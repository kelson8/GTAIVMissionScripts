void main()
{
    ...
    while (NOT g_U860._fU16)
    {
        ...
        switch (l_U24)
        {
            ...
            case 2:
            if ((g_U860._fU8) AND (g_U860._fU312))
            {
                iVar2 = 40;
            }
            break;
        ...
        switch (iVar2)
        {
            ...
            if (g_U860._fU40 == -1)
            {
                ...
                {
                    if ((g_U971[l_U9]._fU28) || (NOT g_U971[l_U9]._fU24))
                    {
                        g_U971[l_U9]._fU36 = 0;
                    }
                    else
...
void sub_1687(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9)
{
    ...
    switch (l_U24)
    {
        ...
        l_U22++;
        if ((g_U860._fU320) || ((g_U860._fU312) || (l_U22 > l_U23)))
        {
            l_U22 = l_U23;
            l_U16 = 1;
        }
...
void sub_4927()
{
    ...
    if (l_U9 != -1)
    {
        ...
        if (l_U24 != 1)
        {
            if (g_U860._fU40 == -1)
            {
                if ((NOT g_U971[l_U9]._fU28) AND (g_U971[l_U9]._fU36))
                {
...
void sub_6472(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, int iParam10)
{
    ...
    if (iParam10 == 0)
    {
        if ((l_U12 == (l_U7._fU0 + (l_U13 - 1))) || (l_U13 < (l_U6 + 1)))
        {
    ...
    {
        if (((l_U12 - (l_U6 - 1)) == l_U7._fU0) || (l_U13 < (l_U6 + 1)))
        {
            ADD_TO_HTML_SCRIPT_OBJECT( l_U26[iParam10], "<th width="30" bgcolor="#999999"></th>" );
        }
        else
