...
void sub_4591()
{
    if ((g_U8628 < g_U2817) AND (g_U8628 < 100))
    {
...
void sub_4651()
{
    ...
    for ( I = 0; I <= (sub_4716() - 1); I++ )
    {
        if ((NOT (g_U2818[I]._fU216 == 1)) AND ((sub_5816( uVar8, I )) AND ((NOT g_U2818[I]._fU208) AND (g_U2818[I]._fU196 < 2000))))
        {
...
int sub_6139(int iParam0)
{
    ...
    {
        if ((sub_5816( uVar7, Result )) AND ((NOT g_U2818[Result]._fU212) AND (g_U2818[Result]._fU196 == iParam0)))
        {
