...
void sub_1498()
{
    ...
    {
        if ((g_U572[I]._fU20) AND ((sub_1536( 5, g_U572[I] )) == 1))
        {
...
void sub_3045()
{
    ...
    l_U366[0] = {-1138.07300000, 1563.59200000, 27.41200000};
    ...
    while ((NOT (HAS_MODEL_LOADED( l_U681 ))) || ((NOT (HAS_MODEL_LOADED( l_U682 ))) || ((NOT (HAS_MODEL_LOADED( l_U677 ))) || ((NOT (HAS_MODEL_LOADED( l_U680 ))) || (NOT (HAS_MODEL_LOADED( l_U679 )))))))
    {
        WAIT( 0 );
    }
...
void sub_5068()
{
    ...
    if (IS_VEH_DRIVEABLE( l_U568 ))
    {
        if (LOCATE_CAR_3D( l_U568, l_U462._fU0, l_U462._fU4, l_U462._fU8, 30.00000000, 30.00000000, 30.00000000, 0 ))
        {
            ...
            if ((iVar6 == 301427732) || (iVar6 == -114291515))
            {
                l_U659 = 1;
            }
            if (NOT l_U659)
...
void sub_24675(unknown uParam0)
{
    ...
    if ((iVar3 != 4) AND ((NOT sub_24835()) AND ((NOT (IS_CHAR_DEAD( (uParam0^) ))) AND ((IS_CHAR_IN_ANY_CAR( sub_2672() )) AND (IS_CONTROL_PRESSED( 0, 51 ))))))
    {
