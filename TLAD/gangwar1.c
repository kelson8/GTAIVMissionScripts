void main()
{
    ...
    sub_1150();
    if ((g_U12306[1]._fU108 == 1) || (g_U15728[8] == 0))
    {
...
void sub_6009(int iParam0, int iParam1)
{
    ...
    if ((iParam1 != sub_5968()) AND (iParam0->_fU8 == sub_5968()))
    {
        if (iParam0->_fU0 == g_U11198)
        {
            g_U11198 = nil;
...
{
    return (NOT (sub_6129( uParam0, uParam1 ))) AND (IS_CHAR_SITTING_IN_CAR( uParam0, uParam1 ));
}
...
void sub_8928()
{
    ...
    while ((TIMERA() < 10000) AND ((l_U719._fU8 < 0) || (LOCATE_CHAR_ANY_MEANS_3D( l_U592, l_U719._fU0, l_U719._fU4, l_U719._fU8, 350, 350, 350, 0 ))))
    {
        GET_RANDOM_CAR_NODE( l_U725, 700.00000000, 1, 1, 1, ref l_U719, ref l_U668 );
        WAIT( 0 );
        sub_45277();
    ...
    sub_2563();
    PRINTSTRING( "\n*\n ----> BACKUP ACTIVATED <---- \n*\n" );
    if ((NOT (IS_CAR_DEAD( l_U1014 ))) AND (DOES_VEHICLE_EXIST( l_U1014 )))
    {
...
void sub_9010()
{
    ...
    else if (LOCATE_CHAR_ANY_MEANS_3D( l_U592, -120.46630000, 1428.77600000, 19.41560000, 20, 20, 20, 0 ))
    {
        ...
        l_U734 = {-73.56910000, 1527.75700000, 17.54800000};
        l_U737 = {-68.10389000, 1524.00000000, 17.41950000};
        l_U748 = 304.75100000;
        l_U749 = 317.32300000;
        l_U750 = 283.52590000;
    ...
    else if (LOCATE_CHAR_ANY_MEANS_3D( l_U592, 425.74800000, 1521.55600000, 15.59500000, 20, 20, 20, 0 ))
    {
        ...
        l_U737 = {810.14980000, 1576.15900000, 17.01150000};
        l_U748 = 303.69770000;
        l_U749 = 347.21460000;
        l_U750 = 300.00340000;
...
void sub_11179()
{
    ...
    while ((NOT (sub_12298( 3 ))) AND ((NOT (sub_12298( 2 ))) AND (NOT (sub_12298( 1 )))))
    {
        sub_11338( 1 );
        sub_11338( 2 );
        sub_11338( 3 );
...
void sub_12453()
{
    ...
    for ( I = 0; I <= 5; I++ )
    {
        if (I == 1)
        {
            ...
            if (NOT (IS_CAR_DEAD( l_U1010[0] )))
            {
                if ((sub_12298( 1 )) AND (IS_CAR_PASSENGER_SEAT_FREE( l_U1010[0], 0 )))
                {
        ...
        else if (I == 3)
        {
            ...
            {
                if ((sub_12298( 2 )) AND (IS_CAR_PASSENGER_SEAT_FREE( g_U11087[0], 0 )))
                {
        ...
        else if (I == 5)
        {
            ...
            {
                if ((sub_12298( 3 )) AND (IS_CAR_PASSENGER_SEAT_FREE( g_U11087[1], 0 )))
                {
...
void sub_16531(int iParam0)
{
    ...
    if (iVar3 == 1)
    {
        ...
        else if ((NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_11393( 7 ) ))) AND (NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_11393( 6 ) ))))
        {
            sub_17610( iParam0 );
        }
    }
...
void sub_16610(unknown uParam0)
{
    ...
    if (Result == 0)
    {
        if (((uParam0^) == (sub_11393( 16 ))) || (((uParam0^) == (sub_11393( 13 ))) || (((uParam0^) == (sub_11393( 7 ))) || (((uParam0^) == (sub_11393( 6 ))) || (((uParam0^) == (sub_11393( 1 ))) || ((uParam0^) == (sub_11393( 0 ))))))))
        {
            Result = 1;
        }
        else if (((uParam0^) == (sub_11393( 17 ))) || ((uParam0^) == (sub_11393( 15 ))))
        {
            Result = 3;
        }
    }
...
void sub_17889(vector vParam0, unknown uParam3, unknown uParam4, unknown uParam5, int iParam6, boolean bParam7)
{
    ...
    sub_17923( vParam0 + (vector( 0.00000000, 0.00000000, 2.00000000)), uParam3, uParam4, iParam6 );
...
int sub_20681()
{
    ...
    switch (l_U1133)
    {
        ...
        break;
        case 3:
        if (((sub_21824( g_U11087[1], -951.58010000, 1301.58400000, 23.86526000 )) < 2.90000000) || (((sub_21824( g_U11087[0], -951.58010000, 1301.58400000, 23.86526000 )) < 2.90000000) || ((sub_21824( l_U1010[0], -951.58010000, 1301.58400000, 23.86526000 )) < 2.90000000)))
        {
            if (l_U658 == 0)
            {
        ...
        break;
        case 4:
        if ((NOT (sub_22391( l_U752 ))) AND (TIMERA() > 6500))
        {
            l_U1133 = 6;
        }
        break;
...
void sub_22662()
{
    if ((l_U663 == 0) AND (IS_SCREEN_FADED_IN()))
    {
        if (NOT (IS_CAR_DEAD( l_U1010[0] )))
        {
            if ((NOT (IS_CHAR_INJURED( sub_5968() ))) AND ((IS_CAR_ON_SCREEN( l_U1010[0] )) AND (LOCATE_CHAR_ANY_MEANS_CAR_3D( l_U592, l_U1010[0], 15, 15, 15, 0 ))))
            {
    ...
    if (Result)
    {
        ...
        if (DOES_CHAR_EXIST( iParam2 ))
        {
            ...
            if (iParam0 != sub_5968())
            {
                ...
                if ((iParam2 != sub_5968()) AND (iVar8 == 1))
                {
        ...
        if (iParam3 != 39)
        {
            if ((IS_CHAR_MODEL( iParam0, sub_11393( 0 ) )) AND (iParam3 == 38))
            {
                if (l_U180)
                {
...
void sub_26971()
{
    if ((IS_SCREEN_FADED_IN()) AND (sub_26980()))
    {
...
int sub_27823()
{
    ...
    switch (l_U1133)
    {
        ...
        break;
        case 4:
        if ((NOT (sub_22391( l_U752 ))) AND (TIMERA() > 3000))
        {
            l_U1133 = 6;
        }
        break;
...
int sub_29448()
{
    ...
    switch (l_U1133)
    {
        ...
        break;
        case 4:
        if ((NOT (sub_22391( l_U752 ))) AND (TIMERA() > 4000))
        {
            l_U1133 = 6;
        }
        break;
...
int sub_32614()
{
    ...
    switch (l_U1133)
    {
        ...
        if ((NOT (sub_22391( l_U752 ))) AND (TIMERA() > 12500))
        {
            l_U1133 = 6;
        }
        break;
...
int sub_35218()
{
    ...
    switch (l_U1133)
    {
        ...
        break;
        case 4:
        if ((NOT (sub_22391( l_U752 ))) AND (TIMERA() > 8750))
        {
            SETTIMERA( 0 );
            l_U1133 = 6;
        }
...
int sub_39383()
{
    ...
    switch (l_U1133)
    {
        ...
        break;
        case 3:
        if (((sub_21824( g_U11087[1], 868.52940000, -474.32400000, 13.90569000 )) < 3.90000000) || (((sub_21824( g_U11087[0], 868.52940000, -474.32400000, 13.90569000 )) < 3.90000000) || ((sub_21824( l_U1010[0], 868.52940000, -474.32400000, 13.90569000 )) < 4.90000000)))
        {
            if (l_U658 == 0)
            {
                SET_CAM_COMPONENT_SHAKE( l_U590, 0, 3, 1250, 0.00500000, 3.90000000, 0.00000000 );
...
void sub_41022()
{
    ...
    if ((NOT (IS_CHAR_INJURED( l_U845[0]._fU0 ))) AND (NOT (DOES_BLIP_EXIST( l_U1044[0] ))))
    {
    ...
    if ((NOT (IS_CHAR_INJURED( g_U11081[0] ))) AND (NOT (DOES_BLIP_EXIST( l_U1044[1] ))))
    {
    ...
    if ((NOT (IS_CHAR_INJURED( g_U11081[1] ))) AND (NOT (DOES_BLIP_EXIST( l_U1044[2] ))))
    {
    ...
    for ( I = 0; I <= 2; I++ )
    {
        if ((NOT (IS_CHAR_INJURED( l_U838[(I * 2) + 1] ))) AND (NOT (DOES_BLIP_EXIST( l_U1044[I + 3] ))))
        {
...
void sub_41757()
{
    ...
    else if ((l_U667 <= 55) AND (l_U667 > 40))
    {
    ...
    else if ((l_U667 <= 70) AND (l_U667 > 55))
    {
        l_U1092[0] = -503930010;
        l_U1092[1] = -235584669;
        l_U1092[2] = 207714363;
    ...
    else if ((l_U667 <= 85) AND (l_U667 > 70))
    {
...
void sub_45307(unknown uParam0)
{
    ...
    if ((NOT bVar4) AND ((iVar8 >= 0) AND ((NOT (iVar14 == 4)) AND ((NOT sub_47643()) AND ((IS_CHAR_ON_ANY_BIKE( sub_5968() )) AND ((NOT (IS_CONTROL_PRESSED( 0, 39 ))) AND ((NOT (IS_CONTROL_PRESSED( 0, 38 ))) AND (IS_CONTROL_PRESSED( 0, 51 )))))))))
    {
...
void sub_45534(unknown uParam0)
{
    ...
    {
        if ((Result < 0) AND ((I != l_U20) AND (sub_45568( uParam0, I ))))
        {
            Result = I;
        }
    }
...
int sub_45568(unknown uParam0, int iParam1)
{
    ...
    if ((NOT (IS_CHAR_IN_ANY_POLICE_VEHICLE( sub_5968() ))) AND ((IS_VEH_DRIVEABLE( (uParam0^)[iParam1]._fU4 )) AND (NOT (IS_CHAR_INJURED( (uParam0^)[iParam1]._fU0 )))))
    {
        if ((IS_CHAR_ON_ANY_BIKE( (uParam0^)[iParam1]._fU0 )) AND ((IS_CHAR_IN_CAR( (uParam0^)[iParam1]._fU0, (uParam0^)[iParam1]._fU4 )) AND (NOT (IS_CHAR_IN_CAR( sub_5968(), (uParam0^)[iParam1]._fU4 )))))
        {
...
void sub_50664()
{
    ...
    if ((NOT (IS_CHAR_INJURED( sub_5968() ))) AND ((l_U662 == 0) AND ((sub_50844()) AND (NOT (sub_22391( l_U752 ))))))
    {
    ...
    if ((l_U652 == 0) AND (NOT (sub_22391( l_U752 ))))
    {
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U592, l_U719._fU0, l_U719._fU4, l_U719._fU8, 450.00000000, 450.00000000, 200.00000000, 0 )) AND (l_U621 == 0))
    {
        sub_51740();
        sub_52010();
        sub_52204();
    ...
    sub_45277();
    sub_81062();
    if ((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) AND ((g_U39123 == 0) AND ((l_U661 == 0) AND (NOT (sub_22391( l_U752 ))))))
    {
        PRINT_HELP( "Leader_4" );
        l_U661 = 1;
    }
    ...
    for ( I = 0; I <= (l_U670 - 1); I++ )
    {
        ...
        else
        {
            ...
            while (l_U644 == 0)
            {
                ...
                {
                    if ((l_U728._fU8 < 0) || (NOT (LOCATE_CAR_3D( l_U1002[0], l_U728._fU0, l_U728._fU4, l_U728._fU8, 50.00000000, 50.00000000, 2.50000000, 0 ))))
                    {
                        iVar2++;
                        GET_NTH_CLOSEST_CAR_NODE_WITH_HEADING( l_U719._fU0, l_U719._fU4, l_U719._fU8, I + iVar2, ref l_U728._fU0, ref l_U728._fU4, ref l_U728._fU8, ref uVar3 );
                    }
        ...
        else
        {
            while (l_U624 == 0)
            {
                ...
                if (NOT (IS_CAR_DEAD( l_U1002[l_U667] )))
                {
                    ...
                    for ( I = 0; I <= iVar4; I++ )
                    {
                        if ((l_U624 == 0) AND (IS_CAR_PASSENGER_SEAT_FREE( l_U1002[l_U667], I )))
                        {
                            GENERATE_RANDOM_INT_IN_RANGE( 1, 101, ref iVar5 );
                            if (iVar5 < 51)
                            {
                                CREATE_CHAR_AS_PASSENGER( l_U1002[l_U667], 7, l_U1092[l_U672], I, ref l_U809[J] );
                                if ((l_U667 == 1) AND (l_U1061 == 1))
                                {
                                    SET_CHAR_WILL_LEAVE_CAR_IN_COMBAT( l_U809[J], 0 );
                                    SET_CHAR_GET_OUT_UPSIDE_DOWN_CAR( l_U809[J], 0 );
                                }
...
void sub_55564()
{
    ...
    else if ((iVar2 <= 20) AND (iVar2 > 5))
    {
        l_U1060 = l_U1055;
    }
    else if ((iVar2 <= 50) AND (iVar2 > 20))
    {
        l_U1060 = l_U1057;
    }
    else
...
void sub_58138()
{
    ...
    {
        if ((IS_CHAR_FATALLY_INJURED( l_U845[0]._fU0 )) || (IS_CHAR_DEAD( l_U845[0]._fU0 )))
        {
    ...
    for ( I = 0; I <= 5; I++ )
    {
        ...
        {
            if ((IS_CHAR_FATALLY_INJURED( l_U838[I] )) || (IS_CHAR_DEAD( l_U838[I] )))
            {
                PRINT_NOW( "GW_FAIL_03", 7500, 1 );
                l_U666 = -1;
                l_U618 = 1;
...
void sub_58492()
{
    if ((l_U647[0] == 0) AND ((DOES_CHAR_EXIST( l_U838[1] )) AND (IS_CHAR_INJURED( l_U838[1] ))))
    {
    ...
    if ((l_U647[1] == 0) AND ((DOES_CHAR_EXIST( l_U838[3] )) AND (IS_CHAR_INJURED( l_U838[3] ))))
    {
    ...
    if ((l_U647[2] == 0) AND ((DOES_CHAR_EXIST( l_U838[5] )) AND (IS_CHAR_INJURED( l_U838[5] ))))
    {
    ...
    if ((l_U647[3] == 0) AND ((g_U12306[1]._fU108 == 1) || (g_U15728[8] == 1)))
    {
        if ((DOES_CHAR_EXIST( l_U845[0]._fU0 )) AND (IS_CHAR_INJURED( l_U845[0]._fU0 )))
        {
...
int sub_59868(int iParam0)
{
    ...
    if ((IS_CHAR_SITTING_IN_ANY_CAR( sub_5968() )) || (NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))))
    {
        return 0;
    }
    ...
    if (iVar4 == iVar3)
    {
        if (NOT (((sub_60011( iVar3 )) == sub_60040()) AND ((sub_16570( iParam0 + 0 )) == 3)))
        {
            if (((NOT (IS_CHAR_GETTING_IN_TO_A_CAR( sub_5968() ))) AND (sub_60128( sub_5968() ))) || (((sub_60086( iParam0->_fU0 )) == (sub_11393( 0 ))) || ((sub_16570( iParam0 + 0 )) != 1)))
            {
                return 0;
            }
            else
...
int sub_60284(int iParam0, unknown uParam1, boolean bParam2)
{
    ...
    else if ((NOT (IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU0 ))) AND (sub_60128( iParam0->_fU0 )))
    {
        return 2;
    }
    else if ((sub_18640( iParam0, 1 )) || (uParam1))
    {
        uVar5 = nil;
        if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
        {
...
void sub_60753(int iParam0)
{
    if (NOT (IS_CHAR_INJURED( iParam0->_fU0 )))
    {
        ...
        {
            if ((NOT l_U163) AND ((NOT l_U162) AND (sub_60819( (iParam0^) ))))
            {
                if ((NOT sub_60871()) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
                {
                    if ((IS_CHAR_ON_ANY_BIKE( sub_5968() )) AND (IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 )))
                    {
        ...
        {
            if ((NOT (sub_22391( l_U155 ))) || ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_5968() ))) || ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU0 ))) || ((NOT (IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 ))) || ((NOT (IS_CHAR_ON_ANY_BIKE( sub_5968() ))) || (NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_5968(), iParam0->_fU0, l_U153, l_U153, l_U153, 0 ))))))))
            {
                sub_62225( iParam0 );
            }
        }
...
void sub_62507(int iParam0)
{
    ...
    if ((sub_60871()) AND (sub_60784( (iParam0^) )))
    {
        if ((IS_VEH_DRIVEABLE( iParam0->_fU4 )) AND (NOT (IS_CHAR_INJURED( iParam0->_fU0 ))))
        {
            if ((IS_CHAR_ON_ANY_BIKE( sub_5968() )) AND ((IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 )) AND (IS_CHAR_SITTING_IN_CAR( iParam0->_fU0, iParam0->_fU4 ))))
            {
                ...
                {
                    if ((l_U176 != sub_5968()) || (l_U175 != iParam0->_fU0))
                    {
    ...
    if (((iVar4 - l_U173) < 33) || ((sub_60784( (iParam0^) )) || (sub_60871())))
    {
        return;
    }
    if (l_U173 <= 0)
    ...
    if ((IS_VEH_DRIVEABLE( iParam0->_fU4 )) AND (NOT (IS_CHAR_INJURED( iParam0->_fU0 ))))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar12 )))
        {
            if (sub_54884( uVar12 ))
            {
                ...
                if ((iParam0->_fU0 != l_U175) AND (((fVar21 < 15) || ((fVar21 < 19) AND (IS_CHAR_ON_SCREEN( iParam0->_fU0 )))) AND (NOT (sub_60784( (iParam0^) )))))
                {
                    GET_CAR_PITCH( uVar12, ref uVar22 );
                    if ((((sub_24749( 0, 10 )) == 0) || (iParam0->_fU36 != 1)) AND (l_U14))
                    {
                        l_U14 = 0;
                        iVar15 = 17;
                        iVar11 = sub_5968();
                    }
                    else if ((NOT (IS_BIT_SET( l_U178, 6 ))) AND (((sub_16570( iParam0 + 0 )) == 1) AND ((iParam0->_fU36 == 2) AND (sub_63599( iParam0 )))))
                    {
                        iVar15 = 38;
                        uVar13 = sub_63713( bVar16 );
                        iVar11 = sub_5968();
                    }
                    else if ((sub_63801( 8 )) AND (((ABSF( uVar22 )) < 20.00000000) AND (IS_CAR_IN_AIR_PROPER( uVar12 ))))
                    {
                        uVar13 = sub_51209( bVar16 );
                        iVar15 = 8;
                    }
                    else if ((sub_63801( 12 )) AND (HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, sub_5968() )))
                    {
                        uVar13 = sub_63713( bVar16 );
                        iVar11 = sub_5968();
                        iVar15 = 12;
                    ...
                    else if ((sub_63801( 13 )) AND ((IS_PED_RAGDOLL( iParam0->_fU0 )) || (HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, 0 ))))
                    {
                        uVar13 = sub_63713( bVar16 );
                        iVar11 = nil;
                        iVar15 = 13;
                    ...
                    else if ((sub_63801( 20 )) AND ((IS_BIT_SET( l_U178, 7 )) AND ((NOT (IS_PLAYER_PRESSING_HORN( sub_5899() ))) AND ((sub_16570( iParam0 + 0 )) == 1))))
                    {
                        if (bVar16)
                        {
                            bVar18 = true;
                    ...
                    else if (((sub_16570( iParam0 + 0 )) == 1) AND ((sub_63801( 24 )) AND ((NOT (IS_BIT_SET( l_U178, 0 ))) AND (IS_WANTED_LEVEL_GREATER( sub_5899(), 0 )))))
                    {
                        iVar15 = 24;
                        iVar11 = sub_5968();
                    }
                    else if (((sub_16570( iParam0 + 0 )) == 1) AND ((sub_63801( 30 )) AND ((IS_BIT_SET( l_U178, 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_5899(), 0 ))))))
                    {
                        iVar15 = 30;
                    }
                    else
                    {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if (((sub_16570( iParam0 + 0 )) == 1) AND ((NOT (IS_BIT_SET( l_U178, 4 ))) AND (sub_63801( 33 ))))
                                {
                            ...
                            else if (IS_CHAR_SITTING_IN_ANY_CAR( sub_5968() ))
                            {
                                ...
                                if (DOES_VEHICLE_EXIST( uVar23 ))
                                {
                                    if (((sub_16570( iParam0 + 0 )) == 1) AND ((NOT (IS_BIT_SET( l_U178, 4 ))) AND (sub_63801( 31 ))))
                                    {
                            ...
                            else if ((NOT (IS_PED_RAGDOLL( sub_5968() ))) AND (IS_CHAR_ON_FOOT( sub_5968() )))
                            {
                                CLEAR_BIT( ref l_U178, 3 );
                                CLEAR_BIT( ref l_U178, 4 );
                            };;;
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (GET_CLOSEST_CHAR( uVar5._fU0, uVar5._fU4, uVar5._fU8, 25.00000000, 1, 1, ref iVar11 ))
                            {
                                ...
                                else if ((NOT (IS_WANTED_LEVEL_GREATER( sub_5899(), 0 ))) AND (sub_63801( 0 )))
                                {
                                ...
                                else if ((NOT (IS_BIT_SET( l_U178, 1 ))) AND ((IS_WANTED_LEVEL_GREATER( sub_5899(), 0 )) AND (sub_63801( 36 ))))
                                {
                                    if (IS_CHAR_ON_SCREEN( iVar11 ))
                                    {
                                        uVar13 = nil;
                                ...
                                else if ((sub_63801( 23 )) AND (IS_WANTED_LEVEL_GREATER( sub_5899(), 2 )))
                                {
                                    uVar13 = nil;
                                    iVar15 = 23;
                                };;;;
                        ...
                        if (iVar15 == 39)
                        {
                            if ((NOT (IS_BIT_SET( l_U178, 2 ))) AND (IS_WANTED_LEVEL_GREATER( sub_5899(), 0 )))
                            {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (IS_VEH_DRIVEABLE( uVar23 ))
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        case 2:
                                        if (((sub_16570( iParam0 + 0 )) == 1) AND (sub_63801( 28 )))
                                        {
                                            iVar15 = 28;
                                        }
                                        break;
                                        ...
                                        {
                                            if ((sub_63801( 4 )) AND (sub_63801( 3 )))
                                            {
                                                if (g_U15728[13])
                                                {
                                                    iVar15 = 4;
                        ...
                        if (iVar15 == 39)
                        {
                            if ((fVar26 < 5) AND ((sub_16570( iParam0 + 0 )) == 1))
                            {
                                if ((IS_WANTED_LEVEL_GREATER( sub_5899(), 0 )) AND (sub_63801( 23 )))
                                {
                                    iVar15 = 23;
                                }
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if (((sub_16570( iParam0 + 0 )) == 1) AND (sub_63801( 30 )))
                                {
                                    iVar15 = 30;
                                }
    ...
    if ((NOT (IS_BIT_SET( l_U178, 7 ))) AND (IS_PLAYER_PRESSING_HORN( sub_5899() )))
    {
...
int sub_68150(int iParam0)
{
    ...
    if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar3 )))
        {
            ...
            {
                if ((((sub_16570( iParam0 + 0 )) == 1) AND (iVar4 == sub_5968())) || ((sub_16570( ref iVar4 )) == (sub_16570( iParam0 + 0 ))))
                {
...
int sub_68407(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if (((NOT (IS_CHAR_INJURED( iVar3 ))) AND (iVar3 == iParam0->_fU8)) || (iVar3 == sub_5968()))
        {
        ...
        if (((sub_46344( iParam0->_fU0, sub_5968(), 1 )) < 90.00000000) || ((IS_CAR_ON_SCREEN( iParam0->_fU4 )) || ((IS_CHAR_ON_SCREEN( iParam0->_fU0 )) || (IS_CHAR_IN_CAR( sub_5968(), iParam0->_fU4 )))))
        {
...
int sub_69143(unknown uParam0)
{
    ...
    if (IS_PED_IN_GROUP( uParam0 ))
    {
        ...
        if (DOES_GROUP_EXIST( iVar3 ))
        {
            ...
            {
                if ((iVar3 != sub_69229()) AND ((iVar5 < 2) || (iVar4 < 1)))
                {
                    REMOVE_GROUP( iVar3 );
                }
                else
            ...
            else if ((iVar3 != sub_69229()) AND (iVar5 < 1))
            {
                REMOVE_GROUP( iVar3 );
            }
        }
...
int sub_69575(int iParam0)
{
    ...
    if ((IS_VEH_DRIVEABLE( iParam0->_fU4 )) AND (NOT (sub_18640( iParam0, 2 ))))
    {
        return 0;
    }
...
int sub_70110(int iParam0)
{
    ...
    else if (((sub_46344( iParam0->_fU0, sub_5968(), 1 )) > 90.00000000) AND ((NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))) AND ((sub_67196( iParam0 )) > 90.00000000)))
    {
        ...
        {
            if (((VDIST( sub_45710( sub_5968(), 1 ), uVar4 )) < 30.00000000) || ((IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000, 2.00000000, 2.00000000 )) || (CAM_IS_SPHERE_VISIBLE( uVar3, uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000 ))))
            {
                ;
            }
            else if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
...
int sub_70725(int iParam0)
{
    ...
    if (NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 )))
    {
        if (NOT (IS_PED_IN_COMBAT( iParam0->_fU0 )))
        {
            ...
            if ((NOT (IS_CHAR_FACING_CHAR( iParam0->_fU0, sub_5968(), 45.00000000 ))) AND (iVar3 == 7))
            {
...
int sub_70882(int iParam0)
{
    ...
    if (DOES_VEHICLE_EXIST( iVar4 ))
    {
        if (sub_6105( iParam0->_fU0, iVar4 ))
        {
            ...
            bVar6 = false;
            if ((NOT (IS_CHAR_GETTING_IN_TO_A_CAR( sub_5968() ))) AND (NOT (IS_CHAR_IN_CAR( sub_5968(), iVar4 ))))
            {
    ...
    if (((sub_67196( iParam0 )) < 30.00000000) AND (sub_18640( iParam0, 1 )))
    {
        SET_CHAR_WILL_LEAVE_CAR_IN_COMBAT( iParam0->_fU0, 1 );
    ...
    if (iParam0->_fU8 == sub_5968())
    {
        if ((IS_CHAR_ON_FOOT( sub_5968() )) AND (IS_CHAR_ON_FOOT( iParam0->_fU0 )))
        {
    ...
    if ((((sub_46344( iParam0->_fU0, iParam0->_fU8, 1 )) > fVar8) || ((DOES_VEHICLE_EXIST( iVar4 )) || ((IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU8 )) || (IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU8 ))))) AND (NOT (IS_CHAR_IN_WATER( iParam0->_fU8 ))))
    {
        if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
        {
            if ((iParam0->_fU4 == iVar4) || (sub_6129( iParam0->_fU8, iParam0->_fU4 )))
            {
            ...
            else if (((sub_16570( iParam0 + 0 )) == 1) AND (sub_6129( sub_5968(), iParam0->_fU4 )))
            {
    ...
    else if (((sub_16570( iParam0 + 0 )) == 1) AND ((iParam0->_fU8 != sub_5968()) AND (sub_68445( sub_5968(), iParam0->_fU0, 1 ))))
    {
    ...
    if (IS_CHAR_IN_WATER( iParam0->_fU8 ))
    {
        ...
        else if ((IS_CHAR_IN_ANY_CAR( iParam0->_fU0 )) || (NOT (sub_18640( iParam0, 1 ))))
        {
            if ((sub_60446( iParam0 )) != 0)
            {
                ;
    ...
    else if ((NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU8 ))) AND (sub_18640( iParam0, 1 )))
    {
...
int sub_72635(int iParam0)
{
    ...
    else if (((sub_63446( iParam0 )) > 30.00000000) AND (NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))))
    {
...
int sub_73046(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if (((VDIST( uVar4, uVar7 )) < 30.00000000) || (((VDIST( uVar4, uVar10 )) < 30.00000000) || ((IS_CAR_ON_SCREEN( iParam0->_fU4 )) || (IS_CHAR_ON_SCREEN( iParam0->_fU0 )))))
        {
            ...
            else if (((sub_16570( ref iVar3 )) == (sub_16570( iParam0 + 0 ))) || (iVar3 == sub_5968()))
            {
...
int sub_73872(int iParam0)
{
    ...
    if (((sub_67196( iParam0 )) < 30.00000000) AND ((IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 115 )) || ((IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 110 )) || (IS_PED_IN_COMBAT( iParam0->_fU0 )))))
    {
        return 2;
    }
    return 0;
...
int sub_74021(int iParam0)
{
    ...
    else if ((IS_CHAR_GETTING_IN_TO_A_CAR( sub_5968() )) AND (iParam0->_fU8 == sub_5968()))
    {
    ...
    if (IS_VEH_DRIVEABLE( uVar10 ))
    {
        ...
        else if (((sub_63446( iParam0 )) >= l_U133) AND ((sub_18640( iParam0, 4 )) || (sub_67724( iParam0->_fU4 ))))
        {
        ...
        if (NOT (IS_CAR_ON_SCREEN( iParam0->_fU4 )))
        {
            ...
            if (GET_CLOSEST_CAR_NODE_WITH_HEADING( vVar9.x, vVar9.y, vVar9.z, ref uVar15._fU0, ref uVar15._fU4, ref uVar15._fU8, ref uVar18 ))
            {
                if (NOT (IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar15._fU0, uVar15._fU4, uVar15._fU8, 4.00000000, 4.00000000, 4.00000000 )))
                {
                    ...
                    if (((VDIST2( uVar15, vVar6 )) > 9.00000000) AND (((VDIST( uVar15, sub_45710( sub_5968(), 1 ) )) > fParam2) AND (NOT (CAM_IS_SPHERE_VISIBLE( uVar19, uVar15._fU0, uVar15._fU4, uVar15._fU8, 6.00000000 )))))
                    {
...
void sub_78964(unknown uParam0)
{
    ...
    if (l_U135 >= 1.20000000)
    {
        ...
        for ( I = 0; I < (uParam0^); I++ )
        {
            ...
            if ((NOT ((uParam0^)[I]._fU8 == sub_5968())) AND ((NOT (IS_CHAR_INJURED( (uParam0^)[I]._fU0 ))) AND ((iVar41[I]) AND (NOT ((uParam0^)[I]._fU8 == nil)))))
            {
...
void sub_81062()
{
    ...
    if ((NOT (IS_CAR_DEAD( l_U1010[0] ))) AND (NOT (IS_CHAR_INJURED( l_U838[1] ))))
    {
        GET_SCRIPT_TASK_STATUS( l_U838[1], 11, ref l_U758 );
        if ((l_U758 == 7) AND (NOT (IS_CHAR_IN_CAR( l_U838[1], l_U1010[0] ))))
        {
            TASK_ENTER_CAR_AS_PASSENGER( l_U838[1], l_U1010[0], -2, 0 );
        }
        if ((IS_CAR_PASSENGER_SEAT_FREE( l_U1010[0], 0 )) AND (NOT (IS_CHAR_IN_ANY_CAR( l_U838[1] ))))
        {
    ...
    if ((NOT (IS_CAR_DEAD( g_U11087[0] ))) AND (NOT (IS_CHAR_INJURED( l_U838[3] ))))
    {
        GET_SCRIPT_TASK_STATUS( l_U838[3], 11, ref l_U758 );
        if ((l_U758 == 7) AND (NOT (IS_CHAR_IN_CAR( l_U838[3], g_U11087[0] ))))
        {
            TASK_ENTER_CAR_AS_PASSENGER( l_U838[3], g_U11087[0], -2, 0 );
        }
        if ((IS_CAR_PASSENGER_SEAT_FREE( g_U11087[0], 0 )) AND (NOT (IS_CHAR_IN_ANY_CAR( l_U838[3] ))))
        {
            GET_GAME_VIEWPORT_ID( ref uVar2 );
    ...
    if ((NOT (IS_CAR_DEAD( g_U11087[1] ))) AND (NOT (IS_CHAR_INJURED( l_U838[5] ))))
    {
        GET_SCRIPT_TASK_STATUS( l_U838[5], 11, ref l_U758 );
        if ((l_U758 == 7) AND (NOT (IS_CHAR_IN_CAR( l_U838[5], g_U11087[1] ))))
        {
            TASK_ENTER_CAR_AS_PASSENGER( l_U838[5], g_U11087[1], -2, 0 );
        }
        if ((IS_CAR_PASSENGER_SEAT_FREE( g_U11087[1], 0 )) AND (NOT (IS_CHAR_IN_ANY_CAR( l_U838[5] ))))
        {
            GET_GAME_VIEWPORT_ID( ref uVar2 );
...
void sub_82168()
{
    ...
    for ( I = 0; I <= 27; I++ )
    {
        ...
        {
            if ((NOT (IS_CHAR_DEAD( l_U809[I] ))) AND (l_U656 == 0))
            {
            ...
            if (NOT (IS_CHAR_DEAD( l_U809[I] )))
            {
                ...
                if ((IS_BULLET_IN_AREA( l_U722._fU0, l_U722._fU4, l_U722._fU8, 10.00000000, 1 )) || (IS_SNIPER_BULLET_IN_AREA( l_U722._fU0 - 5, l_U722._fU4 - 5, l_U722._fU8 - 5, l_U722._fU0 + 5, l_U722._fU4 + 5, l_U722._fU8 + 5 )))
                {
                    l_U666 = 3;
                }
            }
    ...
    if (l_U1061 == 1)
    {
        ...
        {
            if ((l_U653 == 0) AND (LOCATE_CHAR_ANY_MEANS_CAR_3D( l_U592, l_U1002[1], 50, 50, 50, 0 )))
            {
                l_U653 = 1;
            }
            if (l_U653 == 1)
...
void sub_83549()
{
    ...
    if (l_U622 == 0)
    {
        ...
        for ( I = 0; I <= 27; I++ )
        {
            if (l_U1061 == 1)
            {
                if ((NOT (IS_CAR_DEAD( l_U1002[1] ))) AND (l_U1062 == 0))
                {
        ...
        else
        {
            for ( I = 0; I <= (l_U670 - 1); I++ )
            {
                if ((l_U665 == 0) AND (NOT (IS_CAR_DEAD( l_U1002[I] ))))
                {
    ...
    if ((NOT (IS_CHAR_INJURED( sub_5968() ))) AND ((sub_50844()) AND ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND ((NOT (sub_22391( l_U752 ))) AND (l_U654 == 0)))))
    {
        if (l_U1061 == 1)
        {
...
void sub_85233(unknown uParam0)
{
    ...
    if ((NOT (IS_CHAR_INJURED( uParam0 ))) AND ((NOT (IS_CAR_DEAD( l_U1002[1] ))) AND (l_U1061 == 1)))
    {
        if ((NOT (IS_CHAR_IN_CAR( l_U592, l_U1002[1] ))) AND (LOCATE_CHAR_ANY_MEANS_CAR_3D( uParam0, l_U1002[1], 25, 25, 25, 0 )))
        {
...
void sub_85473()
{
    ...
    if ((sub_85510()) AND ((l_U713 - l_U714) > l_U715))
    {
    ...
    if ((sub_85510()) AND ((l_U710 - l_U711) > l_U712))
    {
    ...
    if ((sub_85510()) AND ((l_U707 - l_U708) > l_U709))
    {
...
void sub_88559()
{
    ...
    for ( I = 0; I <= 2; I++ )
    {
        if ((l_U760[I] == 0) AND (TIMERB() > l_U764[I]))
        {
            PRINTSTRING( "\n\n    ----> Try Create Backup: " );
            PRINTINT( I );
            PRINTNL();
...
void sub_89814()
{
    ...
    for ( J = 0; J <= 3; J++ )
    {
        ...
        else
        {
            while (l_U624 == 0)
            {
                if (NOT (IS_CAR_DEAD( l_U779[l_U769] )))
                {
                    ...
                    for ( I = 0; I <= iVar6; I++ )
                    {
                        if ((l_U624 == 0) AND (IS_CAR_PASSENGER_SEAT_FREE( l_U779[l_U769], I )))
                        {
                            GENERATE_RANDOM_INT_IN_RANGE( 1, 101, ref iVar3 );
                            if (iVar3 < 51)
                            {
        ...
        if (NOT (IS_CHAR_INJURED( l_U783[iVar2] )))
        {
            ...
            if ((l_U1061 == 0) AND (NOT (DOES_BLIP_EXIST( l_U796[iVar2] ))))
            {
...
void sub_91513()
{
    ...
    if (l_U1061 == 1)
    {
        if ((sub_91566( l_U1002[1] )) || (IS_CAR_DEAD( l_U1002[1] )))
        {
            if (DOES_BLIP_EXIST( l_U1064 ))
            {
                REMOVE_BLIP( l_U1064 );
        ...
        {
            if ((CHECK_STUCK_TIMER( l_U1002[1], 2, 30000 )) AND (IS_CAR_IN_WATER( l_U1002[1] )))
            {
    ...
    else
    {
        for ( I = 0; I <= 11; I++ )
        {
            if ((NOT (DOES_CHAR_EXIST( l_U783[I] ))) || ((IS_CHAR_DEAD( l_U783[I] )) || (IS_CHAR_INJURED( l_U783[I] ))))
            {
                if (DOES_BLIP_EXIST( l_U796[I] ))
                {
                    REMOVE_BLIP( l_U796[I] );
        ...
        for ( I = 0; I <= 27; I++ )
        {
            if ((NOT (DOES_CHAR_EXIST( l_U809[I] ))) || ((IS_CHAR_DEAD( l_U809[I] )) || (IS_CHAR_INJURED( l_U809[I] ))))
            {
                if (DOES_BLIP_EXIST( l_U1015[I] ))
                {
                    REMOVE_BLIP( l_U1015[I] );
...
int sub_91566(unknown uParam0)
{
    if (DOES_VEHICLE_EXIST( uParam0 ))
    {
        return (IS_CAR_IN_WATER( uParam0 )) AND (IS_CAR_DEAD( uParam0 ));
    }
    return 0;
}
...
void sub_92461()
{
    if ((NOT (IS_CHAR_INJURED( sub_5968() ))) AND (sub_50844()))
    {
...
void sub_97710()
{
    if ((NOT (IS_CHAR_INJURED( sub_5968() ))) AND (g_U10991 > 1))
    {
