...
void sub_1431()
{
    ...
    {
        case 0:
        if ((NOT (IS_WANTED_LEVEL_GREATER( sub_610(), 0 ))) AND (IS_SCORE_GREATER( sub_610(), 9 )))
        {
            l_U105 = 1;
        }
        else
        ...
        if (NOT g_U9223)
        {
            if ((NOT (IS_WANTED_LEVEL_GREATER( sub_610(), 0 ))) AND (LOCATE_CHAR_ON_FOOT_CHAR_3D( l_U113, sub_1136(), 10.00000000, 10.00000000, 2.00000000, 0 )))
            {
                sub_1735();
            }
        }
...
void sub_1453()
{
    if ((IS_PED_IN_COMBAT( sub_1136() )) || (IS_PED_IN_COMBAT( l_U113 )))
    {
        sub_340( 2, ref l_U142 );
        l_U105 = 9;
    }
...
int sub_2501(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_610() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_610() )))
            {
                if (((g_U10499) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_610() )))))
                {
                    if (NOT sub_2597())
                    {
