...
int sub_33210(unknown uParam0, int iParam1, boolean bParam2)
{
    ...
    if (NOT (iParam1 == nil))
    {
        if ((IS_CHAR_INJURED( iParam1 )) || (sub_33282()))
        {
            l_U505 = 1;
            l_U506 = 0;
...
void sub_44155(unknown uParam0, unknown uParam1)
{
    ...
    if ((NOT sub_35408()) || (NOT sub_44216()))
    {
        return;
    }
    sub_36910();
...
{
    if ((NOT (HAS_MODEL_LOADED( sub_44798( uParam0 ) ))) || (NOT (sub_35335( uParam0 ))))
    {
        sub_35374( uParam0 );
...
void sub_45077(vector vParam0, unknown uParam3, unknown uParam4, unknown uParam5, int iParam6, boolean bParam7)
{
    ...
    sub_45111( vParam0 + (vector( 0.00000000, 0.00000000, 2.00000000)), uParam3, uParam4, iParam6 );
...
{
    return (NOT (sub_50198( uParam0, uParam1 ))) AND (IS_CHAR_SITTING_IN_CAR( uParam0, uParam1 ));
}
...
void sub_63576()
{
    ...
    sub_63904( iVar3[54], -1378.11200000, 510.59840000, 13.97960000, 95.79300000, -1382.08400000, 528.18780000, 16.99844000, -11.86755000, -0.00000000, -132.35800000 );
...
int sub_66055(unknown uParam0, unknown uParam1, unknown uParam2)
{
        ...
        for ( I = 0; I < 1; I++ )
        {
            if (l_U514 == -1)
            {
                if (sub_66902( I ))
                {
                    ...
                    if ((sub_67113( 1, 1 )) AND ((NOT (sub_37480( sub_1568() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U611[I]._fU4._fU0, l_U611[I]._fU4._fU4, fVar8, 2.50000000, 2.50000000, 2.50000000, iVar9 ))))
                    {
    ...
    if (l_U502 == 2)
    {
        if ((iVar5 > l_U627) || (sub_67622( uParam0 )))
        {
            l_U514 = l_U628;
            l_U502 = 3;
        }
...
int sub_75831(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    {
        bVar6 = true;
        if ((NOT (sub_37480( sub_1568() ))) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() )))
        {
...
void sub_98057(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if (l_U1194 == 1)
    {
        if (NOT (IS_CHAR_ON_FOOT( sub_1568() )))
        {
            if ((iVar5 > l_U1224) || (sub_98180( uParam1, 20.00000000 )))
            {
                l_U1194++;
            }
            else
...
int sub_103802(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 6; Result++ )
    {
        ...
        if ((NOT (sub_103937( iVar4 ))) AND (sub_103874( Result )))
        {
            iVar5 = g_U11583[iVar4]._fU28 == g_U10999;
            fVar6 = l_U1002[Result]._fU4._fU8;
            if ((sub_67113( 1, 1 )) AND ((NOT (sub_37480( sub_1568() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U1002[Result]._fU4._fU0, l_U1002[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 ))))
            {
...
int sub_104229(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 16; Result++ )
    {
        if (sub_104288( Result ))
        {
            ...
            if ((sub_67113( 1, 1 )) AND ((NOT (sub_37480( sub_1568() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U629[Result]._fU4._fU0, l_U629[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 ))))
            {
                if (IS_CHAR_ON_FOOT( sub_1568() ))
                {
                    if (sub_98180( uParam0, 1092616192 ))
...
int sub_122502(unknown uParam0)
{
    ...
    if ((sub_122592( uParam0, "Bada_room1" )) || ((sub_122592( uParam0, "Bada_room2" )) || ((sub_122592( uParam0, "Bada-Private" )) || (sub_122592( uParam0, "Bada_room1" )))))
    {
        return 1;
    }
    if ((sub_122592( uParam0, "clammainroom" )) || ((sub_122592( uParam0, "clamfronrm" )) || ((sub_122592( uParam0, "clampalbkrm" )) || (sub_122592( uParam0, "clammainroom" )))))
    {
        return 1;
    }
    return 0;
...
void sub_123828(unknown uParam0)
{
    ...
    if (l_U521._fU12)
    {
        if (g_U18635[l_U416]._fU892._fU40 >= 0)
        {
            ...
            if (NOT l_U521._fU24)
            {
                if (((sub_105061( l_U465 )) > 5) || (sub_137304( ref l_U465 )))
                {
                    bVar5 = true;
                }
            }
...
void sub_124004(unknown uParam0)
{
    ...
    if ((sub_124027( uParam0 )) || (IS_CHAR_DEAD( sub_1568() )))
    {
        return;
    }
    if ((sub_124268( uParam0 )) || (IS_CHAR_ON_ANY_BIKE( sub_1568() )))
    {
        sub_124408( uParam0 );
        return;
    }
...
int sub_125874(unknown uParam0)
{
    ...
    if (NOT l_U521._fU8)
    {
        if ((NOT (sub_124027( uParam0 ))) AND (NOT (IS_CHAR_DEAD( sub_1568() ))))
        {
            if (IS_CHAR_ON_ANY_BIKE( sub_1568() ))
            {
...
int sub_126758(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((uParam2) AND (NOT g_U18635[uParam0]._fU892._fU28))
    {
        ...
        for ( I = 0; I < iVar6; I++ )
        {
            if ((NOT (sub_127192( uParam0, I ))) AND (sub_126927( uParam0, I )))
            {
...
void sub_126881()
{
    ...
    for ( I = 0; I < iVar2; I++ )
    {
        if ((sub_126927( 7, I )) || ((sub_126927( 6, I )) || (sub_126927( 1, I ))))
        {
            sub_127019( 1, I );
            sub_127019( 6, I );
            sub_127019( 7, I );
        ...
        if ((sub_127192( 7, I )) || ((sub_127192( 6, I )) || (sub_127192( 1, I ))))
        {
            sub_127284( 1, I );
            sub_127284( 6, I );
            sub_127284( 7, I );
...
int sub_138373(int iParam0)
{
    ...
    if (iVar4 == iVar3)
    {
        if (NOT (((sub_138516( iVar3 )) == sub_138545()) AND ((sub_45876( iParam0 + 0 )) == 3)))
        {
            if (((NOT (IS_CHAR_GETTING_IN_TO_A_CAR( sub_1568() ))) AND (sub_138633( sub_1568() ))) || (((sub_138591( iParam0->_fU0 )) == (sub_17365( 0 ))) || ((sub_45876( iParam0 + 0 )) != 1)))
            {
                return 0;
            }
            else
...
int sub_138789(int iParam0, unknown uParam1, boolean bParam2)
{
    ...
    else if ((NOT (IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU0 ))) AND (sub_138633( iParam0->_fU0 )))
    {
        return 2;
    }
    else if ((sub_88496( iParam0, 1 )) || (uParam1))
    {
        uVar5 = nil;
        if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
        {
...
void sub_139345(int iParam0)
{
    if (NOT (IS_CHAR_INJURED( iParam0->_fU0 )))
    {
        ...
        {
            if ((NOT l_U155) AND ((NOT l_U154) AND (sub_139411( (iParam0^) ))))
            {
                if ((NOT sub_136788()) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
                {
        ...
        {
            if ((NOT (sub_75505( l_U147 ))) || ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() ))) || ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU0 ))) || ((NOT (IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 ))) || ((NOT (IS_CHAR_ON_ANY_BIKE( sub_1568() ))) || (NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_1568(), iParam0->_fU0, l_U145, l_U145, l_U145, 0 ))))))))
            {
                sub_140798( iParam0 );
            }
        }
...
void sub_140961(int iParam0)
{
    ...
    if ((sub_136788()) AND (sub_139376( (iParam0^) )))
    {
    ...
    if (((iVar4 - l_U165) < 33) || ((sub_139376( (iParam0^) )) || (sub_136788())))
    {
        return;
    }
    if (l_U165 <= 0)
    ...
    if ((IS_VEH_DRIVEABLE( iParam0->_fU4 )) AND (NOT (IS_CHAR_INJURED( iParam0->_fU0 ))))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar12 )))
        {
            if (sub_141888( uVar12 ))
            {
                ...
                if ((iParam0->_fU0 != l_U167) AND (((fVar21 < 15) || ((fVar21 < 19) AND (IS_CHAR_ON_SCREEN( iParam0->_fU0 )))) AND (NOT (sub_139376( (iParam0^) )))))
                {
                    GET_CAR_PITCH( uVar12, ref uVar22 );
                    if ((((sub_52560( 0, 10 )) == 0) || (iParam0->_fU36 != 1)) AND (l_U104))
                    {
                        l_U104 = 0;
                        iVar15 = 17;
                        iVar11 = sub_1568();
                    }
                    else if ((NOT (IS_BIT_SET( l_U170, 6 ))) AND (((sub_45876( iParam0 + 0 )) == 1) AND ((iParam0->_fU36 == 2) AND (sub_142125( iParam0 )))))
                    {
                        iVar15 = 38;
                        uVar13 = sub_142239( bVar16 );
                        iVar11 = sub_1568();
                    }
                    else if ((sub_142327( 8 )) AND (((ABSF( uVar22 )) < 20.00000000) AND (IS_CAR_IN_AIR_PROPER( uVar12 ))))
                    {
                        uVar13 = sub_51386( bVar16 );
                        iVar15 = 8;
                    }
                    else if ((sub_142327( 12 )) AND (HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, sub_1568() )))
                    {
                        uVar13 = sub_142239( bVar16 );
                        iVar11 = sub_1568();
                        iVar15 = 12;
                    ...
                    else if ((sub_142327( 13 )) AND ((IS_PED_RAGDOLL( iParam0->_fU0 )) || (HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, 0 ))))
                    {
                        uVar13 = sub_142239( bVar16 );
                        iVar11 = nil;
                        iVar15 = 13;
                    ...
                    else if ((sub_142327( 20 )) AND ((IS_BIT_SET( l_U170, 7 )) AND ((NOT (IS_PLAYER_PRESSING_HORN( sub_4212() ))) AND ((sub_45876( iParam0 + 0 )) == 1))))
                    {
                        if (bVar16)
                        {
                            bVar18 = true;
                    ...
                    else if (((sub_45876( iParam0 + 0 )) == 1) AND ((sub_142327( 24 )) AND ((NOT (IS_BIT_SET( l_U170, 0 ))) AND (IS_WANTED_LEVEL_GREATER( sub_4212(), 0 )))))
                    {
                        iVar15 = 24;
                        iVar11 = sub_1568();
                    }
                    else if (((sub_45876( iParam0 + 0 )) == 1) AND ((sub_142327( 30 )) AND ((IS_BIT_SET( l_U170, 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_4212(), 0 ))))))
                    {
                        iVar15 = 30;
                    }
                    else
                    {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if (((sub_45876( iParam0 + 0 )) == 1) AND ((NOT (IS_BIT_SET( l_U170, 4 ))) AND (sub_142327( 33 ))))
                                {
                            ...
                            else if (IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() ))
                            {
                                ...
                                if (DOES_VEHICLE_EXIST( uVar23 ))
                                {
                                    if (((sub_45876( iParam0 + 0 )) == 1) AND ((NOT (IS_BIT_SET( l_U170, 4 ))) AND (sub_142327( 31 ))))
                                    {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (GET_CLOSEST_CHAR( uVar5._fU0, uVar5._fU4, uVar5._fU8, 25.00000000, 1, 1, ref iVar11 ))
                            {
                                ...
                                else if ((NOT (IS_WANTED_LEVEL_GREATER( sub_4212(), 0 ))) AND (sub_142327( 0 )))
                                {
                                ...
                                else if ((NOT (IS_BIT_SET( l_U170, 1 ))) AND ((IS_WANTED_LEVEL_GREATER( sub_4212(), 0 )) AND (sub_142327( 36 ))))
                                {
                                    if (IS_CHAR_ON_SCREEN( iVar11 ))
                                    {
                                        uVar13 = nil;
                                ...
                                else if ((sub_142327( 23 )) AND (IS_WANTED_LEVEL_GREATER( sub_4212(), 2 )))
                                {
                                    uVar13 = nil;
                                    iVar15 = 23;
                                };;;;
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (IS_VEH_DRIVEABLE( uVar23 ))
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        case 2:
                                        if (((sub_45876( iParam0 + 0 )) == 1) AND (sub_142327( 28 )))
                                        {
                                            iVar15 = 28;
                                        }
                                        break;
                                        ...
                                        {
                                            if ((sub_142327( 4 )) AND (sub_142327( 3 )))
                                            {
                                                if (g_U15728[13])
                                                {
                                                    iVar15 = 4;
                        ...
                        if (iVar15 == 39)
                        {
                            if ((fVar26 < 5) AND ((sub_45876( iParam0 + 0 )) == 1))
                            {
                                if ((IS_WANTED_LEVEL_GREATER( sub_4212(), 0 )) AND (sub_142327( 23 )))
                                {
                                    iVar15 = 23;
                                }
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if (((sub_45876( iParam0 + 0 )) == 1) AND (sub_142327( 30 )))
                                {
                                    iVar15 = 30;
                                }
...
int sub_146800(int iParam0)
{
    ...
    if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar3 )))
        {
            ...
            {
                if ((((sub_45876( iParam0 + 0 )) == 1) AND (iVar4 == sub_1568())) || ((sub_45876( ref iVar4 )) == (sub_45876( iParam0 + 0 ))))
                {
...
int sub_147057(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if (((sub_141951( iParam0->_fU0, sub_1568(), 1 )) < 90.00000000) || ((IS_CAR_ON_SCREEN( iParam0->_fU4 )) || ((IS_CHAR_ON_SCREEN( iParam0->_fU0 )) || (IS_CHAR_IN_CAR( sub_1568(), iParam0->_fU4 )))))
        {
...
int sub_148189(int iParam0)
{
    ...
    if ((IS_VEH_DRIVEABLE( iParam0->_fU4 )) AND (NOT (sub_88496( iParam0, 2 ))))
    {
        return 0;
    }
...
int sub_148724(int iParam0)
{
    ...
    else if (((sub_141951( iParam0->_fU0, sub_1568(), 1 )) > 90.00000000) AND ((NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))) AND ((sub_145846( iParam0 )) > 90.00000000)))
    {
        ...
        {
            if (((VDIST( sub_139134( sub_1568(), 1 ), uVar4 )) < 30.00000000) || ((IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000, 2.00000000, 2.00000000 )) || (CAM_IS_SPHERE_VISIBLE( uVar3, uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000 ))))
            {
                ;
            }
            else if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
...
int sub_149496(int iParam0)
{
    ...
    if (((sub_145846( iParam0 )) < 30.00000000) AND (sub_88496( iParam0, 1 )))
    {
        SET_CHAR_WILL_LEAVE_CAR_IN_COMBAT( iParam0->_fU0, 1 );
    ...
    if ((((sub_141951( iParam0->_fU0, iParam0->_fU8, 1 )) > fVar8) || ((DOES_VEHICLE_EXIST( iVar4 )) || ((IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU8 )) || (IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU8 ))))) AND (NOT (IS_CHAR_IN_WATER( iParam0->_fU8 ))))
    {
        if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
        {
            if ((iParam0->_fU4 == iVar4) || (sub_50198( iParam0->_fU8, iParam0->_fU4 )))
            {
            ...
            else if (((sub_45876( iParam0 + 0 )) == 1) AND (sub_50198( sub_1568(), iParam0->_fU4 )))
            {
    ...
    else if (((sub_45876( iParam0 + 0 )) == 1) AND ((iParam0->_fU8 != sub_1568()) AND (sub_147095( sub_1568(), iParam0->_fU0, 1 ))))
    {
    ...
    if (IS_CHAR_IN_WATER( iParam0->_fU8 ))
    {
        ...
        else if ((IS_CHAR_IN_ANY_CAR( iParam0->_fU0 )) || (NOT (sub_88496( iParam0, 1 ))))
        {
            if ((sub_138951( iParam0 )) != 0)
            {
                ;
    ...
    else if ((NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU8 ))) AND (sub_88496( iParam0, 1 )))
    {
...
int sub_151249(int iParam0)
{
    ...
    else if (((sub_141931( iParam0 )) > 30.00000000) AND (NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))))
    {
...
int sub_151660(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if (((VDIST( uVar4, uVar7 )) < 30.00000000) || (((VDIST( uVar4, uVar10 )) < 30.00000000) || ((IS_CAR_ON_SCREEN( iParam0->_fU4 )) || (IS_CHAR_ON_SCREEN( iParam0->_fU0 )))))
        {
            ...
            else if (((sub_45876( ref iVar3 )) == (sub_45876( iParam0 + 0 ))) || (iVar3 == sub_1568()))
            {
...
int sub_152486(int iParam0)
{
    ...
    if (((sub_145846( iParam0 )) < 30.00000000) AND ((IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 115 )) || ((IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 110 )) || (IS_PED_IN_COMBAT( iParam0->_fU0 )))))
    {
        return 2;
    }
    return 0;
...
int sub_152635(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( uVar10 ))
    {
        ...
        else if (((sub_141931( iParam0 )) >= l_U125) AND ((sub_88496( iParam0, 4 )) || (sub_146374( iParam0->_fU4 ))))
        {
        ...
        if (NOT (IS_CAR_ON_SCREEN( iParam0->_fU4 )))
        {
            ...
            if (GET_CLOSEST_CAR_NODE_WITH_HEADING( vVar9.x, vVar9.y, vVar9.z, ref uVar15._fU0, ref uVar15._fU4, ref uVar15._fU8, ref uVar18 ))
            {
                if (NOT (IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar15._fU0, uVar15._fU4, uVar15._fU8, 4.00000000, 4.00000000, 4.00000000 )))
                {
                    ...
                    if (((VDIST2( uVar15, vVar6 )) > 9.00000000) AND (((VDIST( uVar15, sub_139134( sub_1568(), 1 ) )) > fParam2) AND (NOT (CAM_IS_SPHERE_VISIBLE( uVar19, uVar15._fU0, uVar15._fU4, uVar15._fU8, 6.00000000 )))))
                    {
...
void sub_159689(unknown uParam0)
{
    ...
    if ((NOT bVar4) AND ((iVar8 >= 0) AND ((NOT (iVar14 == 4)) AND ((NOT sub_162035()) AND ((IS_CHAR_ON_ANY_BIKE( sub_1568() )) AND ((NOT (IS_CONTROL_PRESSED( 0, 39 ))) AND ((NOT (IS_CONTROL_PRESSED( 0, 38 ))) AND (IS_CONTROL_PRESSED( 0, 51 )))))))))
    {
...
void sub_159924(unknown uParam0)
{
    ...
    {
        if ((Result < 0) AND ((I != l_U110) AND (sub_159960( uParam0, I ))))
        {
            Result = I;
        }
    }
...
void sub_162619(unknown uParam0)
{
    ...
    if (HAS_SCRIPT_LOADED( "ability_stats" ))
    {
        if (NOT g_U39103)
        {
            if ((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) AND ((NOT g_U11112) AND ((NOT IS_MINIGAME_IN_PROGRESS()) AND ((NOT sub_165107()) AND (((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "ability_stats" )) == 0) AND (NOT sub_162035()))))))
            {
                if (NOT l_U1236)
                {
...
int sub_165107()
{
    ...
    {
        if ((sub_165141()) AND (ARE_WIDESCREEN_BORDERS_ACTIVE()))
        {
            return 1;
        }
