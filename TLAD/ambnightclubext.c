            ...
            switch (l_U439)
            {
                ...
                if (NOT sub_1471())
                {
                    if ((l_U247 < 4) || (l_U247 > 20))
                    {
                        ...
                        {
                            if (((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "FAUSTIN6" )) <= 1) || ((CAN_CREATE_RANDOM_CHAR( 0, 1 )) || (CAN_CREATE_RANDOM_CHAR( 1, 0 ))))
                            {
                ...
                while ((NOT (HAS_MODEL_LOADED( -1850743775 ))) || (NOT (HAS_MODEL_LOADED( l_U432 ))))
                {
                    WAIT( 0 );
                }
                ...
                {
                    WAIT( 0 );
                    if ((CAN_CREATE_RANDOM_CHAR( 0, 1 )) || (CAN_CREATE_RANDOM_CHAR( 1, 0 )))
                    {
                        if ((l_U241 == 1) || (l_U241 == 6))
                        {
                        ...
                        if (DOES_CHAR_EXIST( l_U115[l_U241] ))
                        {
                            if (NOT (IS_CHAR_DEAD( l_U115[l_U241] )))
                            {
                                ...
                                if ((l_U433 == -142386662) || ((l_U433 == -1827421800) || (l_U433 == -1080673049)))
                                {
                                    if (NOT (IS_CHAR_DEAD( l_U115[l_U241] )))
                                    {
...
void sub_178()
{
    ...
    {
        if ((NOT (IS_CHAR_INJURED( l_U156 ))) AND (NOT (IS_CHAR_DEAD( l_U156 ))))
        {
    ...
    {
        WAIT( 0 );
        if ((DOES_CHAR_EXIST( l_U115[l_U241] )) AND ((NOT (IS_CHAR_INJURED( l_U115[l_U241] ))) AND (NOT (IS_CHAR_DEAD( l_U115[l_U241] )))))
        {
            CLEAR_CHAR_TASKS_IMMEDIATELY( l_U115[l_U241] );
            MARK_CHAR_AS_NO_LONGER_NEEDED( ref l_U115[l_U241] );
        }
            ...
            if (l_U397 == 0)
            {
                ...
                if (l_U438 == 7)
                {
                    ...
                    while (l_U241 < l_U245)
                    {
                        ...
                        if (l_U399 == 0)
                        {
                            if ((DOES_CHAR_EXIST( l_U157 )) AND ((NOT (IS_CHAR_INJURED( l_U157 ))) AND (NOT (IS_CHAR_DEAD( l_U157 )))))
                            {
                                if (l_U398 == 1)
                                {
...
void sub_7246(unknown uParam0)
{
    ...
    if ((NOT (IS_CHAR_INJURED( sub_753() ))) AND (NOT (IS_CHAR_INJURED( (uParam0^) ))))
    {
...
int sub_7794(unknown uParam0)
{
    ...
    if (NOT (IS_CHAR_INJURED( (uParam0^) )))
    {
        if (GET_CHAR_READY_TO_BE_STUNNED( (uParam0^) ))
        {
            if (HAVE_ANIMS_LOADED( "melee_unarmed_base" ))
            {
                if ((NOT (IS_CHAR_PLAYING_ANIM( sub_753(), "melee_unarmed_base", "stun_punch" ))) AND (IS_PED_IN_COMBAT( (uParam0^) )))
                {
                    bVar3 = true;
                }
                if ((NOT (IS_CHAR_PLAYING_ANIM( sub_753(), "melee_unarmed_base", "stun_punch" ))) AND (IS_CHAR_IN_MELEE_COMBAT( (uParam0^) )))
                {
                    bVar3 = true;
                }
            }
            if ((IS_CHAR_ARMED( (uParam0^), 4 )) AND (IS_PLAYER_TARGETTING_CHAR( sub_927(), (uParam0^) )))
            {
                bVar3 = true;
            }
            if ((IS_CHAR_ARMED( (uParam0^), 4 )) AND (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_927(), (uParam0^) )))
            {
                bVar3 = true;
            }
        ...
        if ((g_U10506 == 1) AND (l_U401 == 0))
        {
            if (IS_PLAYER_PLAYING( sub_927() ))
            {
                ...
                if (l_U399 == 0)
                {
                    if ((NOT (IS_CHAR_INJURED( l_U156 ))) AND (NOT (IS_CHAR_DEAD( l_U156 ))))
                    {
                        if ((NOT (IS_CHAR_INJURED( l_U157 ))) AND (NOT (IS_CHAR_DEAD( l_U157 ))))
                        {
                            if (LOCATE_CHAR_ANY_MEANS_3D( sub_753(), 957.90000000, -288.65000000, 19.88000000, 3.50000000, 3.50000000, 3.50000000, 0 ))
                            {
                                ...
                                l_U399 = 1;
                                if ((DOES_CHAR_EXIST( l_U157 )) AND (NOT (IS_CHAR_DEAD( l_U157 ))))
                                {
                                    CLEAR_CHAR_TASKS_IMMEDIATELY( l_U157 );
                                    SET_CHAR_RELATIONSHIP( l_U157, 5, 0 );
                                    SET_CHAR_READY_TO_BE_STUNNED( l_U157, 0 );
            ...
            if (l_U399 == 1)
            {
                if (IS_PLAYER_PLAYING( sub_927() ))
                {
                    if ((DOES_CHAR_EXIST( l_U156 )) AND ((NOT (IS_CHAR_INJURED( l_U156 ))) AND (NOT (IS_CHAR_DEAD( l_U156 )))))
                    {
                        if ((DOES_CHAR_EXIST( l_U157 )) AND ((NOT (IS_CHAR_INJURED( l_U157 ))) AND (NOT (IS_CHAR_DEAD( l_U157 )))))
                        {
