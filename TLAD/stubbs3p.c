        ...
        switch (l_U355)
        {
            ...
            if (GET_MISSION_FLAG() == 0)
            {
                if (sub_1820( l_U444 ))
                {
                    ...
                    {
                        if ((sub_2662()) || ((sub_2561()) || ((sub_2475()) || (NOT sub_2428()))))
                        {
...
int sub_2973(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_2060() ))) AND (IS_CHAR_IN_ANY_CAR( sub_2060() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_3526()))
        {
            return 0;
        }
        g_U94._fU60 = uParam0;
...
int sub_12374()
{
    ...
    for ( I = 0; I <= (g_U572 - 1); I++ )
    {
        if ((g_U572[I]._fU20) AND ((sub_8036( 1, g_U572[I] )) != 0))
        {
            sub_8287( I );
            return 1;
        }
