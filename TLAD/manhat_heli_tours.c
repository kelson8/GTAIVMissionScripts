...
void sub_474()
{
    ...
    l_U335[1] = {366.79550000, -731.30110000, 4.15270000};
    ...
    l_U379[1] = {333.54860000, -697.44460000, 3.69190000};
    ...
    l_U397[2] = {378.68210000, -721.63060000, 4.69190000};
    l_U397[3] = {385.66610000, -726.54310000, 4.69190000};
...
int sub_1655()
{
    if (IS_PLAYER_PLAYING( sub_1490() ))
    {
        if (g_U10994[2]._fU0)
        {
            if ((l_U221 == 5) || (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()))
            {
                if (sub_1716())
                {
                    if (NOT g_U12303)
...
void sub_1908()
{
    ...
    {
        iVar3 = sub_1936( 16 );
        if ((g_U10994[g_U11236[I]._fU0]._fU0) AND (sub_1981( 16, iVar3 )))
        {
    ...
    {
        iVar3 = sub_1936( 14 );
        if ((g_U10994[g_U11327[I]._fU0]._fU0) AND (sub_1981( 14, iVar3 )))
        {
    ...
    {
        iVar3 = sub_2462( I );
        if ((g_U10994[g_U11583[I]._fU28]._fU0) AND (sub_1981( g_U11583[I]._fU12, iVar3 )))
        {
...
void sub_2999()
{
    ...
    for ( I = 0; I < 65; I++ )
    {
        if ((g_U10994[g_U11583[I]._fU28]._fU0) AND (sub_2462( I )))
        {
            iVar4++;
        }
    }
                        ...
                        if (IS_CHAR_SITTING_IN_CAR( l_U285[l_U448], l_U326[l_U448] ))
                        {
                            switch (l_U223[l_U448])
                            {
                                ...
                                if (HAS_CAR_RECORDING_BEEN_LOADED( l_U452[l_U448] ))
                                {
                                    ...
                                    if ((sub_5945( l_U326[l_U448], l_U448 )) || (l_U324 == 7))
                                    {
                                        if ((sub_5945( l_U326[l_U448], l_U448 )) || (LOCATE_CAR_3D( l_U326[l_U448], uVar10._fU0, uVar10._fU4, uVar10._fU8, 15.00000000, 15.00000000, 15.00000000, 0 )))
                                        {
                                ...
                                break;
                                case 4:
                                if ((LOCATE_CAR_3D( l_U326[l_U448], l_U335[l_U448]._fU0, l_U335[l_U448]._fU4, l_U335[l_U448]._fU8, 5.00000000, 5.00000000, 5.00000000, 0 )) || (NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U326[l_U448] ))))
                                {
                                    if (NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U326[l_U448] )))
                                    {
                                        l_U223[l_U448] = 5;
    ...
    for ( J = 0; J < 5; J++ )
    {
        if (NOT (IS_CHAR_INJURED( l_U316[J] )))
        {
            if (NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U316[J], l_U357[J]._fU0, l_U357[J]._fU4, l_U357[J]._fU8, 2.00000000, 2.00000000, 2.00000000, 0 )))
            {
                ...
                if ((NOT (IS_PED_IN_COMBAT( l_U316[J] ))) AND (l_U324 == 7))
                {
                    CLEAR_CHAR_TASKS( l_U316[J] );
                    OPEN_SEQUENCE_TASK( ref l_U323 );
...
void sub_11827()
{
    if ((NOT (HAVE_ANIMS_LOADED( l_U541 ))) || ((NOT (HAS_MODEL_LOADED( l_U284 ))) || ((NOT (HAS_MODEL_LOADED( l_U283 ))) || (NOT (HAS_MODEL_LOADED( l_U282 ))))))
    {
        REQUEST_MODEL( l_U282 );
        REQUEST_MODEL( l_U283 );
        REQUEST_MODEL( l_U284 );
...
void sub_13157()
{
    ...
    for ( l_U448 = 0; l_U448 < 5; l_U448++ )
    {
        if ((NOT l_U242[l_U448]) AND (IS_VEH_DRIVEABLE( l_U326[l_U448] )))
        {
            if (NOT (IS_CHAR_INJURED( l_U285[l_U448] )))
            {
                if (IS_CHAR_SITTING_IN_CAR( l_U285[l_U448], l_U326[l_U448] ))
                    ...
                    if (NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U326[l_U448] )))
                    {
                        if (IS_CAR_PASSENGER_SEAT_FREE( l_U326[l_U448], 0 ))
                        {
                            if (NOT l_U236[l_U448])
                            {
                                if (NOT (IS_CHAR_DEAD( sub_1533() )))
                                {
                                    if ((NOT (IS_WANTED_LEVEL_GREATER( sub_1490(), 0 ))) AND (LOCATE_CHAR_ON_FOOT_CAR_3D( sub_1533(), l_U326[l_U448], 3.50000000, 3.50000000, 2.00000000, 0 )))
                                    {
                                        if ((sub_13451()) AND (IS_SCORE_GREATER( sub_1490(), ProtectedGet(l_U220) - 1 )))
                                        {
...
void sub_19891()
{
    ...
    if (IS_VEH_DRIVEABLE( l_U325 ))
    {
        if ((IS_CHAR_SITTING_IN_CAR( sub_1533(), l_U325 )) AND (NOT (IS_CHAR_INJURED( l_U322 ))))
        {
            SET_PLAYER_CAN_DO_DRIVE_BY( sub_1490(), 0 );
            if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U325 ))
            {
                ...
                if (l_U430)
                {
                    ...
                    else if (l_U232)
                    {
                        if (NOT l_U234)
                        {
                            if ((l_U235) || (NOT IS_HELP_MESSAGE_BEING_DISPLAYED()))
                            {
                                CLEAR_HELP();
                                ADD_NEXT_MESSAGE_TO_PREVIOUS_BRIEFS( 0 );
                                PRINT_HELP( "HETR_03" );
                ...
                if (l_U471 < l_U485)
                {
                    ...
                    else if (((l_U471 - 1) <= l_U487) AND (l_U471 > l_U486))
                    {
                        if (NOT l_U281)
                        {
                            if (NOT (sub_20693( l_U548 )))
...
void sub_26276()
{
    if (IS_VEH_DRIVEABLE( l_U325 ))
    {
        switch (l_U222)
        {
            ...
            if ((g_U9254) AND ((g_U9253) AND ((g_U9252) AND ((g_U9251) AND (g_U9250)))))
            {
