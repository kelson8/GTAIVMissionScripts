...
void sub_2128()
{
    ...
    {
        if ((g_U572[I]._fU20) AND ((sub_2166( 5, g_U572[I] )) == 1))
        {
    ...
    for ( I = 0; I <= ((uParam0^) - 1); I++ )
    {
        if (DOES_CHAR_EXIST( (uParam0^)[I]._fU0 ))
        {
            if (NOT (IS_CHAR_INJURED( (uParam0^)[I]._fU0 )))
            {
                ...
                if ((IS_CHAR_RESPONDING_TO_EVENT( (uParam0^)[I]._fU0, 9 )) || ((iVar4 < ProtectedGet((uParam0^)[I]._fU40)) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( (uParam0^)[I]._fU0, sub_3405(), 0 ))))
                {
                    return 1;
                }
            }
...
void sub_6362()
{
    if (NOT l_U2042)
    {
        ...
        l_U1308._fU56 = 0;
        l_U852[0]._fU12 = {2353.21100000, 418.29410000, 5.01310000};
        ...
        l_U2243[0] = {2364.39500000, 398.00960000, 5.08020000};
...
int sub_15233()
{
    ...
    for ( I = 0; I <= (g_U572 - 1); I++ )
    {
        if ((g_U572[I]._fU20) AND ((sub_2166( 1, g_U572[I] )) != 0))
        {
            sub_2452( I );
            return 1;
        }
...
void sub_20701(int iParam0, int iParam1)
{
    ...
    if ((iParam1 != sub_3405()) AND (iParam0->_fU8 == sub_3405()))
    {
        if (iParam0->_fU0 == g_U11198)
        {
            g_U11198 = nil;
...
{
    return (NOT (sub_20821( uParam0, uParam1 ))) AND (IS_CHAR_SITTING_IN_CAR( uParam0, uParam1 ));
}
...
void sub_25871()
{
    if ((l_U2113[0]) AND (NOT l_U2083[0]))
    {
...
void sub_26874()
{
    ...
    if (NOT l_U2053[3])
    {
        if ((sub_14495( ref l_U2152, 10000 )) || (IS_CHAR_IN_ANGLED_AREA_3D( sub_3405(), 2336.11400000, 394.62600000, 2.08500000, 2346.09400000, 395.26800000, 10.08500000, 50.00000000, 0 )))
        {
    ...
    sub_35733();
    if ((sub_36459( ref l_U815, 1 )) AND ((sub_36459( ref l_U742, 1 )) AND ((sub_36459( ref l_U669, 1 )) AND (sub_36117( ref l_U546 )))))
    {
        if (NOT l_U2099)
        {
            SET_FAKE_WANTED_LEVEL( 0 );
...
void sub_27941()
{
    if (NOT l_U2106)
    {
        ...
        if ((l_U516 == 4) || (l_U516 == 5))
        {
            if ((IS_CHAR_INJURED( l_U1596[2]._fU0 )) AND (IS_CHAR_INJURED( l_U1596[1]._fU0 )))
            {
...
void sub_28981()
{
    if ((g_U11004) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_4409(), 0 ))))
    {
...
void sub_29449()
{
    if (NOT l_U2105)
    {
        if (NOT (IS_VEH_DRIVEABLE( l_U1581._fU0 )))
        {
            ...
            if ((sub_14495( ref l_U2162, 7000 )) || ((l_U1581._fU12._fU8 - l_U2182) < 1.00000000))
            {
                sub_29650();
            }
        }
        else if ((NOT (IS_CHAR_SITTING_IN_CAR( l_U1596[0]._fU0, l_U1581._fU0 ))) || (IS_CHAR_INJURED( l_U1596[0]._fU0 )))
        {
            sub_29489();
...
void sub_37561()
{
    ...
    if ((sub_38131( ref l_U1581._fU0, 250.00000000, 0 )) AND ((NOT l_U2106) AND (sub_37972( l_U1581._fU0 ))))
    {
        if (NOT l_U2109)
        {
            SET_CAM_ACTIVE( l_U2290, 1 );
    ...
    if (DOES_BLIP_EXIST( l_U2273 ))
    {
        if (LOCATE_CHAR_ANY_MEANS_3D( sub_3405(), l_U2196._fU0, l_U2196._fU4, l_U2196._fU8, 3.50000000, 3.50000000, 3.50000000, 1 ))
        {
            if (sub_43015())
            {
                ...
                if ((NOT (sub_43689( ref l_U255 ))) AND (sub_43619( ref l_U255 )))
                {
...
void sub_39027()
{
    ...
    {
        case 0:
        if ((l_U2106) AND (sub_39107( ref l_U528._fU0, ref l_U255, 1 )))
        {
            if (NOT l_U2141)
            {
...
int sub_39107(unknown uParam0, unknown uParam1, boolean bParam2)
{
    if (NOT (IS_CHAR_INJURED( (uParam0^) )))
    {
        if (IS_PED_IN_GROUP( (uParam0^) ))
        {
            ...
            if ((IS_CHAR_ON_FOOT( sub_3405() )) AND (IS_CHAR_ON_FOOT( (uParam0^) )))
            {
                return 1;
            }
            if (DOES_VEHICLE_EXIST( (uParam1^) ))
            {
                ...
                {
                    if ((IS_CHAR_SITTING_IN_CAR( sub_3405(), (uParam1^) )) AND (IS_CHAR_SITTING_IN_CAR( (uParam0^), (uParam1^) )))
                    {
                        return 1;
                    }
                }
...
void sub_44851()
{
    if ((l_U2113[1]) AND (NOT l_U2083[1]))
    {
        if (sub_25910( ref l_U2145, 1000 ))
        {
            INCREMENT_INT_STAT( 372, 1 );
    ...
    switch (l_U518)
    {
        ...
        if ((NOT (sub_32472( l_U2291[0] ))) AND (l_U2128))
        {
            if (l_U2049)
            {
                SET_CAM_PROPAGATE( l_U2289, 0 );
        ...
        break;
        case 3:
        if ((NOT (IS_CHAR_PLAYING_ANIM( l_U528._fU0, "misselizabeta2", "F_Kiss_Stand" ))) AND (NOT (IS_CHAR_PLAYING_ANIM( sub_3405(), "misselizabeta2", "M_Kiss_Stand" ))))
        {
            OPEN_SEQUENCE_TASK( ref l_U528._fU48 );
            TASK_FOLLOW_NAV_MESH_TO_COORD( 0, 378.21610000, 1529.99200000, 15.94980000, 2, -1, 1.00000000 );
            CLOSE_SEQUENCE_TASK( l_U528._fU48 );
        ...
        break;
        case 6:
        if ((sub_14495( ref l_U2143, 3500 )) || (NOT (IS_CHAR_ON_SCREEN( l_U528._fU0 ))))
        {
            l_U518 = 7;
        }
        break;
