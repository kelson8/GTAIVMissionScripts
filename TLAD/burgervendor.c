...
void sub_2680(unknown uParam0)
{
    ...
    {
        if ((sub_4421( l_U21 )) || ((IS_PLAYER_TARGETTING_CHAR( sub_525(), l_U70 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U70, sub_653(), 0 ))))
        {
            if (NOT (IS_CHAR_INJURED( l_U69 )))
            {
                CLEAR_CHAR_TASKS( l_U69 );
            ...
            if (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_525() ))
            {
                ...
                if (l_U73 == nil)
                {
                    if (HAVE_ANIMS_LOADED( "amb@burgercart" ))
                    {
                        if (NOT (IS_CHAR_INJURED( l_U69 )))
                        {
                            if ((NOT (IS_CHAR_IN_ANY_CAR( sub_653() ))) AND (l_U13 != 1))
                            {
...
int sub_5933(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_525() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_525() )))
            {
                if (((g_U10499) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_525() )))))
                {
                    if (NOT sub_3472())
                    {
...
void sub_8764()
{
    ...
    if (NOT (IS_CHAR_INJURED( l_U69 )))
    {
        switch (l_U14)
        {
            ...
            if ((l_U57 == 0) AND (l_U40 > 0.02410000))
            {
                if (DOES_OBJECT_EXIST( l_U71 ))
                {
            ...
            if ((l_U55 == 0) AND (l_U40 > 0.64400000))
            {
                if (DOES_OBJECT_EXIST( l_U71 ))
                {
                    if (IS_OBJECT_ATTACHED( l_U71 ))
            ...
            if ((l_U56 == 0) AND (l_U52 > 0.93500000))
            {
                if (NOT (IS_CHAR_INJURED( l_U70 )))
                {
...
void sub_11041()
{
    if (NOT (IS_CHAR_INJURED( l_U69 )))
    {
        switch (l_U14)
        {
            ...
            if ((l_U57 == 0) AND (l_U40 > 0.28400000))
            {
            ...
            BLOCK_CHAR_GESTURE_ANIMS( sub_653(), 1 );
            if ((NOT (IS_CHAR_PLAYING_ANIM( sub_653(), "amb@burgercart", "EAT_BURGER_PLYR" ))) || (l_U40 > 0.80000000))
            {
                if (DOES_OBJECT_EXIST( l_U72 ))
                {
                    if (IS_OBJECT_ATTACHED( l_U72 ))
...
int sub_11172()
{
    if ((sub_11220()) || ((IS_BUTTON_PRESSED( 0, 16 )) || ((IS_BUTTON_PRESSED( 0, 15 )) || ((IS_BUTTON_PRESSED( 0, 14 )) || (IS_BUTTON_PRESSED( 0, 17 ))))))
    {
        CLEAR_CHAR_TASKS_IMMEDIATELY( sub_653() );
        SET_PLAYER_CONTROL( sub_525(), 1 );
        return 1;
