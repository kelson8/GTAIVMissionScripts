...
int sub_3212()
{
    ...
    if (IS_PLAYER_PLAYING( sub_3286() ))
    {
        ...
        {
            if ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_3286(), l_U115 )) || (sub_3347()))
            {
        ...
        if (NOT sub_3995())
        {
            ...
            if ((IS_ANY_CHAR_SHOOTING_IN_AREA( vVar2, vVar5, 0 )) || (IS_CHAR_SHOOTING( sub_2856() )))
            {
                sub_3459( l_U135, l_U134 );
                return 1;
            }
...
int sub_6121(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_3286() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_3286() )))
            {
                if (((g_U10499) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_3286() )))))
                {
                    if (NOT sub_6217())
                    {
    ...
    if ((NOT (IS_CHAR_INJURED( l_U115 ))) AND (NOT (IS_CHAR_INJURED( sub_2856() ))))
    {
        switch (l_U106)
        {
            ...
            else
            {
                ...
                {
                    if ((IS_PLAYER_CLIMBING( sub_3286() )) || (TIMERB() > 5000))
                    {
                        ;
                    }
                }
            ...
            if ((NOT (IS_CHAR_PLAYING_ANIM( sub_2856(), "amb@FFOOD_SERVER", "EAT_BURGER_PLYR" ))) || (fVar3 > 0.90000000))
            {
                if (DOES_OBJECT_EXIST( l_U118 ))
                {
                    if (IS_OBJECT_ATTACHED( l_U118 ))
