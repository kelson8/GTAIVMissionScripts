...
int sub_33202(unknown uParam0, int iParam1, boolean bParam2)
{
    ...
    if (NOT (iParam1 == nil))
    {
        if ((IS_CHAR_INJURED( iParam1 )) || (sub_33274()))
        {
            l_U505 = 1;
            l_U506 = 0;
...
void sub_44147(unknown uParam0, unknown uParam1)
{
    ...
    if ((NOT sub_35400()) || (NOT sub_44208()))
    {
        return;
    }
    sub_36902();
...
{
    if ((NOT (HAS_MODEL_LOADED( sub_44790( uParam0 ) ))) || (NOT (sub_35327( uParam0 ))))
    {
        sub_35366( uParam0 );
...
void sub_45069(vector vParam0, unknown uParam3, unknown uParam4, unknown uParam5, int iParam6, boolean bParam7)
{
    ...
    sub_45103( vParam0 + (vector( 0.00000000, 0.00000000, 2.00000000)), uParam3, uParam4, iParam6 );
...
{
    return (NOT (sub_50190( uParam0, uParam1 ))) AND (IS_CHAR_SITTING_IN_CAR( uParam0, uParam1 ));
}
...
void sub_63566()
{
    ...
    sub_63894( iVar3[54], -1378.11200000, 510.59840000, 13.97960000, 95.79300000, -1382.08400000, 528.18780000, 16.99844000, -11.86755000, -0.00000000, -132.35800000 );
...
int sub_66045(unknown uParam0, unknown uParam1, unknown uParam2)
{
        ...
        for ( I = 0; I < 1; I++ )
        {
            if (l_U514 == -1)
            {
                if (sub_66892( I ))
                {
                    ...
                    if ((sub_67103( 1, 1 )) AND ((NOT (sub_37472( sub_1568() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U611[I]._fU4._fU0, l_U611[I]._fU4._fU4, fVar8, 2.50000000, 2.50000000, 2.50000000, iVar9 ))))
                    {
    ...
    if (l_U502 == 2)
    {
        if ((iVar5 > l_U627) || (sub_67612( uParam0 )))
        {
            l_U514 = l_U628;
            l_U502 = 3;
        }
...
int sub_75815(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    {
        bVar6 = true;
        if ((NOT (sub_37472( sub_1568() ))) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() )))
        {
...
void sub_98041(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if (l_U1194 == 1)
    {
        if (NOT (IS_CHAR_ON_FOOT( sub_1568() )))
        {
            if ((iVar5 > l_U1224) || (sub_98164( uParam1, 20.00000000 )))
            {
                l_U1194++;
            }
            else
...
int sub_103786(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 6; Result++ )
    {
        ...
        if ((NOT (sub_103921( iVar4 ))) AND (sub_103858( Result )))
        {
            iVar5 = g_U11583[iVar4]._fU28 == g_U10999;
            fVar6 = l_U1002[Result]._fU4._fU8;
            if ((sub_67103( 1, 1 )) AND ((NOT (sub_37472( sub_1568() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U1002[Result]._fU4._fU0, l_U1002[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 ))))
            {
...
int sub_104213(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 16; Result++ )
    {
        if (sub_104272( Result ))
        {
            ...
            if ((sub_67103( 1, 1 )) AND ((NOT (sub_37472( sub_1568() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U629[Result]._fU4._fU0, l_U629[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 ))))
            {
                if (IS_CHAR_ON_FOOT( sub_1568() ))
                {
                    if (sub_98164( uParam0, 1092616192 ))
...
int sub_122486(unknown uParam0)
{
    ...
    if ((sub_122576( uParam0, "Bada_room1" )) || ((sub_122576( uParam0, "Bada_room2" )) || ((sub_122576( uParam0, "Bada-Private" )) || (sub_122576( uParam0, "Bada_room1" )))))
    {
        return 1;
    }
    if ((sub_122576( uParam0, "clammainroom" )) || ((sub_122576( uParam0, "clamfronrm" )) || ((sub_122576( uParam0, "clampalbkrm" )) || (sub_122576( uParam0, "clammainroom" )))))
    {
        return 1;
    }
    return 0;
...
void sub_123812(unknown uParam0)
{
    ...
    if (l_U521._fU12)
    {
        if (g_U18635[l_U416]._fU892._fU40 >= 0)
        {
            ...
            if (NOT l_U521._fU24)
            {
                if (((sub_105045( l_U465 )) > 5) || (sub_137288( ref l_U465 )))
                {
                    bVar5 = true;
                }
            }
...
void sub_123988(unknown uParam0)
{
    ...
    if ((sub_124011( uParam0 )) || (IS_CHAR_DEAD( sub_1568() )))
    {
        return;
    }
    if ((sub_124252( uParam0 )) || (IS_CHAR_ON_ANY_BIKE( sub_1568() )))
    {
        sub_124392( uParam0 );
        return;
    }
...
int sub_125858(unknown uParam0)
{
    ...
    if (NOT l_U521._fU8)
    {
        if ((NOT (sub_124011( uParam0 ))) AND (NOT (IS_CHAR_DEAD( sub_1568() ))))
        {
            if (IS_CHAR_ON_ANY_BIKE( sub_1568() ))
            {
...
int sub_126742(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((uParam2) AND (NOT g_U18635[uParam0]._fU892._fU28))
    {
        ...
        for ( I = 0; I < iVar6; I++ )
        {
            if ((NOT (sub_127176( uParam0, I ))) AND (sub_126911( uParam0, I )))
            {
...
void sub_126865()
{
    ...
    for ( I = 0; I < iVar2; I++ )
    {
        if ((sub_126911( 7, I )) || ((sub_126911( 6, I )) || (sub_126911( 1, I ))))
        {
            sub_127003( 1, I );
            sub_127003( 6, I );
            sub_127003( 7, I );
        ...
        if ((sub_127176( 7, I )) || ((sub_127176( 6, I )) || (sub_127176( 1, I ))))
        {
            sub_127268( 1, I );
            sub_127268( 6, I );
            sub_127268( 7, I );
...
int sub_138357(int iParam0)
{
    ...
    if (iVar4 == iVar3)
    {
        if (NOT (((sub_138500( iVar3 )) == sub_138529()) AND ((sub_45868( iParam0 + 0 )) == 3)))
        {
            if (((NOT (IS_CHAR_GETTING_IN_TO_A_CAR( sub_1568() ))) AND (sub_138617( sub_1568() ))) || (((sub_138575( iParam0->_fU0 )) == (sub_17361( 0 ))) || ((sub_45868( iParam0 + 0 )) != 1)))
            {
                return 0;
            }
            else
...
int sub_138773(int iParam0, unknown uParam1, boolean bParam2)
{
    ...
    else if ((NOT (IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU0 ))) AND (sub_138617( iParam0->_fU0 )))
    {
        return 2;
    }
    else if ((sub_88480( iParam0, 1 )) || (uParam1))
    {
        uVar5 = nil;
        if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
        {
...
void sub_139329(int iParam0)
{
    if (NOT (IS_CHAR_INJURED( iParam0->_fU0 )))
    {
        ...
        {
            if ((NOT l_U155) AND ((NOT l_U154) AND (sub_139395( (iParam0^) ))))
            {
                if ((NOT sub_136772()) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
                {
        ...
        {
            if ((NOT (sub_75489( l_U147 ))) || ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() ))) || ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU0 ))) || ((NOT (IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 ))) || ((NOT (IS_CHAR_ON_ANY_BIKE( sub_1568() ))) || (NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_1568(), iParam0->_fU0, l_U145, l_U145, l_U145, 0 ))))))))
            {
                sub_140782( iParam0 );
            }
        }
...
void sub_140945(int iParam0)
{
    ...
    if ((sub_136772()) AND (sub_139360( (iParam0^) )))
    {
    ...
    if (((iVar4 - l_U165) < 33) || ((sub_139360( (iParam0^) )) || (sub_136772())))
    {
        return;
    }
    if (l_U165 <= 0)
    ...
    if ((IS_VEH_DRIVEABLE( iParam0->_fU4 )) AND (NOT (IS_CHAR_INJURED( iParam0->_fU0 ))))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar12 )))
        {
            if (sub_141872( uVar12 ))
            {
                ...
                if ((iParam0->_fU0 != l_U167) AND (((fVar21 < 15) || ((fVar21 < 19) AND (IS_CHAR_ON_SCREEN( iParam0->_fU0 )))) AND (NOT (sub_139360( (iParam0^) )))))
                {
                    GET_CAR_PITCH( uVar12, ref uVar22 );
                    if ((((sub_52552( 0, 10 )) == 0) || (iParam0->_fU36 != 1)) AND (l_U104))
                    {
                        l_U104 = 0;
                        iVar15 = 17;
                        iVar11 = sub_1568();
                    }
                    else if ((NOT (IS_BIT_SET( l_U170, 6 ))) AND (((sub_45868( iParam0 + 0 )) == 1) AND ((iParam0->_fU36 == 2) AND (sub_142109( iParam0 )))))
                    {
                        iVar15 = 38;
                        uVar13 = sub_142223( bVar16 );
                        iVar11 = sub_1568();
                    }
                    else if ((sub_142311( 8 )) AND (((ABSF( uVar22 )) < 20.00000000) AND (IS_CAR_IN_AIR_PROPER( uVar12 ))))
                    {
                        uVar13 = sub_51378( bVar16 );
                        iVar15 = 8;
                    }
                    else if ((sub_142311( 12 )) AND (HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, sub_1568() )))
                    {
                        uVar13 = sub_142223( bVar16 );
                        iVar11 = sub_1568();
                        iVar15 = 12;
                    ...
                    else if ((sub_142311( 13 )) AND ((IS_PED_RAGDOLL( iParam0->_fU0 )) || (HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, 0 ))))
                    {
                        uVar13 = sub_142223( bVar16 );
                        iVar11 = nil;
                        iVar15 = 13;
                    ...
                    else if ((sub_142311( 20 )) AND ((IS_BIT_SET( l_U170, 7 )) AND ((NOT (IS_PLAYER_PRESSING_HORN( sub_4208() ))) AND ((sub_45868( iParam0 + 0 )) == 1))))
                    {
                        if (bVar16)
                        {
                            bVar18 = true;
                    ...
                    else if (((sub_45868( iParam0 + 0 )) == 1) AND ((sub_142311( 24 )) AND ((NOT (IS_BIT_SET( l_U170, 0 ))) AND (IS_WANTED_LEVEL_GREATER( sub_4208(), 0 )))))
                    {
                        iVar15 = 24;
                        iVar11 = sub_1568();
                    }
                    else if (((sub_45868( iParam0 + 0 )) == 1) AND ((sub_142311( 30 )) AND ((IS_BIT_SET( l_U170, 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_4208(), 0 ))))))
                    {
                        iVar15 = 30;
                    }
                    else
                    {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if (((sub_45868( iParam0 + 0 )) == 1) AND ((NOT (IS_BIT_SET( l_U170, 4 ))) AND (sub_142311( 33 ))))
                                {
                            ...
                            else if (IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() ))
                            {
                                ...
                                if (DOES_VEHICLE_EXIST( uVar23 ))
                                {
                                    if (((sub_45868( iParam0 + 0 )) == 1) AND ((NOT (IS_BIT_SET( l_U170, 4 ))) AND (sub_142311( 31 ))))
                                    {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (GET_CLOSEST_CHAR( uVar5._fU0, uVar5._fU4, uVar5._fU8, 25.00000000, 1, 1, ref iVar11 ))
                            {
                                ...
                                else if ((NOT (IS_WANTED_LEVEL_GREATER( sub_4208(), 0 ))) AND (sub_142311( 0 )))
                                {
                                ...
                                else if ((NOT (IS_BIT_SET( l_U170, 1 ))) AND ((IS_WANTED_LEVEL_GREATER( sub_4208(), 0 )) AND (sub_142311( 36 ))))
                                {
                                    if (IS_CHAR_ON_SCREEN( iVar11 ))
                                    {
                                        uVar13 = nil;
                                ...
                                else if ((sub_142311( 23 )) AND (IS_WANTED_LEVEL_GREATER( sub_4208(), 2 )))
                                {
                                    uVar13 = nil;
                                    iVar15 = 23;
                                };;;;
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (IS_VEH_DRIVEABLE( uVar23 ))
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        case 2:
                                        if (((sub_45868( iParam0 + 0 )) == 1) AND (sub_142311( 28 )))
                                        {
                                            iVar15 = 28;
                                        }
                                        break;
                                        ...
                                        {
                                            if ((sub_142311( 4 )) AND (sub_142311( 3 )))
                                            {
                                                if (g_U15728[13])
                                                {
                                                    iVar15 = 4;
                        ...
                        if (iVar15 == 39)
                        {
                            if ((fVar26 < 5) AND ((sub_45868( iParam0 + 0 )) == 1))
                            {
                                if ((IS_WANTED_LEVEL_GREATER( sub_4208(), 0 )) AND (sub_142311( 23 )))
                                {
                                    iVar15 = 23;
                                }
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if (((sub_45868( iParam0 + 0 )) == 1) AND (sub_142311( 30 )))
                                {
                                    iVar15 = 30;
                                }
...
int sub_146784(int iParam0)
{
    ...
    if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar3 )))
        {
            ...
            {
                if ((((sub_45868( iParam0 + 0 )) == 1) AND (iVar4 == sub_1568())) || ((sub_45868( ref iVar4 )) == (sub_45868( iParam0 + 0 ))))
                {
...
int sub_147041(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if (((sub_141935( iParam0->_fU0, sub_1568(), 1 )) < 90.00000000) || ((IS_CAR_ON_SCREEN( iParam0->_fU4 )) || ((IS_CHAR_ON_SCREEN( iParam0->_fU0 )) || (IS_CHAR_IN_CAR( sub_1568(), iParam0->_fU4 )))))
        {
...
int sub_148173(int iParam0)
{
    ...
    if ((IS_VEH_DRIVEABLE( iParam0->_fU4 )) AND (NOT (sub_88480( iParam0, 2 ))))
    {
        return 0;
    }
...
int sub_148708(int iParam0)
{
    ...
    else if (((sub_141935( iParam0->_fU0, sub_1568(), 1 )) > 90.00000000) AND ((NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))) AND ((sub_145830( iParam0 )) > 90.00000000)))
    {
        ...
        {
            if (((VDIST( sub_139118( sub_1568(), 1 ), uVar4 )) < 30.00000000) || ((IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000, 2.00000000, 2.00000000 )) || (CAM_IS_SPHERE_VISIBLE( uVar3, uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000 ))))
            {
                ;
            }
            else if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
...
int sub_149480(int iParam0)
{
    ...
    if (((sub_145830( iParam0 )) < 30.00000000) AND (sub_88480( iParam0, 1 )))
    {
        SET_CHAR_WILL_LEAVE_CAR_IN_COMBAT( iParam0->_fU0, 1 );
    ...
    if ((((sub_141935( iParam0->_fU0, iParam0->_fU8, 1 )) > fVar8) || ((DOES_VEHICLE_EXIST( iVar4 )) || ((IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU8 )) || (IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU8 ))))) AND (NOT (IS_CHAR_IN_WATER( iParam0->_fU8 ))))
    {
        if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
        {
            if ((iParam0->_fU4 == iVar4) || (sub_50190( iParam0->_fU8, iParam0->_fU4 )))
            {
            ...
            else if (((sub_45868( iParam0 + 0 )) == 1) AND (sub_50190( sub_1568(), iParam0->_fU4 )))
            {
    ...
    else if (((sub_45868( iParam0 + 0 )) == 1) AND ((iParam0->_fU8 != sub_1568()) AND (sub_147079( sub_1568(), iParam0->_fU0, 1 ))))
    {
    ...
    if (IS_CHAR_IN_WATER( iParam0->_fU8 ))
    {
        ...
        else if ((IS_CHAR_IN_ANY_CAR( iParam0->_fU0 )) || (NOT (sub_88480( iParam0, 1 ))))
        {
            if ((sub_138935( iParam0 )) != 0)
            {
                ;
    ...
    else if ((NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU8 ))) AND (sub_88480( iParam0, 1 )))
    {
...
int sub_151233(int iParam0)
{
    ...
    else if (((sub_141915( iParam0 )) > 30.00000000) AND (NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))))
    {
...
int sub_151644(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if (((VDIST( uVar4, uVar7 )) < 30.00000000) || (((VDIST( uVar4, uVar10 )) < 30.00000000) || ((IS_CAR_ON_SCREEN( iParam0->_fU4 )) || (IS_CHAR_ON_SCREEN( iParam0->_fU0 )))))
        {
            ...
            else if (((sub_45868( ref iVar3 )) == (sub_45868( iParam0 + 0 ))) || (iVar3 == sub_1568()))
            {
...
int sub_152470(int iParam0)
{
    ...
    if (((sub_145830( iParam0 )) < 30.00000000) AND ((IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 115 )) || ((IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 110 )) || (IS_PED_IN_COMBAT( iParam0->_fU0 )))))
    {
        return 2;
    }
    return 0;
...
int sub_152619(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( uVar10 ))
    {
        ...
        else if (((sub_141915( iParam0 )) >= l_U125) AND ((sub_88480( iParam0, 4 )) || (sub_146358( iParam0->_fU4 ))))
        {
        ...
        if (NOT (IS_CAR_ON_SCREEN( iParam0->_fU4 )))
        {
            ...
            if (GET_CLOSEST_CAR_NODE_WITH_HEADING( vVar9.x, vVar9.y, vVar9.z, ref uVar15._fU0, ref uVar15._fU4, ref uVar15._fU8, ref uVar18 ))
            {
                if (NOT (IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar15._fU0, uVar15._fU4, uVar15._fU8, 4.00000000, 4.00000000, 4.00000000 )))
                {
                    ...
                    if (((VDIST2( uVar15, vVar6 )) > 9.00000000) AND (((VDIST( uVar15, sub_139118( sub_1568(), 1 ) )) > fParam2) AND (NOT (CAM_IS_SPHERE_VISIBLE( uVar19, uVar15._fU0, uVar15._fU4, uVar15._fU8, 6.00000000 )))))
                    {
...
void sub_159673(unknown uParam0)
{
    ...
    if ((NOT bVar4) AND ((iVar8 >= 0) AND ((NOT (iVar14 == 4)) AND ((NOT sub_162019()) AND ((IS_CHAR_ON_ANY_BIKE( sub_1568() )) AND ((NOT (IS_CONTROL_PRESSED( 0, 39 ))) AND ((NOT (IS_CONTROL_PRESSED( 0, 38 ))) AND (IS_CONTROL_PRESSED( 0, 51 )))))))))
    {
...
void sub_159908(unknown uParam0)
{
    ...
    {
        if ((Result < 0) AND ((I != l_U110) AND (sub_159944( uParam0, I ))))
        {
            Result = I;
        }
    }
...
void sub_162603(unknown uParam0)
{
    ...
    if (HAS_SCRIPT_LOADED( "ability_stats" ))
    {
        if (NOT g_U39103)
        {
            if ((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) AND ((NOT g_U11112) AND ((NOT IS_MINIGAME_IN_PROGRESS()) AND ((NOT sub_165091()) AND (((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "ability_stats" )) == 0) AND (NOT sub_162019()))))))
            {
                if (NOT l_U1236)
                {
...
int sub_165091()
{
    ...
    {
        if ((sub_165125()) AND (ARE_WIDESCREEN_BORDERS_ACTIVE()))
        {
            return 1;
        }
