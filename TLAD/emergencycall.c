...
int sub_845(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_1076() ))) AND (IS_CHAR_IN_ANY_CAR( sub_1076() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_1408()))
        {
            return 0;
        }
        g_U94._fU60 = uParam0;
...
void sub_9613()
{
    ...
    if ((NOT (sub_10957( sub_1076() ))) AND ((COUNT_SCRIPT_CAMS_BY_TYPE_AND_OR_STATE( -1, 1, 1 )) > 0))
    {
        sub_10688();
        l_U104 = 6;
    }
...
int sub_14226()
{
    if (NOT (IS_CHAR_INJURED( l_U280 )))
    {
        if (NOT (IS_CHAR_IN_ANY_CAR( sub_1076() )))
        {
            ...
            {
                if ((IS_SCORE_GREATER( sub_344(), sub_14339() )) AND (l_U113 < 175))
                {
                    return 1;
                }
            }
