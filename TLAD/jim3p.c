void main()
{
    ...
    while (true)
    {
        ...
        switch (l_U355)
        {
            case 0:
            sub_1915();
            if ((l_U441 == 0) AND (sub_2599( iVar14 )))
            {
            ...
            sub_330( "HERE6" );
            l_U356 = 0;
            if ((NOT g_U94._fU580) AND (NOT g_U12303))
            {
                sub_8317();
            }
            else
...
void sub_855(unknown uParam0, unknown uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
    ...
    if (g_U15862[uParam0]._fU228._fU76[uParam1]._fU0[0] == -1)
    {
        ...
        if (iParam5 != -1)
        {
            ...
            {
                if ((g_U15862[uParam0]._fU228._fU76[uParam1]._fU0[I] == iParam4) || (g_U15862[uParam0]._fU228._fU76[uParam1]._fU0[I] == iParam3))
                {
                    for ( J = I + 1; J <= (I + iParam5); J++ )
                    {
                        if (J < iParam2)
                        {
                            if ((g_U15862[uParam0]._fU228._fU76[uParam1]._fU0[J] == iParam4) || (g_U15862[uParam0]._fU228._fU76[uParam1]._fU0[J] == iParam3))
                            {
...
void sub_1915()
{
    ...
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( sub_395(), vVar29.x, vVar29.y, vVar29.z, 100.00000000, 100.00000000, 50.00000000, 0 )) || ((LOCATE_CHAR_ANY_MEANS_3D( sub_395(), vVar26.x, vVar26.y, vVar26.z, 100.00000000, 100.00000000, 50.00000000, 0 )) || ((LOCATE_CHAR_ANY_MEANS_3D( sub_395(), vVar23.x, vVar23.y, vVar23.z, 100.00000000, 100.00000000, 50.00000000, 0 )) || ((LOCATE_CHAR_ANY_MEANS_3D( sub_395(), vVar20.x, vVar20.y, vVar20.z, 100.00000000, 100.00000000, 50.00000000, 0 )) || ((LOCATE_CHAR_ANY_MEANS_3D( sub_395(), vVar17.x, vVar17.y, vVar17.z, 100.00000000, 100.00000000, 50.00000000, 0 )) || ((LOCATE_CHAR_ANY_MEANS_3D( sub_395(), vVar14.x, vVar14.y, vVar14.z, 100.00000000, 100.00000000, 50.00000000, 0 )) || ((LOCATE_CHAR_ANY_MEANS_3D( sub_395(), vVar11.x, vVar11.y, vVar11.z, 100.00000000, 100.00000000, 50.00000000, 0 )) || ((LOCATE_CHAR_ANY_MEANS_3D( sub_395(), vVar8.x, vVar8.y, vVar8.z, 100.00000000, 100.00000000, 50.00000000, 0 )) || ((LOCATE_CHAR_ANY_MEANS_3D( sub_395(), vVar5.x, vVar5.y, vVar5.z, 100.00000000, 100.00000000, 50.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_395(), vVar2.x, vVar2.y, vVar2.z, 100.00000000, 100.00000000, 50.00000000, 0 )))))))))))
        {
            l_U441 = 1;
            sub_330( "Cant call" );
            if (sub_2599( 8 ))
...
int sub_3284(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_395() ))) AND (IS_CHAR_IN_ANY_CAR( sub_395() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_3825()))
        {
            return 0;
        }
        g_U94._fU60 = uParam0;
...
int sub_13242()
{
    ...
    for ( I = 0; I <= (g_U572 - 1); I++ )
    {
        if ((g_U572[I]._fU20) AND ((sub_8893( 1, g_U572[I] )) != 0))
        {
            sub_9144( I );
            return 1;
        }
