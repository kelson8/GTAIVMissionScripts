...
void sub_4385(unknown uParam0)
{
    ...
    iVar7 = 0;
    if ((NOT l_U563._fU88) AND ((NOT (COMPARE_STRING( ref l_U563._fU48, l_U562 ))) AND ((l_U507 == 2) AND (l_U563._fU80 == 1))))
    {
        iVar7 = 1;
    }
    bVar8 = false;
    if (l_U563._fU100)
    {
        ...
        if ((NOT l_U563._fU92) AND ((NOT (COMPARE_STRING( ref l_U563._fU64, l_U562 ))) AND ((bVar9) AND ((l_U507 == 2) AND (l_U563._fU80 == 1)))))
        {
            iVar7 = 1;
            bVar8 = true;
        }
...
void sub_6148(unknown uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
    ...
    if (NOT (IS_CHAR_DEAD( (uParam0^) )))
    {
        ...
        if ((g_U15728[19]) AND ((uParam0^) == sub_2792()))
        {
...
void sub_7541()
{
    ...
    if ((LOCATE_CHAR_ANY_MEANS_CAR_3D( sub_2792(), l_U595, fVar2, fVar2, 30.00000000, 0 )) || (IS_CHAR_IN_CAR( sub_2792(), l_U595 )))
    {
        sub_7674();
        return;
    }
...
int sub_10883()
{
    ...
    fVar3 = 0.00000000;
    GET_CAR_SPEED( uVar2, ref fVar3 );
    if ((sub_10958( 1, 1 )) AND (fVar3 < 0.01000000))
    {
        if (NOT l_U517)
        {
...
int sub_11463()
{
    ...
    GET_GAME_TIMER( ref iVar2 );
    bVar3 = false;
    if ((IS_PLAYER_PRESSING_HORN( sub_4041() )) AND ((sub_10958( 1, 1 )) AND (IS_CHAR_IN_ANY_CAR( sub_2792() ))))
    {
        if (l_U517)
        {
            return 0;
...
int sub_12069(unknown uParam0, unknown uParam1)
{
    ...
    iVar11 = 0;
    if ((NOT l_U520) AND (IS_CHAR_IN_ANY_CAR( sub_2792() )))
    {
        ...
        if (NOT (IS_CHAR_IN_CAR( (uParam0^), uVar7 )))
        {
            if (NOT (l_U555 == 0))
            {
                ...
                if ((NOT (IS_VEH_DRIVEABLE( uVar7 ))) || (l_U555 < iVar12))
                {
                    SET_PLAYER_CONTROL( sub_4041(), 1 );
                    HINT_CAM( -1.00000000, -1.00000000, -1.00000000, 0, 0, 0, 0 );
    ...
    if ((NOT l_U520) AND (IS_HINT_RUNNING()))
    {
        HINT_CAM( -1.00000000, -1.00000000, -1.00000000, 0, 0, 0, 0 );
    }
    sub_7674();
...
int sub_16580(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, boolean bParam5, unknown uParam6)
{
    ...
    if (NOT l_U714)
    {
        if ((IS_CHAR_INJURED( iParam1 )) || (sub_16600()))
        {
            l_U643 = 1;
            l_U644 = 0;
            return 1;
    ...
    if (bVar10)
    {
        ...
        {
            if ((NOT (IS_CHAR_DEAD( iParam1 ))) AND (NOT (IS_CHAR_DEAD( sub_2792() ))))
            {
    ...
    if (l_U640 == 7)
    {
        ...
        else if ((IS_CHAR_DEAD( iParam1 )) || (IS_CHAR_DEAD( sub_2792() )))
        {
            l_U640++;
        }
        else
    ...
    if (l_U640 == 12)
    {
        ...
        if ((TIMERA() > 7000) || (sub_26778( iParam1, l_U675 )))
        {
            l_U640++;
        }
    }
...
int sub_23901()
{
    ...
    if (l_U609 == 1)
    {
        ...
        if ((l_U601 < iVar2) || (fVar4 < 0.04000000))
        {
            SET_PLAYER_CONTROL( sub_4041(), 1 );
            l_U609 = 0;
            return 1;
...
int sub_29269()
{
    ...
    for ( I = 0; I <= (g_U572 - 1); I++ )
    {
        if ((g_U572[I]._fU20) AND ((sub_12862( 1, g_U572[I] )) != 0))
        {
            sub_13113( I );
            return 1;
        }
...
void sub_32699()
{
    ...
    l_U513 = 0;
    if ((NOT (IS_CHAR_DEAD( l_U750 ))) AND (NOT (l_U750 == nil)))
    {
...
void sub_33295(unknown uParam0)
{
    ...
    if (l_U659._fU12)
    {
        if (g_U18635[l_U554]._fU892._fU40 >= 0)
        {
            ...
            if (NOT l_U659._fU24)
            {
                if (((sub_34155( l_U603 )) > 5) || (sub_47080( ref l_U603 )))
                {
                    bVar5 = true;
                }
            }
...
void sub_33471(unknown uParam0)
{
    ...
    if ((sub_33494( uParam0 )) || (IS_CHAR_DEAD( sub_2792() )))
    {
        return;
    }
    if ((sub_33855( uParam0 )) || (IS_CHAR_ON_ANY_BIKE( sub_2792() )))
    {
        sub_33995( uParam0 );
        return;
    }
...
int sub_35505(unknown uParam0)
{
    ...
    if (NOT l_U659._fU8)
    {
        ...
        if ((NOT (IS_CHAR_DEAD( uParam0 ))) AND (NOT (IS_CHAR_DEAD( sub_2792() ))))
        {
            if (IS_CHAR_IN_ANY_CAR( sub_2792() ))
            {
                STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_2792(), ref uVar3 );
...
int sub_35514()
{
    if ((l_U659._fU48) || ((l_U659._fU44) || ((l_U659._fU40) || ((l_U659._fU36) || (l_U659._fU32)))))
    {
        return 1;
    }
    return 0;
...
int sub_35646(unknown uParam0)
{
    ...
    if (NOT l_U659._fU8)
    {
        if ((NOT (sub_33494( uParam0 ))) AND (NOT (IS_CHAR_DEAD( sub_2792() ))))
        {
...
int sub_36530(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((uParam2) AND (NOT g_U18635[uParam0]._fU892._fU28))
    {
        ...
        for ( I = 0; I < iVar6; I++ )
        {
            if ((NOT (sub_36964( uParam0, I ))) AND (sub_36699( uParam0, I )))
            {
                sub_36880( uParam0, I );
            }
        }
...
void sub_36653()
{
    ...
    for ( I = 0; I < iVar2; I++ )
    {
        if ((sub_36699( 7, I )) || ((sub_36699( 6, I )) || (sub_36699( 1, I ))))
        {
            sub_36791( 1, I );
            sub_36791( 6, I );
            sub_36791( 7, I );
        ...
        if ((sub_36964( 7, I )) || ((sub_36964( 6, I )) || (sub_36964( 1, I ))))
        {
            sub_37056( 1, I );
            sub_37056( 6, I );
            sub_37056( 7, I );
...
int sub_46418(unknown uParam0)
{
    ...
    if (l_U659._fU24)
    {
        if (NOT sub_35514())
        {
            ...
            if ((iVar3 > l_U659._fU28) AND (NOT (l_U659._fU28 == 0)))
            {
                l_U659._fU28 = 0;
                if (l_U659._fU8)
                {
