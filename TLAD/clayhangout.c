...
void sub_8630()
{
    ...
    {
        if ((g_U572[I]._fU20) AND ((sub_8668( 5, g_U572[I] )) == 1))
        {
...
int sub_24192()
{
    ...
    for ( I = 0; I <= (g_U572 - 1); I++ )
    {
        if ((g_U572[I]._fU20) AND ((sub_8668( 1, g_U572[I] )) != 0))
        {
            sub_8954( I );
            return 1;
        }
...
int sub_26366(unknown uParam0, int iParam1, boolean bParam2)
{
    ...
    if (NOT (iParam1 == nil))
    {
        if ((IS_CHAR_INJURED( iParam1 )) || (sub_26438()))
        {
            l_U505 = 1;
            l_U506 = 0;
...
void sub_37311(unknown uParam0, unknown uParam1)
{
    ...
    if ((NOT sub_28564()) || (NOT sub_37372()))
    {
        return;
    }
    sub_30066();
...
{
    if ((NOT (HAS_MODEL_LOADED( sub_38074( uParam0 ) ))) || (NOT (sub_28491( uParam0 ))))
    {
        sub_28530( uParam0 );
...
void sub_38353(vector vParam0, unknown uParam3, unknown uParam4, unknown uParam5, int iParam6, boolean bParam7)
{
    ...
    sub_38387( vParam0 + (vector( 0.00000000, 0.00000000, 2.00000000)), uParam3, uParam4, iParam6 );
...
void sub_38397(unknown uParam0)
{
    ...
    if (Result == 0)
    {
        if (((uParam0^) == (sub_16107( 16 ))) || (((uParam0^) == (sub_16107( 13 ))) || (((uParam0^) == (sub_16107( 7 ))) || (((uParam0^) == (sub_16107( 6 ))) || (((uParam0^) == (sub_16107( 1 ))) || ((uParam0^) == (sub_16107( 0 ))))))))
        {
            Result = 1;
        }
        else if (((uParam0^) == (sub_16107( 17 ))) || ((uParam0^) == (sub_16107( 15 ))))
        {
            Result = 3;
        }
    }
...
void sub_39113(int iParam0)
{
    ...
    if (iVar3 == 1)
    {
        ...
        else if ((NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_16107( 7 ) ))) AND (NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_16107( 6 ) ))))
        {
            sub_39609( iParam0 );
        }
    }
...
{
    return (NOT (sub_44001( uParam0, uParam1 ))) AND (IS_CHAR_SITTING_IN_CAR( uParam0, uParam1 ));
}
...
void sub_45529(int iParam0, unknown uParam1, int iParam2, int iParam3)
{
    ...
    if (Result)
    {
        ...
        if (iParam3 != 39)
        {
            if ((IS_CHAR_MODEL( iParam0, sub_16107( 0 ) )) AND (iParam3 == 38))
            {
                if (l_U172)
                {
...
void sub_53749()
{
    ...
    sub_54077( iVar3[54], -1378.11200000, 510.59840000, 13.97960000, 95.79300000, -1382.08400000, 528.18780000, 16.99844000, -11.86755000, -0.00000000, -132.35800000 );
...
void sub_56280()
{
    ...
    TASK_FOLLOW_NAV_MESH_AND_SLIDE_TO_COORD( l_U491, -1721.47500000, 337.99800000, 25.34170000, 2, -2, 1.00000000, 89.09279000 );
    if (NOT g_U39169)
    {
...
void sub_56913()
{
    ...
    if (l_U502 == 1)
    {
        ...
        if ((sub_57799( l_U491 )) AND (sub_57716()))
        {
            l_U502++;
        }
    }
...
void sub_69958(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if (l_U1178 == 1)
    {
        if (NOT (IS_CHAR_ON_FOOT( sub_2582() )))
        {
            if ((iVar5 > l_U1208) || (sub_70081( uParam1, 20.00000000 )))
            {
                l_U1178++;
            }
            else
...
int sub_75703(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 6; Result++ )
    {
        ...
        if ((NOT (sub_75838( iVar4 ))) AND (sub_75775( Result )))
        {
            iVar5 = g_U11583[iVar4]._fU28 == g_U10999;
            fVar6 = l_U986[Result]._fU4._fU8;
            if ((sub_76041( 1, 1 )) AND ((NOT (sub_30636( sub_2582() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_2582(), l_U986[Result]._fU4._fU0, l_U986[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 ))))
            {
...
int sub_76552(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 16; Result++ )
    {
        if (sub_76611( Result ))
        {
            ...
            if ((sub_76041( 1, 1 )) AND ((NOT (sub_30636( sub_2582() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_2582(), l_U613[Result]._fU4._fU0, l_U613[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 ))))
            {
                if (IS_CHAR_ON_FOOT( sub_2582() ))
                {
                    if (sub_70081( uParam0, 1092616192 ))
...
int sub_97003(unknown uParam0)
{
    ...
    if ((sub_97093( uParam0, "Bada_room1" )) || ((sub_97093( uParam0, "Bada_room2" )) || ((sub_97093( uParam0, "Bada-Private" )) || (sub_97093( uParam0, "Bada_room1" )))))
    {
        return 1;
    }
    if ((sub_97093( uParam0, "clammainroom" )) || ((sub_97093( uParam0, "clamfronrm" )) || ((sub_97093( uParam0, "clampalbkrm" )) || (sub_97093( uParam0, "clammainroom" )))))
    {
        return 1;
    }
    return 0;
...
void sub_98329(unknown uParam0)
{
    ...
    if (l_U521._fU12)
    {
        if (g_U18635[l_U416]._fU892._fU40 >= 0)
        {
            ...
            if (NOT l_U521._fU24)
            {
                if (((sub_77384( l_U465 )) > 5) || (sub_111919( ref l_U465 )))
                {
                    bVar5 = true;
                }
            }
...
void sub_98505(unknown uParam0)
{
    ...
    if ((sub_98528( uParam0 )) || (IS_CHAR_DEAD( sub_2582() )))
    {
        return;
    }
    if ((sub_98769( uParam0 )) || (IS_CHAR_ON_ANY_BIKE( sub_2582() )))
    {
        sub_98909( uParam0 );
        return;
    }
...
int sub_100489(unknown uParam0)
{
    ...
    if (NOT l_U521._fU8)
    {
        if ((NOT (sub_98528( uParam0 ))) AND (NOT (IS_CHAR_DEAD( sub_2582() ))))
        {
            if (IS_CHAR_ON_ANY_BIKE( sub_2582() ))
            {
...
int sub_101373(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((uParam2) AND (NOT g_U18635[uParam0]._fU892._fU28))
    {
        ...
        for ( I = 0; I < iVar6; I++ )
        {
            if ((NOT (sub_101807( uParam0, I ))) AND (sub_101542( uParam0, I )))
            {
...
void sub_101496()
{
    ...
    for ( I = 0; I < iVar2; I++ )
    {
        if ((sub_101542( 7, I )) || ((sub_101542( 6, I )) || (sub_101542( 1, I ))))
        {
            sub_101634( 1, I );
            sub_101634( 6, I );
            sub_101634( 7, I );
        ...
        if ((sub_101807( 7, I )) || ((sub_101807( 6, I )) || (sub_101807( 1, I ))))
        {
            sub_101899( 1, I );
            sub_101899( 6, I );
            sub_101899( 7, I );
