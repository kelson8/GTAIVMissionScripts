void main()
{
    ...
    l_U264 = 0;
    l_U267 = 1;
    l_U298 = {-0.47300000, 0.86299990, -1.00000000};
    l_U302 = 0;
    l_U311 = 0;
    l_U326 = 4;
    l_U332 = nil;
                ...
                switch (l_U220)
                {
                    ...
                    if (g_U10440)
                    {
                        if (NOT g_U10441)
                        {
                            ...
                            {
                                if ((NOT (IS_CHAR_DEAD( sub_2670() ))) AND (NOT (IS_CHAR_DEAD( l_U271[l_U363] ))))
                                {
...
void sub_584()
{
    ...
    if (sub_1213() > -1)
    {
        ...
        else if ((l_U227 == 2) || ((l_U227 == 4) || (l_U227 == 1)))
        {
...
void sub_3746()
{
    switch (l_U228)
    {
        ...
        l_U354 = 228.73000000;
        l_U318 = {1152.07700000, 1669.39400000, 15.72190000};
        ...
        l_U231[3] = {1149.14700000, 1669.57400000, 17.07823000};
        ...
        l_U401[1] = {1181.31600000, 1696.76800000, 16.79990000};
        ...
        l_U301 = 272.20340000;
        l_U231[0] = {-1576.65200000, 1.51454000, 9.95776300};
        ...
        l_U247[4] = {-2.86955500, 0.00000000, -121.08690000};
        l_U341[0] = {1168.77300000, 1666.60500000, 17.72180000};
        l_U341[1] = {1171.42500000, 1667.95500000, 17.75380000};
        l_U348[0] = 152.75620000;
        l_U348[1] = 250.23200000;
...
void sub_7036()
{
    ...
    switch (l_U227)
    {
        ...
        if (sub_12473( l_U332 ))
        {
            if ((NOT (sub_7414( sub_2670() ))) AND (NOT (sub_7414( l_U332 ))))
            {
                sub_584();
            }
            if (g_U10441)
...
int sub_7414(unknown uParam0)
{
    ...
    if (NOT (IS_CHAR_DEAD( uParam0 )))
    {
        ...
        if ((iVar3 == (GET_HASH_KEY( l_U419 ))) || ((iVar3 == (GET_HASH_KEY( l_U418 ))) || ((iVar3 == (GET_HASH_KEY( l_U417 ))) || (iVar3 == (GET_HASH_KEY( l_U416 ))))))
        {
            if (NOT l_U497)
            {
    ...
    if (NOT sub_9587())
    {
        if (IS_PLAYER_SCRIPT_CONTROL_ON( sub_1055() ))
        {
            for ( I = 0; I < 3; I++ )
            {
                if (NOT (IS_CHAR_INJURED( l_U328[I] )))
                {
                    if ((sub_9978( ref l_U328[I] )) AND (IS_PLAYER_SCRIPT_CONTROL_ON( sub_1055() )))
                    {
...
int sub_9587()
{
    ...
    else
    {
        ...
        if (sub_9802())
        {
            if ((NOT g_U11117[1]) || (NOT g_U11117[0]))
            {
                return 1;
            }
        }
...
int sub_9612()
{
    if ((NOT (IS_CHAR_INJURED( l_U328[0] ))) || ((NOT (IS_CHAR_INJURED( l_U328[2] ))) || (NOT (IS_CHAR_INJURED( l_U328[1] )))))
    {
        return 1;
    }
    return 0;
...
int sub_10584(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_1055() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_1055() )))
            {
                if (((g_U10499) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_1055() )))))
                {
                    if (NOT sub_10680())
                    {
...
int sub_12473(unknown uParam0)
{
    ...
    if ((NOT (IS_CHAR_INJURED( uParam0 ))) AND (NOT (IS_CHAR_DEAD( uParam0 ))))
    {
        ...
        else if (NOT (DOES_BLIP_EXIST( l_U443 )))
        {
            ...
            if ((NOT g_U10440) AND (NOT g_U10441))
            {
                if (sub_1213() == 0)
                {
...
void sub_15241()
{
    if (l_U228 == 0)
    {
        ...
        REQUEST_ANIMS( l_U475 );
        if ((HAVE_ANIMS_LOADED( l_U475 )) AND ((HAS_MODEL_LOADED( l_U376 )) AND ((HAS_MODEL_LOADED( l_U442 )) AND (HAS_MODEL_LOADED( l_U441 )))))
        {
            l_U385 = 1;
        }
        else
    ...
    else if (l_U228 == 1)
    {
        ...
        REQUEST_MODEL( l_U376 );
        REQUEST_ANIMS( l_U475 );
        if ((HAVE_ANIMS_LOADED( l_U475 )) AND ((HAS_MODEL_LOADED( l_U460[1] )) AND ((HAS_MODEL_LOADED( l_U460[0] )) AND ((HAS_MODEL_LOADED( l_U376 )) AND ((HAS_MODEL_LOADED( l_U442 )) AND (HAS_MODEL_LOADED( l_U441 )))))))
        {
...
int sub_15951()
{
    ...
    if ((IS_ANY_CHAR_SHOOTING_IN_AREA( l_U370, l_U373, 0 )) || (IS_CHAR_SHOOTING( sub_2670() )))
    {
        g_U10441 = 1;
        return 1;
    }
    ...
    if (NOT (IS_CHAR_INJURED( iParam0 )))
    {
        ...
        switch ((uParam1^))
        {
            ...
            if (l_U445)
            {
                if (l_U491 == 2)
                {
                    if ((NOT (IS_CHAR_INJURED( l_U294 ))) AND (NOT (IS_CHAR_INJURED( sub_2670() ))))
                    {
            ...
            else
            {
                ...
                if (l_U384 == 7)
                {
                    if (LOCATE_CHAR_ON_FOOT_CHAR_3D( sub_2670(), iParam0, 2.00000000, 2.00000000, 2.00000000, 0 ))
                    {
                        if ((NOT sub_9587()) AND (NOT sub_10680()))
                        {
            ...
            if (sub_11157())
            {
                if (NOT l_U265)
                {
                    if (IS_CONTROL_JUST_PRESSED( 2, 0 ))
                    {
                        ...
                        if (l_U267 > 0)
                        {
                            if ((DOES_CAM_EXIST( l_U230 )) AND (DOES_CAM_EXIST( l_U229 )))
                            {
                        ...
                        else if ((DOES_CAM_EXIST( l_U230 )) AND (DOES_CAM_EXIST( l_U229 )))
                        {
                ...
                {
                    GET_SCRIPT_TASK_STATUS( iParam0, 29, ref l_U384 );
                    if ((HAS_CHAR_ANIM_FINISHED( iParam0, "MISSSTRIPCLUBHI", l_U506 )) || (l_U384 == 7))
                    {
                        if (l_U491 < 2)
                        {
                            STOP_STREAM();
                ...
                if ((uParam1^) == 4)
                {
                    if ((l_U390) || (sub_28256()))
                    {
                        if (NOT l_U389)
                        {
                            ...
                            if ((NOT (IS_CHAR_INJURED( iParam0 ))) AND (NOT (IS_CHAR_DEAD( sub_2670() ))))
                            {
                                CLEAR_HELP();
...
int sub_23080(unknown uParam0, int iParam1)
{
    ...
    if (PRELOAD_STREAM( l_U487 ))
    {
        ...
        else if ((NOT (IS_CHAR_INJURED( (uParam0^) ))) AND (NOT (IS_CHAR_INJURED( sub_2670() ))))
        {
...
void sub_26293(unknown uParam0)
{
    ...
    if ((NOT l_U507) AND ((iVar9 > 65486) AND ((iVar9 < 50) AND ((iVar8 > 65486) AND (iVar8 < 50)))))
    {
        l_U496 = 0;
        l_U495 = 0;
...
int sub_28952(unknown uParam0, unknown uParam1)
{
    ...
    {
        if ((l_U493 < 0.53288800) AND (l_U493 > 0.52324700))
        {
            return 1;
        }
        if ((l_U493 < 0.62095000) AND (l_U493 > 0.61193900))
        {
            return 1;
        }
        if ((l_U493 < 0.65241200) AND (l_U493 > 0.63925100))
        {
            return 1;
        }
        if ((l_U493 < 0.68554900) AND (l_U493 > 0.68149700))
        {
            return 1;
        }
        if ((l_U493 < 0.72343800) AND (l_U493 > 0.70069900))
        {
            return 1;
        }
    }
    ...
    {
        if ((l_U493 < 0.07128900) AND (l_U493 > 0.06655600))
        {
            return 1;
        }
        if ((l_U493 < 0.08912300) AND (l_U493 > 0.07604000))
        {
            return 1;
        }
        if ((l_U493 < 0.10628700) AND (l_U493 > 0.09845400))
        {
            return 1;
        }
        if ((l_U493 < 0.12760500) AND (l_U493 > 0.12243100))
        {
            return 1;
        }
        if ((l_U493 < 0.14627400) AND (l_U493 > 0.13721000))
        {
            return 1;
        }
        if ((l_U493 < 0.16362900) AND (l_U493 > 0.15714800))
        {
            return 1;
        }
        if ((l_U493 < 0.22365800) AND (l_U493 > 0.19519500))
        {
            return 1;
        }
        if ((l_U493 < 0.24339200) AND (l_U493 > 0.23661100))
        {
            return 1;
        }
        if ((l_U493 < 0.25979700) AND (l_U493 > 0.25288200))
        {
            return 1;
        }
        if ((l_U493 < 0.26556200) AND (l_U493 > 0.26377000))
        {
            return 1;
        }
        if ((l_U493 < 0.28340600) AND (l_U493 > 0.27656600))
        {
            return 1;
        }
        if ((l_U493 < 0.29459700) AND (l_U493 > 0.28897900))
        {
            return 1;
        }
        if ((l_U493 < 0.31288300) AND (l_U493 > 0.30806300))
        {
            return 1;
        }
        if ((l_U493 < 0.32801200) AND (l_U493 > 0.32529000))
        {
            return 1;
        }
        if ((l_U493 < 0.36980700) AND (l_U493 > 0.36630900))
        {
            return 1;
        }
        if ((l_U493 < 0.42403200) AND (l_U493 > 0.40667800))
        {
            return 1;
        }
        if ((l_U493 < 0.45460400) AND (l_U493 > 0.44832300))
        {
            return 1;
        }
        if ((l_U493 < 0.47036900) AND (l_U493 > 0.46352000))
        {
            return 1;
        }
        if ((l_U493 < 0.49150500) AND (l_U493 > 0.48455500))
        {
            return 1;
        }
        if ((l_U493 < 0.53929700) AND (l_U493 > 0.53320300))
        {
            return 1;
        }
        if ((l_U493 < 0.62434500) AND (l_U493 > 0.61667000))
        {
            return 1;
        }
        if ((l_U493 < 0.67467700) AND (l_U493 > 0.66192400))
        {
            return 1;
        }
        if ((l_U493 < 0.68975400) AND (l_U493 > 0.68147500))
        {
            return 1;
        }
        if ((l_U493 < 0.69863300) AND (l_U493 > 0.69438200))
        {
            return 1;
        }
        if ((l_U493 < 0.70674900) AND (l_U493 > 0.70192900))
        {
            return 1;
        }
        if ((l_U493 < 0.71560100) AND (l_U493 > 0.71093600))
        {
            return 1;
        }
        if ((l_U493 < 0.75603200) AND (l_U493 > 0.73810300))
        {
            return 1;
        }
        if ((l_U493 < 0.77422800) AND (l_U493 > 0.76443600))
        {
            return 1;
        }
        if ((l_U493 < 0.79352700) AND (l_U493 > 0.78226600))
        {
            return 1;
        }
        if ((l_U493 < 0.81403100) AND (l_U493 > 0.80322000))
        {
            return 1;
        }
        if ((l_U493 < 0.83809900) AND (l_U493 > 0.82743300))
        {
            return 1;
        }
        if ((l_U493 < 0.95752300) AND (l_U493 > 0.92863200))
        {
            return 1;
        }
        if ((l_U493 < 0.97697500) AND (l_U493 > 0.96494500))
        {
            return 1;
        }
        if ((l_U493 < 0.98457090) AND (l_U493 > 0.97697500))
        {
            return 1;
        }
        if ((l_U493 < 0.99091200) AND (l_U493 > 0.98619910))
        {
            return 1;
        }
    }
    ...
    {
        if ((l_U493 < 0.61829700) AND (l_U493 > 0.60844000))
        {
            return 1;
        }
        if ((l_U493 < 0.66399200) AND (l_U493 > 0.65144800))
        {
            return 1;
        }
        if ((l_U493 < 0.68908000) AND (l_U493 > 0.67295200))
        {
            return 1;
        }
        if ((l_U493 < 0.71058400) AND (l_U493 > 0.70610300))
        {
            return 1;
        }
    }
    ...
    {
        if ((l_U493 < 0.22319800) AND (l_U493 > 0.21957400))
        {
            return 1;
        }
        if ((l_U493 < 0.23841500) AND (l_U493 > 0.22899500))
        {
            return 1;
        }
        if ((l_U493 < 0.24783600) AND (l_U493 > 0.24058900))
        {
            return 1;
        }
        if ((l_U493 < 0.25870600) AND (l_U493 > 0.25363300))
        {
            return 1;
        }
        if ((l_U493 < 0.27102600) AND (l_U493 > 0.26450400))
        {
            return 1;
        }
        if ((l_U493 < 0.28986800) AND (l_U493 > 0.27754700))
        {
            return 1;
        }
        if ((l_U493 < 0.30870900) AND (l_U493 > 0.30146200))
        {
            return 1;
        }
        if ((l_U493 < 0.32392600) AND (l_U493 > 0.31740500))
        {
            return 1;
        }
        if ((l_U493 < 0.33479700) AND (l_U493 > 0.32827500))
        {
            return 1;
        }
        if ((l_U493 < 0.34276800) AND (l_U493 > 0.33914500))
        {
            return 1;
        }
        if ((l_U493 < 0.34711600) AND (l_U493 > 0.34494200))
        {
            return 1;
        }
        if ((l_U493 < 0.35218900) AND (l_U493 > 0.34929000))
        {
            return 1;
        }
        if ((l_U493 < 0.35798600) AND (l_U493 > 0.35508800))
        {
            return 1;
        }
        if ((l_U493 < 0.36450800) AND (l_U493 > 0.36016000))
        {
            return 1;
        }
        if ((l_U493 < 0.37392900) AND (l_U493 > 0.36668400))
        {
            return 1;
        }
        if ((l_U493 < 0.38479900) AND (l_U493 > 0.37972700))
        {
            return 1;
        }
        if ((l_U493 < 0.39566900) AND (l_U493 > 0.38987200))
        {
            return 1;
        }
        if ((l_U493 < 0.41741000) AND (l_U493 > 0.40653900))
        {
            return 1;
        }
        if ((l_U493 < 0.47393400) AND (l_U493 > 0.45581700))
        {
            return 1;
        }
        if ((l_U493 < 0.49060100) AND (l_U493 > 0.48190500))
        {
            return 1;
        }
        if ((l_U493 < 0.50509600) AND (l_U493 > 0.49784700))
        {
            return 1;
        }
        if ((l_U493 < 0.51668800) AND (l_U493 > 0.51016700))
        {
            return 1;
        }
        if ((l_U493 < 0.55002300) AND (l_U493 > 0.53480500))
        {
            return 1;
        }
        if ((l_U493 < 0.56886500) AND (l_U493 > 0.55944400))
        {
            return 1;
        }
        if ((l_U493 < 0.60437400) AND (l_U493 > 0.58118500))
        {
            return 1;
        }
        if ((l_U493 < 0.62394000) AND (l_U493 > 0.61886800))
        {
            return 1;
        }
        if ((l_U493 < 0.68481300) AND (l_U493 > 0.66524700))
        {
            return 1;
        }
        if ((l_U493 < 0.69713200) AND (l_U493 > 0.68988600))
        {
            return 1;
        }
        if ((l_U493 < 0.71235000) AND (l_U493 > 0.70655200))
        {
            return 1;
        }
        if ((l_U493 < 0.73988900) AND (l_U493 > 0.72322000))
        {
            return 1;
        }
        if ((l_U493 < 0.75075800) AND (l_U493 > 0.74713400))
        {
            return 1;
        }
        if ((l_U493 < 0.75655510) AND (l_U493 > 0.75365610))
        {
            return 1;
        }
        if ((l_U493 < 0.76235200) AND (l_U493 > 0.75945400))
        {
            return 1;
        }
        if ((l_U493 < 0.76959900) AND (l_U493 > 0.76742500))
        {
            return 1;
        }
        if ((l_U493 < 0.77467300) AND (l_U493 > 0.77249800))
        {
            return 1;
        }
        if ((l_U493 < 0.78119390) AND (l_U493 > 0.77757000))
        {
            return 1;
        }
        if ((l_U493 < 0.78699100) AND (l_U493 > 0.78336900))
        {
            return 1;
        }
        if ((l_U493 < 0.79568700) AND (l_U493 > 0.78916500))
        {
            return 1;
        }
        if ((l_U493 < 0.82177600) AND (l_U493 > 0.81380600))
        {
            return 1;
        }
        if ((l_U493 < 0.83844200) AND (l_U493 > 0.83192100))
        {
            return 1;
        }
        if ((l_U493 < 0.85148700) AND (l_U493 > 0.84496500))
        {
            return 1;
        }
        if ((l_U493 < 0.87902600) AND (l_U493 > 0.87177700))
        {
            return 1;
        }
    }
    ...
    {
        if ((l_U493 < 0.26649100) AND (l_U493 > 0.26024000))
        {
            return 1;
        }
        if ((l_U493 < 0.28109400) AND (l_U493 > 0.27373000))
        {
            return 1;
        }
        if ((l_U493 < 0.29412100) AND (l_U493 > 0.28902400))
        {
            return 1;
        }
        if ((l_U493 < 0.30988100) AND (l_U493 > 0.30478300))
        {
            return 1;
        }
        if ((l_U493 < 0.32060700) AND (l_U493 > 0.31497900))
        {
            return 1;
        }
        if ((l_U493 < 0.33420000) AND (l_U493 > 0.33080200))
        {
            return 1;
        }
        if ((l_U493 < 0.34099800) AND (l_U493 > 0.33929800))
        {
            return 1;
        }
        if ((l_U493 < 0.34939700) AND (l_U493 > 0.34769800))
        {
            return 1;
        }
        if ((l_U493 < 0.40803100) AND (l_U493 > 0.39898500))
        {
            return 1;
        }
        if ((l_U493 < 0.42389100) AND (l_U493 > 0.41992600))
        {
            return 1;
        }
        if ((l_U493 < 0.43465400) AND (l_U493 > 0.43012100))
        {
            return 1;
        }
        if ((l_U493 < 0.44525700) AND (l_U493 > 0.44073900))
        {
            return 1;
        }
        if ((l_U493 < 0.45715200) AND (l_U493 > 0.45318700))
        {
            return 1;
        }
        if ((l_U493 < 0.46847800) AND (l_U493 > 0.46508300))
        {
            return 1;
        }
        if ((l_U493 < 0.47867400) AND (l_U493 > 0.47584200))
        {
            return 1;
        }
        if ((l_U493 < 0.49221300) AND (l_U493 > 0.48994600))
        {
            return 1;
        }
        if ((l_U493 < 0.55109900) AND (l_U493 > 0.54430200))
        {
            return 1;
        }
        if ((l_U493 < 0.56351500) AND (l_U493 > 0.55841600))
        {
            return 1;
        }
        if ((l_U493 < 0.57314300) AND (l_U493 > 0.56861100))
        {
            return 1;
        }
        if ((l_U493 < 0.58560400) AND (l_U493 > 0.57824100))
        {
            return 1;
        }
        if ((l_U493 < 0.59629100) AND (l_U493 > 0.59295100))
        {
            return 1;
        }
        if ((l_U493 < 0.60592000) AND (l_U493 > 0.60138800))
        {
            return 1;
        }
        if ((l_U493 < 0.61441800) AND (l_U493 > 0.61102200))
        {
            return 1;
        }
        if ((l_U493 < 0.62513200) AND (l_U493 > 0.62064700))
        {
            return 1;
        }
        if ((l_U493 < 0.63531900) AND (l_U493 > 0.63135600))
        {
            return 1;
        }
        if ((l_U493 < 0.64381600) AND (l_U493 > 0.64155100))
        {
            return 1;
        }
        if ((l_U493 < 0.64891300) AND (l_U493 > 0.64664800))
        {
            return 1;
        }
        if ((l_U493 < 0.65346100) AND (l_U493 > 0.65117900))
        {
            return 1;
        }
        if ((l_U493 < 0.65905100) AND (l_U493 > 0.65621800))
        {
            return 1;
        }
        if ((l_U493 < 0.66358200) AND (l_U493 > 0.66188400))
        {
            return 1;
        }
        if ((l_U493 < 0.66864700) AND (l_U493 > 0.66698000))
        {
            return 1;
        }
        if ((l_U493 < 0.67371600) AND (l_U493 > 0.67201800))
        {
            return 1;
        }
        if ((l_U493 < 0.69849600) AND (l_U493 > 0.69175300))
        {
            return 1;
        }
        if ((l_U493 < 0.71310900) AND (l_U493 > 0.70913800))
        {
            return 1;
        }
        if ((l_U493 < 0.72782000) AND (l_U493 > 0.71932500))
        {
            return 1;
        }
        if ((l_U493 < 0.73965300) AND (l_U493 > 0.73519500))
        {
            return 1;
        }
        if ((l_U493 < 0.75438000) AND (l_U493 > 0.74701500))
        {
            return 1;
        }
        if ((l_U493 < 0.77239000) AND (l_U493 > 0.76609900))
        {
            return 1;
        }
        if ((l_U493 < 0.78244300) AND (l_U493 > 0.77734500))
        {
            return 1;
        }
        if ((l_U493 < 0.79263900) AND (l_U493 > 0.78867300))
        {
            return 1;
        }
        if ((l_U493 < 0.80319200) AND (l_U493 > 0.79835500))
        {
            return 1;
        }
        if ((l_U493 < 0.81678000) AND (l_U493 > 0.81168400))
        {
            return 1;
        }
        if ((l_U493 < 0.83031700) AND (l_U493 > 0.82408800))
        {
            return 1;
        }
        if ((l_U493 < 0.84656000) AND (l_U493 > 0.84045800))
        {
            return 1;
        }
        if ((l_U493 < 0.88771200) AND (l_U493 > 0.88333400))
        {
            return 1;
        }
        if ((l_U493 < 0.89618500) AND (l_U493 > 0.89280800))
        {
            return 1;
        }
        if ((l_U493 < 0.92716400) AND (l_U493 > 0.91364900))
        {
            return 1;
        }
        if ((l_U493 < 0.93955400) AND (l_U493 > 0.93393400))
        {
            return 1;
        }
