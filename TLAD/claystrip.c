...
void sub_63841()
{
    ...
    sub_64169( iVar3[54], -1378.11200000, 510.59840000, 13.97960000, 95.79300000, -1382.08400000, 528.18780000, 16.99844000, -11.86755000, -0.00000000, -132.35800000 );
...
int sub_66320(unknown uParam0, unknown uParam1, unknown uParam2)
{
        ...
        for ( I = 0; I < 2; I++ )
        {
            if (l_U514 == -1)
            {
                if (sub_67167( I ))
                {
                    ...
                    if ((sub_67378( 1, 1 )) AND ((NOT (sub_37516( sub_1568() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U611[I]._fU4._fU0, l_U611[I]._fU4._fU4, fVar8, 2.50000000, 2.50000000, 2.50000000, iVar9 ))))
                    {
    ...
    if (l_U502 == 2)
    {
        if ((iVar5 > l_U639) || (sub_67887( uParam0 )))
        {
            l_U514 = l_U640;
            l_U502 = 3;
        }
...
void sub_97809(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if (l_U1206 == 1)
    {
        if (NOT (IS_CHAR_ON_FOOT( sub_1568() )))
        {
            if ((iVar5 > l_U1236) || (sub_97932( uParam1, 20.00000000 )))
            {
                l_U1206++;
            }
            else
...
int sub_103554(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 6; Result++ )
    {
        ...
        if ((NOT (sub_103689( iVar4 ))) AND (sub_103626( Result )))
        {
            iVar5 = g_U11583[iVar4]._fU28 == g_U10999;
            fVar6 = l_U1014[Result]._fU4._fU8;
            if ((sub_67378( 1, 1 )) AND ((NOT (sub_37516( sub_1568() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U1014[Result]._fU4._fU0, l_U1014[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 ))))
            {
...
int sub_103981(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 16; Result++ )
    {
        if (sub_104040( Result ))
        {
            ...
            if ((sub_67378( 1, 1 )) AND ((NOT (sub_37516( sub_1568() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U641[Result]._fU4._fU0, l_U641[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 ))))
            {
                if (IS_CHAR_ON_FOOT( sub_1568() ))
                {
                    if (sub_97932( uParam0, 1092616192 ))
...
int sub_123158(unknown uParam0)
{
    ...
    if ((sub_123248( uParam0, "Bada_room1" )) || ((sub_123248( uParam0, "Bada_room2" )) || ((sub_123248( uParam0, "Bada-Private" )) || (sub_123248( uParam0, "Bada_room1" )))))
    {
        return 1;
    }
    if ((sub_123248( uParam0, "clammainroom" )) || ((sub_123248( uParam0, "clamfronrm" )) || ((sub_123248( uParam0, "clampalbkrm" )) || (sub_123248( uParam0, "clammainroom" )))))
    {
        return 1;
    }
    return 0;
...
void sub_124626(unknown uParam0)
{
    ...
    if (l_U521._fU12)
    {
        if (g_U18635[l_U416]._fU892._fU40 >= 0)
        {
            ...
            if (NOT l_U521._fU24)
            {
                if (((sub_104813( l_U465 )) > 5) || (sub_138102( ref l_U465 )))
                {
                    bVar5 = true;
                }
            }
...
void sub_124802(unknown uParam0)
{
    ...
    if ((sub_124825( uParam0 )) || (IS_CHAR_DEAD( sub_1568() )))
    {
        return;
    }
    if ((sub_125066( uParam0 )) || (IS_CHAR_ON_ANY_BIKE( sub_1568() )))
    {
        sub_125206( uParam0 );
        return;
    }
...
int sub_126672(unknown uParam0)
{
    ...
    if (NOT l_U521._fU8)
    {
        if ((NOT (sub_124825( uParam0 ))) AND (NOT (IS_CHAR_DEAD( sub_1568() ))))
        {
            if (IS_CHAR_ON_ANY_BIKE( sub_1568() ))
            {
...
int sub_127556(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((uParam2) AND (NOT g_U18635[uParam0]._fU892._fU28))
    {
        ...
        for ( I = 0; I < iVar6; I++ )
        {
            if ((NOT (sub_127990( uParam0, I ))) AND (sub_127725( uParam0, I )))
            {
...
void sub_127679()
{
    ...
    for ( I = 0; I < iVar2; I++ )
    {
        if ((sub_127725( 7, I )) || ((sub_127725( 6, I )) || (sub_127725( 1, I ))))
        {
            sub_127817( 1, I );
            sub_127817( 6, I );
            sub_127817( 7, I );
        ...
        if ((sub_127990( 7, I )) || ((sub_127990( 6, I )) || (sub_127990( 1, I ))))
        {
            sub_128082( 1, I );
            sub_128082( 6, I );
            sub_128082( 7, I );
...
int sub_139171(int iParam0)
{
    ...
    if (iVar4 == iVar3)
    {
        if (NOT (((sub_139314( iVar3 )) == sub_139343()) AND ((sub_45912( iParam0 + 0 )) == 3)))
        {
            if (((NOT (IS_CHAR_GETTING_IN_TO_A_CAR( sub_1568() ))) AND (sub_139431( sub_1568() ))) || (((sub_139389( iParam0->_fU0 )) == (sub_17369( 0 ))) || ((sub_45912( iParam0 + 0 )) != 1)))
            {
                return 0;
            }
            else
...
int sub_139587(int iParam0, unknown uParam1, boolean bParam2)
{
    ...
    else if ((NOT (IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU0 ))) AND (sub_139431( iParam0->_fU0 )))
    {
        return 2;
    }
    else if ((sub_88248( iParam0, 1 )) || (uParam1))
    {
        uVar5 = nil;
        if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
        {
...
void sub_140143(int iParam0)
{
    if (NOT (IS_CHAR_INJURED( iParam0->_fU0 )))
    {
        ...
        {
            if ((NOT l_U155) AND ((NOT l_U154) AND (sub_140209( (iParam0^) ))))
            {
                if ((NOT sub_137586()) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
                {
        ...
        {
            if ((NOT (sub_75246( l_U147 ))) || ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() ))) || ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU0 ))) || ((NOT (IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 ))) || ((NOT (IS_CHAR_ON_ANY_BIKE( sub_1568() ))) || (NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_1568(), iParam0->_fU0, l_U145, l_U145, l_U145, 0 ))))))))
            {
                sub_141596( iParam0 );
            }
        }
...
void sub_141759(int iParam0)
{
    ...
    if ((sub_137586()) AND (sub_140174( (iParam0^) )))
    {
    ...
    if (((iVar4 - l_U165) < 33) || ((sub_140174( (iParam0^) )) || (sub_137586())))
    {
        return;
    }
    if (l_U165 <= 0)
    ...
    if ((IS_VEH_DRIVEABLE( iParam0->_fU4 )) AND (NOT (IS_CHAR_INJURED( iParam0->_fU0 ))))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar12 )))
        {
            if (sub_142686( uVar12 ))
            {
                ...
                if ((iParam0->_fU0 != l_U167) AND (((fVar21 < 15) || ((fVar21 < 19) AND (IS_CHAR_ON_SCREEN( iParam0->_fU0 )))) AND (NOT (sub_140174( (iParam0^) )))))
                {
                    ...
                    else if ((NOT (IS_BIT_SET( l_U170, 6 ))) AND (((sub_45912( iParam0 + 0 )) == 1) AND ((iParam0->_fU36 == 2) AND (sub_142923( iParam0 )))))
                    {
                        iVar15 = 38;
                        uVar13 = sub_143037( bVar16 );
                        iVar11 = sub_1568();
                    }
                    else if ((sub_143125( 8 )) AND (((ABSF( uVar22 )) < 20.00000000) AND (IS_CAR_IN_AIR_PROPER( uVar12 ))))
                    {
                        uVar13 = sub_51422( bVar16 );
                        iVar15 = 8;
                    }
                    else if ((sub_143125( 12 )) AND (HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, sub_1568() )))
                    {
                        uVar13 = sub_143037( bVar16 );
                        iVar11 = sub_1568();
                        iVar15 = 12;
                    ...
                    else if ((sub_143125( 13 )) AND ((IS_PED_RAGDOLL( iParam0->_fU0 )) || (HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, 0 ))))
                    {
                        uVar13 = sub_143037( bVar16 );
                        iVar11 = nil;
                        iVar15 = 13;
                    ...
                    else if ((sub_143125( 20 )) AND ((IS_BIT_SET( l_U170, 7 )) AND ((NOT (IS_PLAYER_PRESSING_HORN( sub_4216() ))) AND ((sub_45912( iParam0 + 0 )) == 1))))
                    {
                        if (bVar16)
                        {
                            bVar18 = true;
                    ...
                    else if (((sub_45912( iParam0 + 0 )) == 1) AND ((sub_143125( 24 )) AND ((NOT (IS_BIT_SET( l_U170, 0 ))) AND (IS_WANTED_LEVEL_GREATER( sub_4216(), 0 )))))
                    {
                        iVar15 = 24;
                        iVar11 = sub_1568();
                    }
                    else if (((sub_45912( iParam0 + 0 )) == 1) AND ((sub_143125( 30 )) AND ((IS_BIT_SET( l_U170, 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_4216(), 0 ))))))
                    {
                        iVar15 = 30;
                    }
                    else
                    {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if (((sub_45912( iParam0 + 0 )) == 1) AND ((NOT (IS_BIT_SET( l_U170, 4 ))) AND (sub_143125( 33 ))))
                                {
                            ...
                            else if (IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() ))
                            {
                                ...
                                if (DOES_VEHICLE_EXIST( uVar23 ))
                                {
                                    if (((sub_45912( iParam0 + 0 )) == 1) AND ((NOT (IS_BIT_SET( l_U170, 4 ))) AND (sub_143125( 31 ))))
                                    {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (GET_CLOSEST_CHAR( uVar5._fU0, uVar5._fU4, uVar5._fU8, 25.00000000, 1, 1, ref iVar11 ))
                            {
                                ...
                                else if ((NOT (IS_WANTED_LEVEL_GREATER( sub_4216(), 0 ))) AND (sub_143125( 0 )))
                                {
                                ...
                                else if ((NOT (IS_BIT_SET( l_U170, 1 ))) AND ((IS_WANTED_LEVEL_GREATER( sub_4216(), 0 )) AND (sub_143125( 36 ))))
                                {
                                    if (IS_CHAR_ON_SCREEN( iVar11 ))
                                    {
                                        uVar13 = nil;
                                ...
                                else if ((sub_143125( 23 )) AND (IS_WANTED_LEVEL_GREATER( sub_4216(), 2 )))
                                {
                                    uVar13 = nil;
                                    iVar15 = 23;
                                };;;;
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (IS_VEH_DRIVEABLE( uVar23 ))
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        case 2:
                                        if (((sub_45912( iParam0 + 0 )) == 1) AND (sub_143125( 28 )))
                                        {
                                            iVar15 = 28;
                                        }
                                        break;
                                        ...
                                        {
                                            if ((sub_143125( 4 )) AND (sub_143125( 3 )))
                                            {
                                                if (g_U15728[13])
                                                {
                                                    iVar15 = 4;
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if ((IS_WANTED_LEVEL_GREATER( sub_4216(), 0 )) AND (sub_143125( 23 )))
                                {
                                    iVar15 = 23;
                                }
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if (((sub_45912( iParam0 + 0 )) == 1) AND (sub_143125( 30 )))
                                {
                                    iVar15 = 30;
                                }
...
int sub_147855(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if (((sub_142749( iParam0->_fU0, sub_1568(), 1 )) < 90.00000000) || ((IS_CAR_ON_SCREEN( iParam0->_fU4 )) || ((IS_CHAR_ON_SCREEN( iParam0->_fU0 )) || (IS_CHAR_IN_CAR( sub_1568(), iParam0->_fU4 )))))
        {
...
int sub_148987(int iParam0)
{
    ...
    if ((IS_VEH_DRIVEABLE( iParam0->_fU4 )) AND (NOT (sub_88248( iParam0, 2 ))))
    {
        return 0;
    }
...
int sub_149522(int iParam0)
{
    ...
    else if (((sub_142749( iParam0->_fU0, sub_1568(), 1 )) > 90.00000000) AND ((NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))) AND ((sub_146644( iParam0 )) > 90.00000000)))
    {
        ...
        {
            if (((VDIST( sub_139932( sub_1568(), 1 ), uVar4 )) < 30.00000000) || ((IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000, 2.00000000, 2.00000000 )) || (CAM_IS_SPHERE_VISIBLE( uVar3, uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000 ))))
            {
                ;
            }
            else if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
...
int sub_150294(int iParam0)
{
    ...
    if (((sub_146644( iParam0 )) < 30.00000000) AND (sub_88248( iParam0, 1 )))
    {
        SET_CHAR_WILL_LEAVE_CAR_IN_COMBAT( iParam0->_fU0, 1 );
    ...
    if ((((sub_142749( iParam0->_fU0, iParam0->_fU8, 1 )) > fVar8) || ((DOES_VEHICLE_EXIST( iVar4 )) || ((IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU8 )) || (IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU8 ))))) AND (NOT (IS_CHAR_IN_WATER( iParam0->_fU8 ))))
    {
        if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
        {
    ...
    else if (((sub_45912( iParam0 + 0 )) == 1) AND ((iParam0->_fU8 != sub_1568()) AND (sub_147893( sub_1568(), iParam0->_fU0, 1 ))))
    {
    ...
    if (IS_CHAR_IN_WATER( iParam0->_fU8 ))
    {
        ...
        else if ((IS_CHAR_IN_ANY_CAR( iParam0->_fU0 )) || (NOT (sub_88248( iParam0, 1 ))))
        {
            if ((sub_139749( iParam0 )) != 0)
            {
                ;
    ...
    else if ((NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU8 ))) AND (sub_88248( iParam0, 1 )))
    {
...
int sub_152047(int iParam0)
{
    ...
    else if (((sub_142729( iParam0 )) > 30.00000000) AND (NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))))
    {
...
int sub_153284(int iParam0)
{
    ...
    if (((sub_146644( iParam0 )) < 30.00000000) AND ((IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 115 )) || ((IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 110 )) || (IS_PED_IN_COMBAT( iParam0->_fU0 )))))
    {
        return 2;
    }
    return 0;
...
int sub_153433(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( uVar10 ))
    {
        ...
        else if (((sub_142729( iParam0 )) >= l_U125) AND ((sub_88248( iParam0, 4 )) || (sub_147172( iParam0->_fU4 ))))
        {
        ...
        if (NOT (IS_CAR_ON_SCREEN( iParam0->_fU4 )))
        {
            ...
            if (GET_CLOSEST_CAR_NODE_WITH_HEADING( vVar9.x, vVar9.y, vVar9.z, ref uVar15._fU0, ref uVar15._fU4, ref uVar15._fU8, ref uVar18 ))
            {
                if (NOT (IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar15._fU0, uVar15._fU4, uVar15._fU8, 4.00000000, 4.00000000, 4.00000000 )))
                {
                    ...
                    if (((VDIST2( uVar15, vVar6 )) > 9.00000000) AND (((VDIST( uVar15, sub_139932( sub_1568(), 1 ) )) > fParam2) AND (NOT (CAM_IS_SPHERE_VISIBLE( uVar19, uVar15._fU0, uVar15._fU4, uVar15._fU8, 6.00000000 )))))
                    {
...
void sub_160487(unknown uParam0)
{
    ...
    if ((NOT bVar4) AND ((iVar8 >= 0) AND ((NOT (iVar14 == 4)) AND ((NOT sub_162833()) AND ((IS_CHAR_ON_ANY_BIKE( sub_1568() )) AND ((NOT (IS_CONTROL_PRESSED( 0, 39 ))) AND ((NOT (IS_CONTROL_PRESSED( 0, 38 ))) AND (IS_CONTROL_PRESSED( 0, 51 )))))))))
    {
...
void sub_160722(unknown uParam0)
{
    ...
    {
        if ((Result < 0) AND ((I != l_U110) AND (sub_160758( uParam0, I ))))
        {
            Result = I;
        }
    }
...
void sub_163417(unknown uParam0)
{
    ...
    if (HAS_SCRIPT_LOADED( "ability_stats" ))
    {
        if (NOT g_U39103)
        {
            if ((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) AND ((NOT g_U11112) AND ((NOT IS_MINIGAME_IN_PROGRESS()) AND ((NOT sub_165905()) AND (((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "ability_stats" )) == 0) AND (NOT sub_162833()))))))
            {
                if (NOT l_U1248)
                {
...
int sub_165905()
{
    ...
    {
        if ((sub_165939()) AND (ARE_WIDESCREEN_BORDERS_ACTIVE()))
        {
            return 1;
        }
