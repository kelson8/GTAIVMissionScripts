...
void sub_1973(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    ...
    if (NOT (IS_CHAR_DEAD( sub_2101() )))
    {
        if ((IS_CHAR_PLAYING_ANIM( sub_2101(), uParam4, "GET_IN_LIFT_TOP" )) || ((IS_CHAR_PLAYING_ANIM( sub_2101(), uParam4, "operate_lift_intro" )) || ((IS_CHAR_PLAYING_ANIM( sub_2101(), uParam4, "OPERATE_LIFT_SWITCH" )) || (IS_CHAR_PLAYING_ANIM( sub_2101(), uParam4, "GET_IN_LIFT_BOTTOM" )))))
        {
            l_U149 = 1;
        }
        else
...
int sub_4844(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_2377() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_2377() )))
            {
                if (((g_U10499) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_2377() )))))
                {
                    if (NOT sub_4940())
                    {
...
void sub_6362(unknown uParam0)
{
    ...
    if (l_U14)
    {
        if (l_U126)
        {
            if (NOT (IS_CHAR_DEAD( sub_2101() )))
            {
                if ((IS_CHAR_PLAYING_ANIM( sub_2101(), uParam0, "GET_IN_LIFT_TOP" )) || (IS_CHAR_PLAYING_ANIM( sub_2101(), uParam0, "GET_IN_LIFT_BOTTOM" )))
                {
                    l_U151 = 1;
                }
            }
