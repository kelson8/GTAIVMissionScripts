        ...
        switch (l_U3)
        {
            ...
            else if (sub_238())
            {
                if (NOT (IS_CHAR_INJURED( sub_2249() )))
                {
                    ...
                    {
                        if ((g_U10455 == 0) AND (sub_2845( l_U7 )))
                        {
                            sub_2442();
                            if (sub_2525( l_U5, l_U7 ))
                            {
        ...
        switch (l_U4)
        {
            ...
            else if (sub_238())
            {
                if (NOT (IS_CHAR_INJURED( sub_2249() )))
                {
                    ...
                    {
                        if ((g_U10456 == 0) AND (sub_2845( l_U10 )))
                        {
                            sub_3536();
                            if (sub_2525( l_U6, l_U10 ))
                            {
...
int sub_2668()
{
    if (NOT sub_238())
    {
        if ((NOT g_U10455) AND (NOT g_U10437))
        {
            return 1;
        }
    }
...
int sub_3689()
{
    if (NOT sub_238())
    {
        if ((NOT g_U10456) AND (NOT g_U10438))
        {
            return 1;
        }
    }
