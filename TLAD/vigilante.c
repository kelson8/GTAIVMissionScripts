void main()
{
    ...
    while (true)
    {
        ...
        if ((IS_SCREEN_FADED_OUT()) AND (sub_2023( sub_244() )))
        {
        ...
        switch (l_U133._fU0)
        {
            ...
            else if ((l_U133._fU4 < 100) AND (l_U133._fU4 > 50))
            {
                sub_16607( l_U133._fU16, l_U133._fU12 );
            }
            else
            ...
            switch (l_U120)
            {
                ...
                switch (l_U97)
                {
                    ...
                    if (NOT (IS_CHAR_INJURED( l_U15 )))
                    {
                        ...
                        if (l_U117)
                        {
                            if ((IS_PLAYER_TARGETTING_CHAR( sub_4301(), l_U15 )) || ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_4301(), l_U15 )) || ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U15, sub_244(), 0 )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_244(), l_U15, 30.00000000, 30.00000000, 12.50000000, 0 )))))
                            {
                    ...
                    if (NOT (IS_CHAR_INJURED( l_U15 )))
                    {
                        ...
                        if (l_U117)
                        {
                            if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U15, sub_244(), 0 )) || (HAS_CHAR_SPOTTED_CHAR( l_U15, sub_244() )))
                            {
                                CLEAR_CHAR_TASKS_IMMEDIATELY( l_U15 );
                                l_U120 = 2;
                            }
...
int sub_2499()
{
    ...
    else if ((ProtectedGet(g_U8740) < 20) AND (ProtectedGet(g_U8740) >= 10))
    {
        return 2;
    }
...
int sub_3441()
{
    ...
    if ((ProtectedGet(g_U8740) < 10) AND (ProtectedGet(g_U8740) >= 5))
    {
        return 300;
    }
    if ((ProtectedGet(g_U8740) < 20) AND (ProtectedGet(g_U8740) >= 10))
    {
        return 350;
    }
    return 450;
...
void sub_4241()
{
    ...
    if (l_U121 != 2)
    {
        if ((IS_PLAYER_PLAYING( sub_4301() )) AND (NOT (IS_CHAR_INJURED( l_U15 ))))
        {
    ...
    else if ((IS_PLAYER_PLAYING( sub_4301() )) AND (NOT (IS_CHAR_INJURED( l_U16[0] ))))
    {
...
int sub_4673()
{
    ...
    if ((ProtectedGet(g_U8740) < 15) AND (ProtectedGet(g_U8740) >= 10))
    {
        return 2;
    }
    if ((ProtectedGet(g_U8740) < 20) AND (ProtectedGet(g_U8740) >= 15))
    {
        return 3;
    }
    return 4;
...
void sub_5252()
{
    if (l_U122 != 0)
    {
        if ((NOT sub_5284()) AND (l_U50 > l_U49))
        {
            if (l_U98)
            {
                sub_5423( l_U105 );
...
int sub_5284()
{
    if ((NOT (IS_CHAR_FATALLY_INJURED( l_U15 ))) AND (NOT (IS_CHAR_DEAD( sub_244() ))))
    {
...
void sub_5423(int iParam0)
{
    ...
    else
    {
        ...
        if (l_U126)
        {
            ...
            else if ((l_U124 > (l_U125 + 500)) AND (l_U124 < (l_U125 + 700)))
            {
                SET_MULTIPLAYER_HUD_TIME( " " );
                return;
            }
...
void sub_10638(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    ...
    if (NOT (IS_CHAR_FATALLY_INJURED( sub_244() )))
    {
        switch (l_U122)
        {
            ...
            if ((IS_VEH_DRIVEABLE( l_U25 )) AND (NOT (IS_CHAR_FATALLY_INJURED( l_U15 ))))
            {
                SET_CHAR_AS_MISSION_CHAR( l_U15 );
                SET_CHAR_HEALTH( l_U15, sub_3441() );
                GIVE_DELAYED_WEAPON_TO_CHAR( l_U15, sub_3541(), 100, 1 );
            ...
            if ((IS_CHAR_FATALLY_INJURED( l_U16[1] )) AND ((IS_CHAR_FATALLY_INJURED( l_U16[0] )) AND (IS_CHAR_FATALLY_INJURED( l_U15 ))))
            {
            ...
            else if (NOT (IS_CHAR_FATALLY_INJURED( l_U15 )))
            {
                switch (l_U119)
                {
                    ...
                    if (IS_VEH_DRIVEABLE( l_U25 ))
                    {
                        ...
                        if ((NOT (CHECK_STUCK_TIMER( l_U25, 0, 10000 ))) AND ((NOT (CHECK_STUCK_TIMER( l_U25, 3, 10000 ))) AND (l_U51 > 350)))
                        {
                            ...
                            else
                            {
                                ...
                                if (((VDIST( l_U42, l_U39 )) < 40.00000000) AND ((VDIST( l_U42, l_U39 )) > 20.00000000))
                                {
                                    if ((l_U53 > 40.00000000) || (l_U53 < 20.00000000))
                                    {
                                        if (IS_CHAR_SITTING_IN_ANY_CAR( l_U15 ))
                                        {
                    ...
                    break;
                    case 4:
                    if ((NOT (IS_CHAR_FATALLY_INJURED( sub_244() ))) AND (NOT (IS_CHAR_INJURED( l_U15 ))))
                    {
                        if (IS_CHAR_SITTING_IN_ANY_CAR( l_U15 ))
                        {
                            TASK_LEAVE_ANY_CAR( l_U15 );
                    ...
                    if ((NOT (IS_CHAR_FATALLY_INJURED( sub_244() ))) AND (NOT (IS_CHAR_INJURED( l_U16[0] ))))
                    {
                        if (IS_CHAR_SITTING_IN_ANY_CAR( l_U15 ))
                        {
                            TASK_LEAVE_ANY_CAR( l_U16[0] );
...
void sub_14032(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    ...
    if (NOT (IS_CHAR_FATALLY_INJURED( sub_244() )))
    {
        switch (l_U122)
        {
            ...
            if ((IS_CHAR_FATALLY_INJURED( l_U16[0] )) AND (IS_CHAR_FATALLY_INJURED( l_U15 )))
            {
                if (NOT (sub_7012( l_U15 )))
                {
                    sub_11980();
...
void sub_17622()
{
    if (l_U122 != 0)
    {
        if ((NOT (sub_17659( 1112014848 ))) AND (l_U50 > l_U49))
        {
            if (l_U98)
            {
                sub_5423( l_U105 );
