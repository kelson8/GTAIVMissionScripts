...
void sub_9884()
{
    ...
    {
        if ((g_U572[I]._fU20) AND ((sub_9922( 5, g_U572[I] )) == 1))
        {
...
void sub_18495()
{
    ...
    {
        iVar3 = sub_18523( 16 );
        if ((g_U10994[g_U11236[I]._fU0]._fU0) AND (sub_18568( 16, iVar3 )))
        {
    ...
    {
        iVar3 = sub_18523( 14 );
        if ((g_U10994[g_U11327[I]._fU0]._fU0) AND (sub_18568( 14, iVar3 )))
        {
    ...
    {
        iVar3 = sub_19001( I );
        if ((g_U10994[g_U11583[I]._fU28]._fU0) AND (sub_18568( g_U11583[I]._fU12, iVar3 )))
        {
...
void sub_19538()
{
    ...
    for ( I = 0; I < 65; I++ )
    {
        if ((g_U10994[g_U11583[I]._fU28]._fU0) AND (sub_19001( I )))
        {
            iVar4++;
        }
    }
...
int sub_29314()
{
    ...
    for ( I = 0; I <= (g_U572 - 1); I++ )
    {
        if ((g_U572[I]._fU20) AND ((sub_9922( 1, g_U572[I] )) != 0))
        {
            sub_10208( I );
            return 1;
        }
...
int sub_33242(unknown uParam0, int iParam1, boolean bParam2)
{
    ...
    if (NOT (iParam1 == nil))
    {
        if ((IS_CHAR_INJURED( iParam1 )) || (sub_33314()))
        {
            l_U505 = 1;
            l_U506 = 0;
...
void sub_44187(unknown uParam0, unknown uParam1)
{
    ...
    if ((NOT sub_35440()) || (NOT sub_44248()))
    {
        return;
    }
    sub_36942();
...
{
    if ((NOT (HAS_MODEL_LOADED( sub_44830( uParam0 ) ))) || (NOT (sub_35367( uParam0 ))))
    {
        sub_35406( uParam0 );
...
void sub_45109(vector vParam0, unknown uParam3, unknown uParam4, unknown uParam5, int iParam6, boolean bParam7)
{
    ...
    sub_45143( vParam0 + (vector( 0.00000000, 0.00000000, 2.00000000)), uParam3, uParam4, iParam6 );
...
void sub_45153(unknown uParam0)
{
    ...
    if (Result == 0)
    {
        if (((uParam0^) == (sub_17367( 16 ))) || (((uParam0^) == (sub_17367( 13 ))) || (((uParam0^) == (sub_17367( 7 ))) || (((uParam0^) == (sub_17367( 6 ))) || (((uParam0^) == (sub_17367( 1 ))) || ((uParam0^) == (sub_17367( 0 ))))))))
        {
            Result = 1;
        }
        else if (((uParam0^) == (sub_17367( 17 ))) || ((uParam0^) == (sub_17367( 15 ))))
        {
            Result = 3;
        }
    }
...
void sub_45869(int iParam0)
{
    ...
    if (iVar3 == 1)
    {
        ...
        else if ((NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_17367( 7 ) ))) AND (NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_17367( 6 ) ))))
        {
            sub_46365( iParam0 );
        }
    }
...
{
    return (NOT (sub_50230( uParam0, uParam1 ))) AND (IS_CHAR_SITTING_IN_CAR( uParam0, uParam1 ));
}
...
void sub_51758(int iParam0, unknown uParam1, int iParam2, int iParam3)
{
    ...
    if (Result)
    {
        ...
        if (iParam3 != 39)
        {
            if ((IS_CHAR_MODEL( iParam0, sub_17367( 0 ) )) AND (iParam3 == 38))
            {
                if (l_U172)
                {
...
void sub_55246()
{
    ...
    vVar2 = {(vector( 1176.32200000, 1698.27500000, 16.81840000)) + vVar2};
    vVar5 = {(vector( 1176.32200000, 1698.27500000, 16.81840000)) + vVar5};
...
void sub_63836()
{
    ...
    sub_64164( iVar3[54], -1378.11200000, 510.59840000, 13.97960000, 95.79300000, -1382.08400000, 528.18780000, 16.99844000, -11.86755000, -0.00000000, -132.35800000 );
...
int sub_66315(unknown uParam0, unknown uParam1, unknown uParam2)
{
        ...
        for ( I = 0; I < 2; I++ )
        {
            if (l_U514 == -1)
            {
                if (sub_67162( I ))
                {
                    ...
                    if ((sub_67373( 1, 1 )) AND ((NOT (sub_37512( sub_1568() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U611[I]._fU4._fU0, l_U611[I]._fU4._fU4, fVar8, 2.50000000, 2.50000000, 2.50000000, iVar9 ))))
                    {
    ...
    if (l_U502 == 2)
    {
        if ((iVar5 > l_U639) || (sub_67882( uParam0 )))
        {
            l_U514 = l_U640;
            l_U502 = 3;
        }
...
int sub_75563(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    {
        bVar6 = true;
        if ((NOT (sub_37512( sub_1568() ))) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() )))
        {
...
void sub_97800(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if (l_U1206 == 1)
    {
        if (NOT (IS_CHAR_ON_FOOT( sub_1568() )))
        {
            if ((iVar5 > l_U1236) || (sub_97923( uParam1, 20.00000000 )))
            {
                l_U1206++;
            }
            else
...
int sub_103545(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 6; Result++ )
    {
        ...
        if ((NOT (sub_103680( iVar4 ))) AND (sub_103617( Result )))
        {
            iVar5 = g_U11583[iVar4]._fU28 == g_U10999;
            fVar6 = l_U1014[Result]._fU4._fU8;
            if ((sub_67373( 1, 1 )) AND ((NOT (sub_37512( sub_1568() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U1014[Result]._fU4._fU0, l_U1014[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 ))))
            {
...
int sub_103972(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 16; Result++ )
    {
        if (sub_104031( Result ))
        {
            ...
            if ((sub_67373( 1, 1 )) AND ((NOT (sub_37512( sub_1568() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U641[Result]._fU4._fU0, l_U641[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 ))))
            {
                if (IS_CHAR_ON_FOOT( sub_1568() ))
                {
                    if (sub_97923( uParam0, 1092616192 ))
...
int sub_123149(unknown uParam0)
{
    ...
    if ((sub_123239( uParam0, "Bada_room1" )) || ((sub_123239( uParam0, "Bada_room2" )) || ((sub_123239( uParam0, "Bada-Private" )) || (sub_123239( uParam0, "Bada_room1" )))))
    {
        return 1;
    }
    if ((sub_123239( uParam0, "clammainroom" )) || ((sub_123239( uParam0, "clamfronrm" )) || ((sub_123239( uParam0, "clampalbkrm" )) || (sub_123239( uParam0, "clammainroom" )))))
    {
        return 1;
    }
    return 0;
...
void sub_124617(unknown uParam0)
{
    ...
    if (l_U521._fU12)
    {
        if (g_U18635[l_U416]._fU892._fU40 >= 0)
        {
            ...
            if (NOT l_U521._fU24)
            {
                if (((sub_104804( l_U465 )) > 5) || (sub_138093( ref l_U465 )))
                {
                    bVar5 = true;
                }
            }
...
void sub_124793(unknown uParam0)
{
    ...
    if ((sub_124816( uParam0 )) || (IS_CHAR_DEAD( sub_1568() )))
    {
        return;
    }
    if ((sub_125057( uParam0 )) || (IS_CHAR_ON_ANY_BIKE( sub_1568() )))
    {
        sub_125197( uParam0 );
        return;
    }
...
int sub_126663(unknown uParam0)
{
    ...
    if (NOT l_U521._fU8)
    {
        if ((NOT (sub_124816( uParam0 ))) AND (NOT (IS_CHAR_DEAD( sub_1568() ))))
        {
            if (IS_CHAR_ON_ANY_BIKE( sub_1568() ))
            {
...
int sub_127547(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((uParam2) AND (NOT g_U18635[uParam0]._fU892._fU28))
    {
        ...
        for ( I = 0; I < iVar6; I++ )
        {
            if ((NOT (sub_127981( uParam0, I ))) AND (sub_127716( uParam0, I )))
            {
...
void sub_127670()
{
    ...
    for ( I = 0; I < iVar2; I++ )
    {
        if ((sub_127716( 7, I )) || ((sub_127716( 6, I )) || (sub_127716( 1, I ))))
        {
            sub_127808( 1, I );
            sub_127808( 6, I );
            sub_127808( 7, I );
        ...
        if ((sub_127981( 7, I )) || ((sub_127981( 6, I )) || (sub_127981( 1, I ))))
        {
            sub_128073( 1, I );
            sub_128073( 6, I );
            sub_128073( 7, I );
...
int sub_139162(int iParam0)
{
    ...
    if (iVar4 == iVar3)
    {
        if (NOT (((sub_139305( iVar3 )) == sub_139334()) AND ((sub_45908( iParam0 + 0 )) == 3)))
        {
            if (((NOT (IS_CHAR_GETTING_IN_TO_A_CAR( sub_1568() ))) AND (sub_139422( sub_1568() ))) || (((sub_139380( iParam0->_fU0 )) == (sub_17367( 0 ))) || ((sub_45908( iParam0 + 0 )) != 1)))
            {
                return 0;
            }
            else
...
int sub_139578(int iParam0, unknown uParam1, boolean bParam2)
{
    ...
    else if ((NOT (IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU0 ))) AND (sub_139422( iParam0->_fU0 )))
    {
        return 2;
    }
    else if ((sub_88239( iParam0, 1 )) || (uParam1))
    {
        uVar5 = nil;
        if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
        {
...
void sub_140134(int iParam0)
{
    if (NOT (IS_CHAR_INJURED( iParam0->_fU0 )))
    {
        ...
        {
            if ((NOT l_U155) AND ((NOT l_U154) AND (sub_140200( (iParam0^) ))))
            {
                if ((NOT sub_137577()) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
                {
        ...
        {
            if ((NOT (sub_75237( l_U147 ))) || ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() ))) || ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU0 ))) || ((NOT (IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 ))) || ((NOT (IS_CHAR_ON_ANY_BIKE( sub_1568() ))) || (NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_1568(), iParam0->_fU0, l_U145, l_U145, l_U145, 0 ))))))))
            {
                sub_141587( iParam0 );
            }
        }
...
void sub_141750(int iParam0)
{
    ...
    if ((sub_137577()) AND (sub_140165( (iParam0^) )))
    {
    ...
    if (((iVar4 - l_U165) < 33) || ((sub_140165( (iParam0^) )) || (sub_137577())))
    {
        return;
    }
    if (l_U165 <= 0)
    ...
    if ((IS_VEH_DRIVEABLE( iParam0->_fU4 )) AND (NOT (IS_CHAR_INJURED( iParam0->_fU0 ))))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar12 )))
        {
            if (sub_142677( uVar12 ))
            {
                ...
                if ((iParam0->_fU0 != l_U167) AND (((fVar21 < 15) || ((fVar21 < 19) AND (IS_CHAR_ON_SCREEN( iParam0->_fU0 )))) AND (NOT (sub_140165( (iParam0^) )))))
                {
                    GET_CAR_PITCH( uVar12, ref uVar22 );
                    if ((((sub_52592( 0, 10 )) == 0) || (iParam0->_fU36 != 1)) AND (l_U104))
                    {
                        l_U104 = 0;
                        iVar15 = 17;
                        iVar11 = sub_1568();
                    }
                    else if ((NOT (IS_BIT_SET( l_U170, 6 ))) AND (((sub_45908( iParam0 + 0 )) == 1) AND ((iParam0->_fU36 == 2) AND (sub_142914( iParam0 )))))
                    {
                        iVar15 = 38;
                        uVar13 = sub_143028( bVar16 );
                        iVar11 = sub_1568();
                    }
                    else if ((sub_143116( 8 )) AND (((ABSF( uVar22 )) < 20.00000000) AND (IS_CAR_IN_AIR_PROPER( uVar12 ))))
                    {
                        uVar13 = sub_51418( bVar16 );
                        iVar15 = 8;
                    }
                    else if ((sub_143116( 12 )) AND (HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, sub_1568() )))
                    {
                        uVar13 = sub_143028( bVar16 );
                        iVar11 = sub_1568();
                        iVar15 = 12;
                    ...
                    else if ((sub_143116( 13 )) AND ((IS_PED_RAGDOLL( iParam0->_fU0 )) || (HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, 0 ))))
                    {
                        uVar13 = sub_143028( bVar16 );
                        iVar11 = nil;
                        iVar15 = 13;
                    ...
                    else if ((sub_143116( 20 )) AND ((IS_BIT_SET( l_U170, 7 )) AND ((NOT (IS_PLAYER_PRESSING_HORN( sub_4214() ))) AND ((sub_45908( iParam0 + 0 )) == 1))))
                    {
                        if (bVar16)
                        {
                            bVar18 = true;
                    ...
                    else if (((sub_45908( iParam0 + 0 )) == 1) AND ((sub_143116( 24 )) AND ((NOT (IS_BIT_SET( l_U170, 0 ))) AND (IS_WANTED_LEVEL_GREATER( sub_4214(), 0 )))))
                    {
                        iVar15 = 24;
                        iVar11 = sub_1568();
                    }
                    else if (((sub_45908( iParam0 + 0 )) == 1) AND ((sub_143116( 30 )) AND ((IS_BIT_SET( l_U170, 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_4214(), 0 ))))))
                    {
                        iVar15 = 30;
                    }
                    else
                    {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if (((sub_45908( iParam0 + 0 )) == 1) AND ((NOT (IS_BIT_SET( l_U170, 4 ))) AND (sub_143116( 33 ))))
                                {
                            ...
                            else if (IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() ))
                            {
                                ...
                                if (DOES_VEHICLE_EXIST( uVar23 ))
                                {
                                    if (((sub_45908( iParam0 + 0 )) == 1) AND ((NOT (IS_BIT_SET( l_U170, 4 ))) AND (sub_143116( 31 ))))
                                    {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (GET_CLOSEST_CHAR( uVar5._fU0, uVar5._fU4, uVar5._fU8, 25.00000000, 1, 1, ref iVar11 ))
                            {
                                ...
                                else if ((NOT (IS_WANTED_LEVEL_GREATER( sub_4214(), 0 ))) AND (sub_143116( 0 )))
                                {
                                ...
                                else if ((NOT (IS_BIT_SET( l_U170, 1 ))) AND ((IS_WANTED_LEVEL_GREATER( sub_4214(), 0 )) AND (sub_143116( 36 ))))
                                {
                                    if (IS_CHAR_ON_SCREEN( iVar11 ))
                                    {
                                        uVar13 = nil;
                                ...
                                else if ((sub_143116( 23 )) AND (IS_WANTED_LEVEL_GREATER( sub_4214(), 2 )))
                                {
                                    uVar13 = nil;
                                    iVar15 = 23;
                                };;;;
                        ...
                        if (iVar15 == 39)
                        {
                            if ((NOT (IS_BIT_SET( l_U170, 2 ))) AND (IS_WANTED_LEVEL_GREATER( sub_4214(), 0 )))
                            {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (IS_VEH_DRIVEABLE( uVar23 ))
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        case 2:
                                        if (((sub_45908( iParam0 + 0 )) == 1) AND (sub_143116( 28 )))
                                        {
                                            iVar15 = 28;
                                        }
                                        break;
                                        ...
                                        {
                                            if ((sub_143116( 4 )) AND (sub_143116( 3 )))
                                            {
                                                if (g_U15728[13])
                                                {
                                                    iVar15 = 4;
                        ...
                        if (iVar15 == 39)
                        {
                            if ((fVar26 < 5) AND ((sub_45908( iParam0 + 0 )) == 1))
                            {
                                if ((IS_WANTED_LEVEL_GREATER( sub_4214(), 0 )) AND (sub_143116( 23 )))
                                {
                                    iVar15 = 23;
                                }
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if (((sub_45908( iParam0 + 0 )) == 1) AND (sub_143116( 30 )))
                                {
                                    iVar15 = 30;
                                }
    ...
    if ((NOT (IS_BIT_SET( l_U170, 7 ))) AND (IS_PLAYER_PRESSING_HORN( sub_4214() )))
    {
...
int sub_147589(int iParam0)
{
    ...
    if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar3 )))
        {
            ...
            {
                if ((((sub_45908( iParam0 + 0 )) == 1) AND (iVar4 == sub_1568())) || ((sub_45908( ref iVar4 )) == (sub_45908( iParam0 + 0 ))))
                {
...
int sub_147846(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if (((sub_142740( iParam0->_fU0, sub_1568(), 1 )) < 90.00000000) || ((IS_CAR_ON_SCREEN( iParam0->_fU4 )) || ((IS_CHAR_ON_SCREEN( iParam0->_fU0 )) || (IS_CHAR_IN_CAR( sub_1568(), iParam0->_fU4 )))))
        {
...
int sub_148582(unknown uParam0)
{
    ...
    if (IS_PED_IN_GROUP( uParam0 ))
    {
        ...
        if (DOES_GROUP_EXIST( iVar3 ))
        {
            ...
            {
                if ((iVar3 != sub_17788()) AND ((iVar5 < 2) || (iVar4 < 1)))
                {
                    REMOVE_GROUP( iVar3 );
                }
                else
            ...
            else if ((iVar3 != sub_17788()) AND (iVar5 < 1))
            {
                REMOVE_GROUP( iVar3 );
            }
        }
...
int sub_148978(int iParam0)
{
    ...
    if ((IS_VEH_DRIVEABLE( iParam0->_fU4 )) AND (NOT (sub_88239( iParam0, 2 ))))
    {
        return 0;
    }
...
int sub_149513(int iParam0)
{
    ...
    else if (((sub_142740( iParam0->_fU0, sub_1568(), 1 )) > 90.00000000) AND ((NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))) AND ((sub_146635( iParam0 )) > 90.00000000)))
    {
        ...
        {
            if (((VDIST( sub_139923( sub_1568(), 1 ), uVar4 )) < 30.00000000) || ((IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000, 2.00000000, 2.00000000 )) || (CAM_IS_SPHERE_VISIBLE( uVar3, uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000 ))))
            {
                ;
            }
            else if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
...
int sub_150285(int iParam0)
{
    ...
    if (((sub_146635( iParam0 )) < 30.00000000) AND (sub_88239( iParam0, 1 )))
    {
        SET_CHAR_WILL_LEAVE_CAR_IN_COMBAT( iParam0->_fU0, 1 );
    ...
    if ((((sub_142740( iParam0->_fU0, iParam0->_fU8, 1 )) > fVar8) || ((DOES_VEHICLE_EXIST( iVar4 )) || ((IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU8 )) || (IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU8 ))))) AND (NOT (IS_CHAR_IN_WATER( iParam0->_fU8 ))))
    {
        if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
        {
            if ((iParam0->_fU4 == iVar4) || (sub_50230( iParam0->_fU8, iParam0->_fU4 )))
            {
            ...
            else if (((sub_45908( iParam0 + 0 )) == 1) AND (sub_50230( sub_1568(), iParam0->_fU4 )))
            {
    ...
    else if (((sub_45908( iParam0 + 0 )) == 1) AND ((iParam0->_fU8 != sub_1568()) AND (sub_147884( sub_1568(), iParam0->_fU0, 1 ))))
    {
    ...
    if (IS_CHAR_IN_WATER( iParam0->_fU8 ))
    {
        ...
        else if ((IS_CHAR_IN_ANY_CAR( iParam0->_fU0 )) || (NOT (sub_88239( iParam0, 1 ))))
        {
            if ((sub_139740( iParam0 )) != 0)
            {
                ;
    ...
    else if ((NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU8 ))) AND (sub_88239( iParam0, 1 )))
    {
...
int sub_152038(int iParam0)
{
    ...
    else if (((sub_142720( iParam0 )) > 30.00000000) AND (NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))))
    {
...
int sub_152449(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if (((VDIST( uVar4, uVar7 )) < 30.00000000) || (((VDIST( uVar4, uVar10 )) < 30.00000000) || ((IS_CAR_ON_SCREEN( iParam0->_fU4 )) || (IS_CHAR_ON_SCREEN( iParam0->_fU0 )))))
        {
            ...
            else if (((sub_45908( ref iVar3 )) == (sub_45908( iParam0 + 0 ))) || (iVar3 == sub_1568()))
            {
...
int sub_153275(int iParam0)
{
    ...
    if (((sub_146635( iParam0 )) < 30.00000000) AND ((IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 115 )) || ((IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 110 )) || (IS_PED_IN_COMBAT( iParam0->_fU0 )))))
    {
        return 2;
    }
    return 0;
...
int sub_153424(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( uVar10 ))
    {
        ...
        else if (((sub_142720( iParam0 )) >= l_U125) AND ((sub_88239( iParam0, 4 )) || (sub_147163( iParam0->_fU4 ))))
        {
        ...
        if (NOT (IS_CAR_ON_SCREEN( iParam0->_fU4 )))
        {
            ...
            if (GET_CLOSEST_CAR_NODE_WITH_HEADING( vVar9.x, vVar9.y, vVar9.z, ref uVar15._fU0, ref uVar15._fU4, ref uVar15._fU8, ref uVar18 ))
            {
                if (NOT (IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar15._fU0, uVar15._fU4, uVar15._fU8, 4.00000000, 4.00000000, 4.00000000 )))
                {
                    ...
                    if (((VDIST2( uVar15, vVar6 )) > 9.00000000) AND (((VDIST( uVar15, sub_139923( sub_1568(), 1 ) )) > fParam2) AND (NOT (CAM_IS_SPHERE_VISIBLE( uVar19, uVar15._fU0, uVar15._fU4, uVar15._fU8, 6.00000000 )))))
                    {
...
void sub_160478(unknown uParam0)
{
    ...
    if ((NOT bVar4) AND ((iVar8 >= 0) AND ((NOT (iVar14 == 4)) AND ((NOT sub_162824()) AND ((IS_CHAR_ON_ANY_BIKE( sub_1568() )) AND ((NOT (IS_CONTROL_PRESSED( 0, 39 ))) AND ((NOT (IS_CONTROL_PRESSED( 0, 38 ))) AND (IS_CONTROL_PRESSED( 0, 51 )))))))))
    {
...
void sub_160713(unknown uParam0)
{
    ...
    {
        if ((Result < 0) AND ((I != l_U110) AND (sub_160749( uParam0, I ))))
        {
            Result = I;
        }
    }
...
void sub_163408(unknown uParam0)
{
    ...
    if (HAS_SCRIPT_LOADED( "ability_stats" ))
    {
        if (NOT g_U39103)
        {
            if ((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) AND ((NOT g_U11112) AND ((NOT IS_MINIGAME_IN_PROGRESS()) AND ((NOT sub_165896()) AND (((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "ability_stats" )) == 0) AND (NOT sub_162824()))))))
            {
                if (NOT l_U1248)
                {
...
int sub_165896()
{
    ...
    {
        if ((sub_165930()) AND (ARE_WIDESCREEN_BORDERS_ACTIVE()))
        {
            return 1;
        }
