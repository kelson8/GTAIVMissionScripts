void main()
{
    ...
    l_U439 = {840.78120000, 628.64360000, 37.67980000};
    l_U442 = {831.24830000, 628.78360000, 37.97270000};
    l_U445 = {947.00000000, -261.20000000, 18.50000000};
    l_U448 = {551.97590000, 763.48400000, 20.11330000};
    l_U454 = 1;
    SET_MISSION_FLAG( 1 );
...
void sub_1899()
{
    ...
    {
        if ((g_U572[I]._fU20) AND ((sub_1937( 5, g_U572[I] )) == 1))
        {
...
void sub_4403()
{
    ...
    if (g_U39149[12] > 0)
    {
        while ((NOT (HAS_MODEL_LOADED( 2006142190 ))) || ((NOT (HAS_MODEL_LOADED( 977480632 ))) || ((NOT (HAS_MODEL_LOADED( -2107556865 ))) || ((NOT (HAS_MODEL_LOADED( -14495224 ))) || (NOT (HAS_MODEL_LOADED( 729783779 )))))))
        {
            WAIT( 0 );
    ...
    SET_CAR_GENERATORS_ACTIVE_IN_AREA( 961.33900000, 1550.66900000, 12.83640000, 911.34470000, 1562.85900000, 24.39600000, 0 );
...
void sub_6855(unknown uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
    ...
    if (NOT (IS_CHAR_DEAD( (uParam0^) )))
    {
        ...
        if ((g_U15728[19]) AND ((uParam0^) == sub_2940()))
        {
...
void sub_9091(int iParam0, int iParam1)
{
    ...
    if ((iParam1 != sub_2940()) AND (iParam0->_fU8 == sub_2940()))
    {
        if (iParam0->_fU0 == g_U11198)
        {
            g_U11198 = nil;
...
{
    return (NOT (sub_9211( uParam0, uParam1 ))) AND (IS_CHAR_SITTING_IN_CAR( uParam0, uParam1 ));
}
...
void sub_11113()
{
    switch (l_U366)
    {
        ...
        SET_CAM_ROT( l_U587[0], -7.39834800, 0.00000000, 168.22640000 );
        ...
        SET_CAM_ROT( l_U587[1], -5.02579500, -0.00000000, -176.32050000 );
...
void sub_14397()
{
    if ((NOT (IS_CHAR_INJURED( l_U541 ))) AND ((NOT (IS_CHAR_INJURED( l_U542 ))) AND (NOT (IS_CHAR_INJURED( l_U543 )))))
    {
...
void sub_14780()
{
    switch (l_U371)
    {
        ...
        if (l_U455 == 0)
        {
            if ((NOT (IS_CHAR_IN_ANY_HELI( sub_2940() ))) AND ((sub_14908( 1, 1 )) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_2940(), l_U403._fU0, l_U403._fU4, l_U403._fU8, 5.00000000, 5.00000000, 2.00000000, l_U454 ))))
            {
                SET_PLAYER_CONTROL( sub_9017(), 0 );
        ...
        switch (l_U372)
        {
            ...
            break;
            case 1:
            if ((NOT sub_11216()) AND (TIMERA() > 1000))
            {
            ...
            break;
            case 2:
            if ((TIMERA() > 500) AND (NOT sub_11216()))
            {
                PRINT_NOW( "GOTOTOLL", 7500, 1 );
                SETTIMERA( 0 );
                l_U372++;
            ...
            break;
            case 3:
            if ((TIMERA() > 8000) AND (NOT sub_11216()))
            {
                if (l_U455 == 0)
                {
                    if (NOT (IS_CHAR_INJURED( l_U541 )))
            ...
            if (NOT l_U476)
            {
                if (l_U455 == 0)
                {
                    if ((TIMERA() > 22000) AND (NOT (sub_13936( l_U565 ))))
                    {
                        if (g_U39240 == 0)
                        {
        ...
        SET_CAM_PROPAGATE( l_U587[0], 1 );
        CREATE_CAM( 14, ref l_U587[1] );
        SET_CAM_POS( l_U587[1], 824.49170000, 631.10550000, 44.42840000 );
...
int sub_17511()
{
    ...
    for ( I = 0; I <= (g_U572 - 1); I++ )
    {
        if ((g_U572[I]._fU20) AND ((sub_1937( 1, g_U572[I] )) != 0))
        {
            sub_2223( I );
            return 1;
        }
...
void sub_27985()
{
    ...
    {
        if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U536, sub_2940(), 3.00000000, 14.00000000, 3.00000000, 0 )) AND (HAS_CHAR_SPOTTED_CHAR( l_U536, sub_2940() )))
        {
            sub_28066( 3 );
        }
    ...
    {
        if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U537, sub_2940(), 3.00000000, 14.00000000, 3.00000000, 0 )) AND (HAS_CHAR_SPOTTED_CHAR( l_U537, sub_2940() )))
        {
            sub_28066( 3 );
        }
...
void sub_29688(unknown uParam0)
{
    ...
    SET_CAM_FOV( l_U587[1], 36.10002000 );
    CREATE_CAM( 3, ref l_U590 );
    ...
    switch (uParam0)
    {
        ...
        if (NOT (IS_CHAR_INJURED( l_U541 )))
        {
            ...
            while ((NOT sub_13385()) AND (sub_13936( l_U565 )))
            {
                WAIT( 0 );
            }
        }
...
{
    sub_27985();
    if ((NOT (IS_CHAR_INJURED( l_U541 ))) AND (NOT (IS_CHAR_INJURED( l_U519[11] ))))
    {
        switch (l_U367)
        {
            case 0:
            ...
            if (TIMERB() > 2000)
            {
                if ((NOT (IS_CHAR_INJURED( l_U519[11] ))) AND (NOT (sub_13936( l_U565 ))))
                {
                    if (NOT (IS_CHAR_INJURED( l_U541 )))
                    {
            ...
            if ((NOT (IS_CHAR_INJURED( l_U541 ))) AND (NOT (IS_CHAR_INJURED( l_U519[11] ))))
            {
                if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U541, l_U519[11], 4.00000000, 4.00000000, 3.00000000, 0 ))) AND (NOT (sub_13936( l_U565 ))))
                {
                    g_U10435 = 0;
                    l_U367++;
                }
    ...
    if ((NOT (IS_CHAR_INJURED( l_U541 ))) AND (NOT (IS_CHAR_INJURED( l_U519[0] ))))
    {
        switch (l_U368)
        {
            case 0:
            ...
            if (TIMERB() > 2000)
            {
                if ((NOT (IS_CHAR_INJURED( l_U519[0] ))) AND (NOT (sub_13936( l_U565 ))))
                {
                    if (NOT (IS_CHAR_INJURED( l_U541 )))
                    {
                        if (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_2940(), l_U541, 20, 20, 3, 0 ))
            ...
            if ((NOT (IS_CHAR_INJURED( l_U541 ))) AND (NOT (IS_CHAR_INJURED( l_U519[0] ))))
            {
                if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U541, l_U519[0], 4.00000000, 4.00000000, 3.00000000, 0 ))) AND (NOT (sub_13936( l_U565 ))))
                {
                    g_U10435 = 0;
                    l_U368++;
                }
    ...
    if (NOT (IS_CHAR_INJURED( l_U541 )))
    {
        if (IS_VEH_DRIVEABLE( l_U504[0] ))
        {
            if (sub_25776( 1, 1 ))
            {
                if (l_U455 == 0)
                {
                    if ((IS_CHAR_SITTING_IN_CAR( sub_2940(), l_U504[0] )) AND ((IS_CHAR_SITTING_IN_CAR( l_U541, l_U504[0] )) AND (LOCATE_CAR_3D( l_U504[0], l_U397._fU0, l_U397._fU4, l_U397._fU8, 4.00000000, 4.00000000, 2.50000000, l_U454 ))))
                    {
                        l_U362++;
                    }
                }
    ...
    if (l_U382 > 0)
    {
        ...
        if ((l_U375 - l_U374) > 18000)
        {
            ...
            if (l_U383 < 3)
            {
                ...
                if ((IS_CHAR_SHOOTING( sub_2940() )) AND (l_U604 == 22))
                {
...
void sub_43853()
{
    ...
    CREATE_CAM( 14, ref l_U587[0] );
    SET_CAM_POS( l_U587[0], 923.49560000, 1576.67600000, 17.91833000 );
    SET_CAM_ROT( l_U587[0], 0.52075000, 0.00000000, -152.69690000 );
    SET_CAM_FOV( l_U587[0], 35.00000000 );
    SET_CAM_ACTIVE( l_U587[0], 1 );
    SET_CAM_PROPAGATE( l_U587[0], 1 );
    CREATE_CAM( 14, ref l_U587[1] );
    SET_CAM_POS( l_U587[1], 923.89470000, 1568.49100000, 17.90946000 );
    ...
    l_U492 = 0;
    while ((NOT l_U471) AND (sub_13936( l_U565 )))
    {
        WAIT( 0 );
        if (sub_13385())
        {
