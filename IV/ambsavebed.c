void main()
{
    ...
    // 8 is in sub_5938
    // Possibly bed stage, seems to go from 0-8
    currentBedStage = 0;
    l_U10 = 0;

    // l_U11 is possibly interiorId, 2 = loftrm1, 4 = PlayXroom
    l_U11 = 0;
    l_U178 = 1;
    l_U179 = 0;
    l_U180 = 0;
    ...
    saveGameAnimation = "AMB@SAVEGAME";
        ...
        if (IS_PLAYER_PLAYING( CurrentPlayerId() ))
        {
            if (NOT (IS_CHAR_DEAD( CurrentPlayerChar() )))
            {
                if (sub_265())
                {
                    ...
                    else if ((NOT g_U9893._fU12) AND (NOT (l_U8 == 4)))
                    {
                        if ((l_U11 == 4) || (l_U11 == 2))
                        {
                            if ((NOT sub_1159()) AND (sub_568()))
                            {
                                if (sub_8281())
                                {
                                    sub_8332();
...
// Get the current player interior
// If the player interior is not null, request save game animation and model.
void sub_371()
{
    int currentPlayerInterior;

    GET_INTERIOR_FROM_CHAR( CurrentPlayerChar(), ref currentPlayerInterior );
    if (NOT (currentPlayerInterior == nil))
    {
        if (l_U178)
        {
            REQUEST_ANIMS( saveGameAnimation );
...
void sub_455()
{
    if ((NOT (HAS_MODEL_LOADED( -809347846 ))) AND (NOT (HAVE_ANIMS_LOADED( saveGameAnimation ))))
    {
        REQUEST_ANIMS( saveGameAnimation );
        REQUEST_MODEL( -809347846 );
    }
...
void sub_542()
{
    ...
    if (IS_PLAYER_PLAYING( CurrentPlayerId() ))
    {
        if (sub_568())
        {
            if (LOCATE_CHAR_ON_FOOT_3D( CurrentPlayerChar(), l_U12[l_U11]._fU92._fU0, l_U12[l_U11]._fU92._fU4, l_U12[l_U11]._fU92._fU8, l_U12[l_U11]._fU104._fU0, l_U12[l_U11]._fU104._fU4, l_U12[l_U11]._fU104._fU8, 0 ))
            {
                if ((NOT sub_1159()) AND ((NOT IS_MEMORY_CARD_IN_USE()) AND ((IS_SCREEN_FADED_IN()) AND (NOT g_U10978))))
                {
...
// Switch for the bed stage
void sub_1738()
{
    if (NOT (currentBedStage > 5))
    {
        DISABLE_PAUSE_MENU( 1 );
    }
    if (NOT (currentBedStage == 8))
    {
        sub_1292();
        sub_1783();
    }
...
// Set player weapon to nothing, remove helmet
// sub_2174
void MakePlayerSafeForBed()
{
    if (IS_PLAYER_PLAYING( CurrentPlayerId() ))
    {
...
void sub_2244()
{
    ...
    if (IS_PLAYER_PLAYING( CurrentPlayerId() ))
    {
        GET_PLAYERS_LAST_CAR_NO_SAVE( ref currentVehicle );
        if (IS_VEH_DRIVEABLE( currentVehicle ))
        {
            if ((LOCATE_CAR_3D( currentVehicle, l_U12[l_U11]._fU28._fU0, l_U12[l_U11]._fU28._fU4, l_U12[l_U11]._fU28._fU8, 5.00000000, 5.00000000, 1.50000000, 0 )) || (LOCATE_CAR_3D( currentVehicle, l_U12[l_U11]._fU16._fU0, l_U12[l_U11]._fU16._fU4, l_U12[l_U11]._fU16._fU8, 5.00000000, 5.00000000, 1.50000000, 0 )))
            {
                SET_CAR_COORDINATES( currentVehicle, l_U12[l_U11]._fU116._fU0, l_U12[l_U11]._fU116._fU4, l_U12[l_U11]._fU116._fU8 );
                SET_CAR_HEADING( currentVehicle, l_U12[l_U11]._fU128 );
                GET_CAR_MODEL( currentVehicle, ref storedVehicle );

                if ((IS_THIS_MODEL_A_CAR( storedVehicle )) || (IS_THIS_MODEL_A_BIKE( storedVehicle )))
                {
                    SET_CAR_ON_GROUND_PROPERLY( currentVehicle );
                }
            }
        }
        ...
        if (l_U10 == 2)
        {
            ...
            SET_CHAR_COORDINATES( CurrentPlayerChar(), l_U12[l_U11]._fU28._fU0, l_U12[l_U11]._fU28._fU4, l_U12[l_U11]._fU28._fU8 );
        }
        ...
        SET_CHAR_COORDINATES( CurrentPlayerChar(), l_U12[l_U11]._fU16._fU0, l_U12[l_U11]._fU16._fU4, l_U12[l_U11]._fU16._fU8 );;
        SET_CHAR_HEADING( CurrentPlayerChar(), l_U191 );
        if (NOT (IS_PED_ATTACHED_TO_OBJECT( CurrentPlayerChar(), l_U185 )))
        {
            ;
        }
    }

    BEGIN_CAM_COMMANDS( ref camCommands );

    CREATE_CAM( 14, ref currentCamera );
    if (l_U10 == 2)
    {
        SET_CAM_POS( currentCamera, l_U12[l_U11]._fU40._fU0, l_U12[l_U11]._fU40._fU4, l_U12[l_U11]._fU40._fU8 );
        SET_CAM_ROT( currentCamera, l_U12[l_U11]._fU52._fU0, l_U12[l_U11]._fU52._fU4, l_U12[l_U11]._fU52._fU8 );
    }
    else
    {
        SET_CAM_POS( currentCamera, l_U12[l_U11]._fU64._fU0, l_U12[l_U11]._fU64._fU4, l_U12[l_U11]._fU64._fU8 );
        SET_CAM_ROT( currentCamera, l_U12[l_U11]._fU76._fU0, l_U12[l_U11]._fU76._fU4, l_U12[l_U11]._fU76._fU8 );
    }

    SET_CAM_NEAR_CLIP( currentCamera, 0.10000000 );
    SET_CAM_ACTIVE( currentCamera, 1 );
    SET_CAM_PROPAGATE( currentCamera, 1 );
...
void sub_3485()
{
    if (IS_PLAYER_PLAYING( CurrentPlayerId() ))
    {
        ...
        if (HAVE_ANIMS_LOADED( saveGameAnimation ))
        {
            OPEN_SEQUENCE_TASK( ref bedSequenceTask );
            if (l_U10 == 2)
            {
                TASK_PLAY_ANIM_WITH_FLAGS( 0, "LIE_ON_BED_R", saveGameAnimation, 4.00000000, 0, 160 );
            }
            else
            {
                TASK_PLAY_ANIM_WITH_FLAGS( 0, "LIE_ON_BED_L", saveGameAnimation, 4.00000000, 0, 160 );
            }
            CLOSE_SEQUENCE_TASK( bedSequenceTask );
            TASK_PERFORM_SEQUENCE( CurrentPlayerChar(), bedSequenceTask );
            CLEAR_SEQUENCE_TASK( bedSequenceTask );
            currentBedStage = 4;
        }
        else
        {
...
void sub_3716()
{
    if (IS_PLAYER_PLAYING( CurrentPlayerId() ))
    {
        if (IS_PLAYER_PLAYING( CurrentPlayerId() ))
        {
            SET_USE_LEG_IK( CurrentPlayerId(), 0 );
        }
        GET_SCRIPT_TASK_STATUS( CurrentPlayerChar(), 29, ref currentScriptTaskStatus );

        // 1 seems to be what activates the save game animation.
        if (currentScriptTaskStatus == 1)
        {
            if (l_U10 == 2)
            {
                if (IS_CHAR_PLAYING_ANIM( CurrentPlayerChar(), saveGameAnimation, "LIE_ON_BED_R" ))
                {
                    if (HAS_CHAR_ANIM_FINISHED( CurrentPlayerChar(), saveGameAnimation, "LIE_ON_BED_R" ))
                    {
            ...
            else if (IS_CHAR_PLAYING_ANIM( CurrentPlayerChar(), saveGameAnimation, "LIE_ON_BED_L" ))
            {
                if (HAS_CHAR_ANIM_FINISHED( CurrentPlayerChar(), saveGameAnimation, "LIE_ON_BED_L" ))
                {
                    DO_SCREEN_FADE_OUT( 700 );
                    currentBedStage = 5;
                }
        ...
        // 2 and 7 changes currentBedStage to 7.
        else if ((currentScriptTaskStatus == 2) || (currentScriptTaskStatus == 7))
        {
            currentBedStage = 7;
        }
    }
...
void sub_4034()
{
    ...
    if (IS_SCREEN_FADED_OUT())
    {
        if (IS_PLAYER_PLAYING( CurrentPlayerId() ))
        {
            ...
            if ((l_U11 == 3) || ((l_U11 == 4) || (l_U11 == 2)))
            {
                alarmClockSound = "ALARM_CLOCK_MECH_MULTI";
            }
            else
            {
                alarmClockSound = "ALARM_CLOCK_ELECTRIC_LOOP";
            }
            ...
            if (DID_SAVE_COMPLETE_SUCCESSFULLY())
            {
                ...
                PLAY_SOUND_FROM_POSITION( currentSoundId, alarmClockSound, uVar2 );
                l_U181 = 1;
                if (NOT g_U8705)
                {
                    if (l_U196 < 6)
    ...
    if (IS_SCREEN_FADED_IN())
    {
        if (IS_PLAYER_PLAYING( CurrentPlayerId() ))
        {
            if (HAVE_ANIMS_LOADED( saveGameAnimation ))
            {
                ...
                if (l_U10 == 2)
                {
                    TASK_PLAY_ANIM_WITH_FLAGS( 0, "GET_OUT_BED_R", saveGameAnimation, 1000.00000000, 0, 200 );
                }
                else
                {
                    TASK_PLAY_ANIM_WITH_FLAGS( 0, "GET_OUT_BED_L", saveGameAnimation, 1000.00000000, 0, 200 );
                }
                CLOSE_SEQUENCE_TASK( bedSequenceTask );
                TASK_PERFORM_SEQUENCE( CurrentPlayerChar(), bedSequenceTask );
                CLEAR_SEQUENCE_TASK( bedSequenceTask );
...
void sub_5938()
{
    ...
    if (IS_PLAYER_PLAYING( CurrentPlayerId() ))
    {
        ...
        if ((currentScriptTaskStatus == 2) || (currentScriptTaskStatus == 7))
        {
            if (l_U181)
            {
            ...
            DESTROY_CAM( currentCamera );
            END_CAM_COMMANDS( ref camCommands );
        ...
        else
        {
            ...
            if (currentScriptTaskStatus == 1)
            {
                if (l_U10 == 2)
                {
                    if (IS_CHAR_PLAYING_ANIM( CurrentPlayerChar(), saveGameAnimation, "GET_OUT_BED_R" ))
                    {
                        if (HAS_CHAR_ANIM_FINISHED( CurrentPlayerChar(), saveGameAnimation, "GET_OUT_BED_R" ))
                        {
                            bVar2 = true;
                        }
                    }
                }
                else if (IS_CHAR_PLAYING_ANIM( CurrentPlayerChar(), saveGameAnimation, "GET_OUT_BED_L" ))
                {
                    if (HAS_CHAR_ANIM_FINISHED( CurrentPlayerChar(), saveGameAnimation, "GET_OUT_BED_L" ))
                    {
                        bVar2 = true;
                    }
                }
...
// Possibly locations for all the beds?
void sub_6470()
{
    int I;
    int iVar3;
    ...
    l_U12[0]._fU40 = {893.57780000, -491.87750000, 20.27680000};

    l_U12[0]._fU52 = {-14.35633000, -0.00000000, 146.20300000};
    ...
    l_U12[1]._fU4 = {601.17940000, 1411.32500000, 16.88680000};
    l_U12[1]._fU88 = 180.00000000;

    l_U12[1]._fU92 = {601.17940000, 1411.67500000, 16.88680000};
    ...
    l_U12[2]._fU28 = {103.31260000, 846.62590000, 44.04590000};
    ...
    l_U12[3]._fU40 = {-968.29230000, 888.43180000, 20.64495000};
    l_U12[3]._fU52 = {-23.84027000, -0.00000000, 47.16120000};

    l_U12[3]._fU64 = {-968.29230000, 888.43180000, 20.64495000};
    ...
    l_U12[3]._fU116 = {-956.63680000, 901.05690000, 12.57360000};
...
void sub_8332()
{
    ...
    if (IS_PLAYER_PLAYING( CurrentPlayerId() ))
    {
        if (LOCATE_CHAR_ON_FOOT_3D( CurrentPlayerChar(), vVar40[l_U11]._fU0, vVar40[l_U11]._fU4, vVar40[l_U11]._fU8, 1.20000000, 1.20000000, 1.60000000, 1 ))
        {
            if (NOT l_U179)
            {
                l_U179 = 1;
            ...
            else if (NOT IS_SCREEN_FADING())
            {
                ...
                if (IS_PLAYER_PLAYING( CurrentPlayerId() ))
                {
                    ...
                    SET_CHAR_COORDINATES( CurrentPlayerChar(), vVar18[l_U11]._fU0, vVar18[l_U11]._fU4, vVar18[l_U11]._fU8 );
                    if (iVar90[l_U11])
                    {
                        SET_ROOM_FOR_CHAR_BY_NAME( CurrentPlayerChar(), sVar84[l_U11] );
                    }

                    SET_CHAR_HEADING( CurrentPlayerChar(), fVar34[l_U11] );
                    SET_CAM_BEHIND_PED( CurrentPlayerChar() );
        ...
        else if (LOCATE_CHAR_ON_FOOT_3D( CurrentPlayerChar(), vVar2[l_U11]._fU0, vVar2[l_U11]._fU4, vVar2[l_U11]._fU8, 1.60000000, 1.60000000, 1.60000000, 1 ))
        {
            if (NOT IS_SCREEN_FADING())
            {
                ...
                if (IS_PLAYER_PLAYING( CurrentPlayerId() ))
                {
                    ...
                    {
                        WARP_CHAR_FROM_CAR_TO_COORD( CurrentPlayerChar(), vVar56[l_U11]._fU0, vVar56[l_U11]._fU4, vVar56[l_U11]._fU8 );
                    }
                    else
                    {
                        SET_CHAR_COORDINATES( CurrentPlayerChar(), vVar56[l_U11]._fU0, vVar56[l_U11]._fU4, vVar56[l_U11]._fU8 );
                    }
                    
                    SET_ROOM_FOR_CHAR_BY_NAME( CurrentPlayerChar(), sVar78[l_U11] );
                    SET_CHAR_HEADING( CurrentPlayerChar(), fVar72[l_U11] );
                    SET_CAM_BEHIND_PED( CurrentPlayerChar() );
...
void sub_10187()
{
    REMOVE_ANIMS( saveGameAnimation );
