                ...
                if (sub_11609( l_U1335, l_U1389 ))
                {
                    ...
                    else if (IS_HELP_MESSAGE_BEING_DISPLAYED())
                    {
                        for ( I = 0; I < 31; I++ )
                        {
                            ...
                            {
                                if ((IS_THIS_HELP_MESSAGE_WITH_STRING_BEING_DISPLAYED( "LB_TRYON_R3", l_U283[I]._fU4 )) || ((IS_THIS_HELP_MESSAGE_WITH_STRING_BEING_DISPLAYED( "LB_TRYON_B", l_U283[I]._fU4 )) || (IS_THIS_HELP_MESSAGE_WITH_STRING_BEING_DISPLAYED( "LB_TRYON", l_U283[I]._fU4 ))))
                                {
                                    CLEAR_HELP();
                                }
                            }
...
void sub_2783()
{
    ...
    sub_2861( 2, 3.70000000, -5.20000000, 1.40000000, 1.25000000, 0.50000000, 1.50000000, 3.90000000, -5.20000000, 1.40000000, 889.30950000, -437.99200000, 14.86010000, 360.00000000 );
    ...
    sub_2861( 12, -6.10000000, 5.40000000, 1.40000000, 0.75000000, 0.40000000, 1.50000000, -6.30000000, 5.80000000, 1.40000000, 879.62440000, -447.51200000, 14.86010000, 287.64000000 );
    sub_2861( 13, -5.25000000, 5.40000000, 1.40000000, 0.75000000, 0.45000000, 1.50000000, -6.30000000, 5.80000000, 1.40000000, 879.62440000, -446.51200000, 14.86010000, 270.00000000 );
    sub_2861( 14, -4.40000000, 5.40000000, 1.40000000, 0.75000000, 0.40000000, 1.50000000, -4.80000000, 5.80000000, 1.40000000, 879.62440000, -445.61200000, 14.86010000, 270.00000000 );
    sub_2861( 15, -3.20000000, 5.30000000, 1.40000000, 0.75000000, 0.80000000, 1.50000000, -3.30000000, 5.80000000, 1.40000000, 879.62440000, -444.63640000, 14.86010000, 270.00000000 );
    sub_2861( 16, -1.80000000, 5.30000000, 1.40000000, 0.75000000, 0.60000000, 1.50000000, 1.40000000, 5.80000000, 1.40000000, 879.62440000, -443.12100000, 14.86010000, 270.00000000 );
    sub_2861( 17, -0.60000000, 5.30000000, 1.40000000, 0.75000000, 0.60000000, 1.50000000, 1.40000000, 5.80000000, 1.40000000, 879.62440000, -441.82100000, 14.86010000, 206.28000000 );
    sub_2861( 18, 0.60000000, 5.30000000, 1.40000000, 0.75000000, 0.60000000, 1.50000000, 2.90000000, 5.80000000, 1.40000000, 879.62440000, -440.49660000, 14.86010000, 300.00000000 );
    ...
    sub_2861( 28, -3.60000000, 3.10000000, 1.40000000, 1.30000000, 1.30000000, 1.50000000, -3.60000000, 3.00000000, 1.40000000, 880.33720000, -444.14280000, 14.86020000, 199.80000000 );
...
void sub_5240()
{
    ...
    sub_5288( 14, 880.94420000, -446.11930000, 16.20920000, -1.29170000, -0.00000000, 72.99700000, 45.00000000 );
    ...
    sub_5288( 19, 887.69170000, -443.60670000, 15.66380000, -0.00400000, 0.00000000, 72.43540000, 45.00000000 );
    ...
    sub_5288( 23, 882.37370000, -441.00780000, 15.84000000, -2.04930000, -0.00000000, -69.20680000, 45.00000000 );
...
void sub_9540()
{
    ...
    l_U202[2]._fU24 = {0.10300000, 0.09400000, 0.07900001};
...
int sub_16036()
{
    ...
    switch (l_U200)
    {
        ...
        else
        {
            ...
            {
                if ((sub_16485( uVar3, l_U1335 )) || (LOCATE_CAR_3D( uVar3, l_U1345._fU0, l_U1345._fU4, l_U1345._fU8, 7.50000000, 7.50000000, 7.50000000, 0 )))
                {
            ...
            SET_CAM_POS( l_U1400[0], 890.22430000, -438.83030000, 16.89151000 );
            SET_CAM_ROT( l_U1400[0], -9.57918400, 0.00000000, 112.57860000 );
...
int sub_16082(unknown uParam0, int iParam1)
{
    if ((uParam0^))
    {
        if ((iParam1 > 0) AND ((IS_SCREEN_FADED_IN()) AND (sub_16099())))
        {
            return 1;
        }
        else
...
int sub_20038(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, int iParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, unknown uParam17, unknown uParam18, unknown uParam19, unknown uParam20, unknown uParam21, unknown uParam22, unknown uParam23, unknown uParam24)
{
    ...
    if ((NOT (uParam11^)) AND (sub_20064( 2, 0 )))
    {
...
int sub_31410(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, int iParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, unknown uParam17, unknown uParam18, unknown uParam19, unknown uParam20, unknown uParam21, unknown uParam22, unknown uParam23, unknown uParam24, unknown uParam25, unknown uParam26, unknown uParam27, unknown uParam28)
{
    ...
    if ((NOT (uParam11^)) AND (sub_20064( 2, 0 )))
    {
        if ((NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( sub_31552( uParam7, 1, 1 ) ))) AND ((NOT (IS_THIS_HELP_MESSAGE_WITH_NUMBER_BEING_DISPLAYED( sub_31552( uParam7, 1, 0 ), iParam8 ))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( sub_31552( uParam7, 0, 0 ) )))))
        {
            if (sub_20445( 2, "BLANK", 0 ))
            {
                sub_749( 2, "BLANK" );
...
int sub_33586(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, int iParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, unknown uParam17, unknown uParam18)
{
    ...
    if ((NOT l_U1324) AND (sub_20064( 2, 0 )))
    {
...
int sub_45915(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7)
{
    ...
    else if ((NOT l_U1325) AND (sub_41789( "BLANK" )))
    {
        return sub_51763( sVar12, uParam0, ref uParam1 );
    }
