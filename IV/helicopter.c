void main()
{
    ...
    l_U612 = 196.71320000;
    l_U613 = {785.50160000, 152.45710000, 30.75240000};
    l_U616 = 339.37170000;
    ...
    while (true)
    {
        ...
        if (IS_PLAYER_PLAYING( sub_1297() ))
        {
            ...
            {
                case 0:
                // Looks like requesting the model and checking for a blip
                sub_5240();
                // Some sets of coords and a blip for the coords.
                sub_6602();
                l_U484 = 1;
                break;
                case 1:
                ...
                break;
                case 5:
                // Not sure where l_U870 is coming from but it seems to be the current helicopter?
                if (IS_VEH_DRIVEABLE( l_U870 ))
                {
                    SET_GAME_CAM_HEADING( 0.00000000 );
                    // Set high dof, set widescreen borders, allow the player controls.
                    // Deactivate scripted cams, Disable everyone ignore player, allow emergency services.
                    // Clear tasks, hide weapon for cutscene
                    sub_1270( 0 );
                ...
                if (IS_VEH_DRIVEABLE( l_U870 ))
                {
                    ...
                    if ((l_U494 == 1) AND ((l_U495 == 1) AND (l_U496 == 1)))
                    {
                        CLEAR_PRINTS();
                        // Set the peds group member?
                        sub_10105( l_U896 );
                        sub_10105( l_U894 );
                        sub_10105( l_U895 );
...
// Gets the players id, GET_PLAYER_ID?
void sub_1297()
{
            ...
            if (NOT (IS_CHAR_INJURED( l_U895 )))
            {
                switch (l_U897)
                {
                    ...
                    if (l_U902 > 1000)
                    {
                        ...
                        sub_8875( 760.65570000, 116.55500000, 58.21360000, -49.09749000, -0.00000100, -55.91641000, 45, l_U899 );
...
void sub_8384(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    ...
    {
        if ((IS_CHAR_SITTING_IN_ANY_CAR( sub_1390() )) || (IS_CHAR_IN_ANY_CAR( uParam0 )))
        {
...
void sub_16512(int iParam0)
{
    ...
    else if (iParam0 == 3)
    {
        ...
        SET_CAM_ROT( l_U874[4], 50.41197000, 0.00000100, 38.70676000 );
    ...
    else if (iParam0 == 4)
    {
        ...
        SET_CAM_ROT( l_U874[2], -51.68477000, 0.00000100, 60.25109000 );
        SET_CAM_FOV( l_U874[2], 51.89998000 );
        ADD_CAM_SPLINE_NODE( l_U871, l_U874[2] );
    }
    else if (iParam0 == 5)
    {
        ...
        SET_CAM_POS( l_U874[3], -30.94306000, 230.44480000, 250.11080000 );
        ...
        SET_CAM_ROT( l_U874[4], -3.31155100, 0.00000000, -63.07891000 );
    ...
    else if (iParam0 == 7)
    {
        ...
        SET_CAM_ROT( l_U874[0], 46.58486000, 0.00000000, 59.26371000 );
                                ...
                                if (NOT (sub_4190( l_U684 )))
                                {
                                    if (NOT (sub_4190( l_U698 )))
                                    {
                                        if (NOT (sub_4190( l_U740 )))
                                        {
                                            ...
                                            if ((g_U9117[2] == 1) AND ((g_U9117[1] == 1) AND (g_U9117[0] == 1)))
                                            {
                                                l_U580 = 4;
                                            }
                                        }
