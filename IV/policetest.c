...
vector sub_6907(unknown uParam0, int iParam1)
{
    switch (uParam0)
    {
        ...
        switch (iParam1)
        {
            ...
            case 72: return vector( 370.37630000, -448.75110000, 3.69260000);
    ...
    if (NOT g_U8086)
    {
        ...
        if ((NOT l_U496) AND (IS_CONTROL_PRESSED( 2, 77 )))
        {
            switch (l_U490)
            {
                ...
                break;
                case 2:
                if ((g_U15654[20]) AND ((sub_27338()) AND ((NOT g_U10978) AND (NOT GET_MISSION_FLAG()))))
                {
                    PLAY_SOUND_FRONTEND( -1, "POLICE_COMPUTER_FORWARDS" );
                    l_U489 = 3;
                    l_U490 = 0;
                ...
                if (NOT g_U8218)
                {
                    if ((g_U8216 != iVar7) || ((g_U8215 != iVar6) || ((VDIST( g_U8212, uVar3 )) > 150.00000000)))
                    {
                        g_U8212 = {uVar3};
                        g_U8215 = iVar6;
                        g_U8216 = iVar7;
...
void sub_30791()
{
    ...
    switch (l_U493)
    {
        ...
        if ((sub_32939( l_U495 )) AND (NOT sub_32861()))
        {
        ...
        break;
        case 2:
        if ((NOT sub_37318()) AND (NOT sub_34937()))
        {
...
void sub_44369(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((DOES_TEXT_LABEL_EXIST( uParam1 )) || (DOES_TEXT_LABEL_EXIST( uParam0 )))
    {
        for ( I = 0; I <= 99; I++ )
        {
            ...
            if ((COMPARE_STRING( ref g_U2273[I]._fU0, uParam0 )) || ((COMPARE_STRING( ref g_U2273[I]._fU0, uParam1 )) || (COMPARE_STRING( ref g_U2273[I]._fU16, uParam0 ))))
            {
                if (NOT g_U2273[I]._fU208)
                {
                    (uParam2^)[Result] = I;
...
void sub_48288(int iParam0, unknown uParam1)
{
    ...
    if (((VMAG( g_U2273[iParam0]._fU60[0]._fU16 )) > 0.00000000) || ((VMAG( g_U2273[iParam0]._fU32._fU16 )) > 0.00000000))
    {
        if (iParam0 != g_U8083)
        {
...
void sub_50452(int iParam0, boolean bParam1)
{
    ...
    if ((NOT l_U496) AND (IS_CONTROL_PRESSED( 2, 77 )))
    {
        if ((NOT g_U2273[iParam0]._fU208) AND (iParam0 != g_U8083))
        {
            if (((VMAG( g_U2273[iParam0]._fU32._fU16 )) > 1.00000000) AND (l_U715 == 0))
            {
                    ...
                    else if (IS_THREAD_ACTIVE( l_U658 ))
                    {
                        if ((VMAG( g_U2273[iParam0]._fU32._fU16 )) > 0.00000000)
                        {
                            if (g_U8083 != iParam0)
                            {
                                ...
                                if ((NOT sub_51166()) AND (NOT sub_51134()))
                                {
                                    DISPLAY_RADAR( 0 );
                                }
                                sub_50910( iParam0 );
...
void sub_54681()
{
    ...
    for ( I = 0; I <= (sub_44917() - 1); I++ )
    {
        if ((NOT (g_U2273[I]._fU216 == 1)) AND ((sub_55829( uVar8, I )) AND ((NOT g_U2273[I]._fU208) AND (g_U2273[I]._fU196 < 2000))))
        {
...
int sub_56152(int iParam0)
{
    ...
    {
        if ((sub_55829( uVar7, Result )) AND ((NOT g_U2273[Result]._fU212) AND (g_U2273[Result]._fU196 == iParam0)))
        {
