void main()
{
    ...
    while (true)
    {
        ...
        if ((((NOT IS_PLAYER_ONLINE()) AND (IS_IN_LAN_MODE() == 0)) || ((IS_IN_LAN_MODE() == 1) AND (NOT NETWORK_IS_NETWORK_AVAILABLE()))) AND (cellphone3Dstructure._fU0 != 1001))
        {
            sub_3643( 1001 );
        }
        ...
        else if ((cellphone3Dstructure._fU48) || (cellphone3Dstructure._fU52))
        {
            if ((sub_4347( ref l_U2079 )) AND (NOT sub_4381()))
            {
        ...
        else if (cellphone3Dstructure._fU632 == 1)
        {
            sub_3643( 1064 );
        };;;;
        if (sub_5027( iVar18 ))
        {
            switch (cellphone3Dstructure._fU0)
            {
                ...
                {
                    switch (sub_28583( cellphone3Dstructure._fU524 ))
                    {
                        case 6:
                        l_U2109 = -1;
                        sub_3643( 1058 );
                ...
                switch (sub_28583( cellphone3Dstructure._fU524 ))
                {
                    ...
                    switch (cellphone3Dstructure._fU0)
                    {
                        ...
                        case 1075:
                        case 1084:
                        l_U2109 = cellphone3Dstructure._fU0;
                        sub_3643( 1058 );
                        break;
                        case 1078:
                        l_U2109 = 1078;
                    ...
                    switch (cellphone3Dstructure._fU0)
                    {
                        ...
                        switch (l_U3._fU60)
                        {
                            ...
                            {
                                cellphone3Dstructure._fU636 = l_U2161;
                                cellphone3Dstructure._fU632 = 2;
                                StrCopy( ref cellphone3Dstructure._fU584, 8, l_U2137, 16);
                                sub_3643( 1064 );
                            };;;
                            break;
                            case 3:
                            cellphone3Dstructure._fU636 = 33;
                            cellphone3Dstructure._fU632 = 4;
                            sub_3643( 1062 );
                            break;
                            case 1:
                            ...
                            if (GET_NUMBER_OF_PLAYERS() > 2)
                            {
                                ...
                                {
                                    ProtectedSet(cellphone3Dstructure._fU668, l_U2161);
                                }
                                else
                                {
                        ...
                        switch (l_U3._fU60)
                        {
                            ...
                            default:
                            ProtectedSet(cellphone3Dstructure._fU660, l_U3._fU60);
                            sub_3643( 1085 );
                            break;
                        }
                        break;
                ...
                if (cellphone3Dstructure._fU0 == 1097)
                {
                    if (TIMERA() >= 1500)
                    {
                        sub_3643( 1098 );
                ...
                if (sub_27549( ref l_U2079, 2 ))
                {
                    sub_6945( "\n The net state is ", cellphone3Dstructure._fU632 );
                    switch (sub_28583( cellphone3Dstructure._fU524 ))
                    {
                        case 7:
                        STOP_MOBILE_PHONE_RINGING();
...
{
    iParam0->_fU0 = uParam1;
    sub_2294( uParam1, ref cellphone3Dstructure._fU8 );
    sub_2924();
    return;
}
...
void sub_2294(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        ...
        {
            sub_2411( uParam1, 11.50000000, -60.00000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, cellphone3Dstructure._fU8._fU24 );
        }
        else
        {
            sub_2411( uParam1, 5.00000000, -60.00000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, cellphone3Dstructure._fU8._fU24 );
        }
        break;
        case 2:
        if ((cellphone3Dstructure._fU496) AND (GET_IS_WIDESCREEN()))
        {
            sub_2411( uParam1, 11.50000000, -11.00000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, cellphone3Dstructure._fU8._fU24 );
        }
        else
        {
            sub_2411( uParam1, 5.00000000, -7.00000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, cellphone3Dstructure._fU8._fU24 );
        }
        break;
        case 3:
        if ((cellphone3Dstructure._fU496) AND (GET_IS_WIDESCREEN()))
        {
            sub_2411( uParam1, 11.50000000, 4.50000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, cellphone3Dstructure._fU8._fU24 );
        }
        else
        {
            sub_2411( uParam1, 5.00000000, 8.50000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, cellphone3Dstructure._fU8._fU24 );
        }
        break;
        case 4:
        if ((cellphone3Dstructure._fU496) AND (GET_IS_WIDESCREEN()))
        {
            sub_2411( uParam1, 11.50000000, -5.25000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, cellphone3Dstructure._fU8._fU24 );
        }
        else
        {
            sub_2411( uParam1, 5.00000000, -0.75000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, cellphone3Dstructure._fU8._fU24 );
        }
        break;
    }
    return;
...
int sub_4381()
{
    if ((cellphone3Dstructure._fU0 == 1010) || (cellphone3Dstructure._fU0 == 1001))
    {
        return 1;
    }
    return 0;
...
void sub_5305()
{
    ...
    switch (cellphone3Dstructure._fU0)
    {
        ...
        if (l_U2110 != GET_NUMBER_OF_PLAYERS())
        {
            ...
            if ((l_U2110 <= 1) AND (NOT cellphone3Dstructure._fU1488))
            {
                l_U2109 = -1;
                cellphone3Dstructure._fU0 = 1061;
            }
            else
            {
                l_U2109 = -1;
                ...
                {
                    if (cellphone3Dstructure._fU0 == 1060)
                    {
                ...
                cellphone3Dstructure._fU0 = 1060;
            }
            l_U2029 = 1;
        }
        break;
    ...
    switch (cellphone3Dstructure._fU0)
    {
        case 1064:
        case 1062:
        if (l_U2164 != cellphone3Dstructure._fU632)
        {
            if ((l_U2164 != 2) AND (cellphone3Dstructure._fU632 != 3))
            {
                l_U2029 = 1;
            }
            l_U2164 = cellphone3Dstructure._fU632;
        }
        break;
    }
    if ((l_U2029) || (cellphone3Dstructure._fU92))
    {
        sub_8685();
    }
        ...
        switch (cellphone3Dstructure._fU632)
        {
            ...
            if (TIMERB() > 4000)
            {
                if (l_U2163)
                {
                    ...
                    sub_9011( ref l_U3, ref l_U228, 0, ref cellphone3Dstructure._fU584, "", 1, 1, 0, 0, 0 );
...
void sub_5771(int iParam0, unknown uParam1, int iParam2)
{
    ...
    if ((cellphone3Dstructure._fU496) AND (cellphone3Dstructure._fU500))
    {
        fVar8 = 1.55000000;
        fVar9 = 1.40000000;
    }
...
void sub_8685()
{
    ...
    switch (cellphone3Dstructure._fU0)
    {
        ...
        if ((NOT NETWORK_IS_GAME_RANKED()) AND (cellphone3Dstructure._fU664))
        {
        ...
        else
        {
            ...
            if (cellphone3Dstructure._fU1488)
            {
        ...
        case 1062:
        sub_8927( ref l_U3, 1, l_U2109, 0 );
        if (cellphone3Dstructure._fU632 != 9)
        {
        ...
        if (cellphone3Dstructure._fU636 != l_U2161)
        {
            if (NETWORK_IS_PLAYER_MUTED_BY_ME( l_U2161 ))
            {
        ...
        if (NOT NETWORK_IS_GAME_RANKED())
        {
            if (GET_NUMBER_OF_PLAYERS() > 2)
            {
                if (ProtectedGet(cellphone3Dstructure._fU668) == l_U2161)
                {
        ...
        switch (cellphone3Dstructure._fU632)
        {
            case 9:
            STOP_MOBILE_PHONE_RINGING();
            NETWORK_SET_TALKER_FOCUS( cellphone3Dstructure._fU636 );
            sub_8927( ref l_U3, 1, 0, 1 );
            sub_9011( ref l_U3, ref l_U228, 0, ref cellphone3Dstructure._fU584, "", 1, 1, 0, 0, 0 );
            sub_9622( ref l_U3, ref l_U228, ref l_U41, 1, 1, 0 );
            break;
            ...
            sub_9011( ref l_U3, ref l_U228, 1, ref cellphone3Dstructure._fU584, "", 1, 1, 0, 0, 0 );
            sub_9622( ref l_U3, ref l_U228, ref l_U41, 1, 1, 0 );
            break;
            case 4:
            STOP_MOBILE_PHONE_RINGING();
        ...
        if (NOT (COMPARE_STRING( ref cellphone3Dstructure._fU640, "" )))
        {
        ...
        break;
        case 1077:
        l_U2117[0] = {cellphone3Dstructure._fU640};
        StrCopy( ref l_U2117[1], "", 16 );
        StrCopy( ref l_U2117[2], "", 16 );
        sub_11633( ref l_U2044._fU0[0], ref l_U2117, 0, ref l_U2116, ref l_U2114, ref l_U2112, ref l_U2113, ref l_U3._fU44, ref l_U3._fU60, ref l_U3._fU56, ref l_U3._fU52 );
        break;
        ...
        for ( I = 0; I <= (cellphone3Dstructure._fU676 - 1); I++ )
        {
            if (NOT (COMPARE_STRING( ref cellphone3Dstructure._fU676[I], "" )))
            {
                sub_9011( ref l_U3, ref l_U228, 1, ref cellphone3Dstructure._fU676[I], ref cellphone3Dstructure._fU1080[I], 1, 0, 0, 0, 0 );
            }
            else
            {
                I = cellphone3Dstructure._fU676;
            }
        }
        sub_9622( ref l_U3, ref l_U228, ref l_U41, 1, 1, 0 );
        break;
        ...
        case 1080:
        cellphone3Dstructure._fU0 = 1080;
        ...
        break;
        case 1091:
        l_U2168 = cellphone3Dstructure._fU568;
        ...
        ConcatString(ref l_U2117[1], ProtectedGet(cellphone3Dstructure._fU660), 16);
        StrCopy( ref l_U2117[2], "", 16 );
        sub_11633( ref l_U2044._fU0[0], ref l_U2117, 0, ref l_U2116, ref l_U2114, ref l_U2112, ref l_U2113, ref l_U3._fU44, ref l_U3._fU60, ref l_U3._fU56, ref l_U3._fU52 );
        break;
        case 1090:
...
void sub_9622(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    ...
    sub_9679( ref cellphone3Dstructure._fU492, 100, 500 );
    if (cellphone3Dstructure._fU500)
    {
        iVar9 = 6;
    }
...
void sub_20156(int iParam0, unknown uParam1, unknown uParam2, int iParam3)
{
    ...
    {
        sub_11823( 0, 0, ref iParam0->_fU0[1], uParam2, ref iParam0->_fU100->_fU0, ref iParam0->_fU100->_fU4, 0.00000000, 1.00000000, 0, 0, 0, 0, cellphone3Dstructure._fU564, 1 );
    }
    if (iParam0->_fU128 != 1678728908)
    {
        sub_11823( 0, 0, ref iParam0->_fU0[2], uParam1, (ref iParam0->_fU108->_fU0) - uVar8, ref iParam0->_fU108->_fU4, 0.00000000, ref iParam0->_fU108->_fU0, 0, 0, 0, 0, cellphone3Dstructure._fU564, 1 );
    }
    return;
}
...
void sub_22896(int iParam0, unknown uParam1, int iParam2, int iParam3, boolean bParam4)
{
    ...
    iParam0->_fU112++;
    iParam0->_fU116++;
    if ((iParam0->_fU64) AND (cellphone3Dstructure._fU40 == 2))
    {
...
void sub_23924(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, float fParam4, unknown uParam5, unknown uParam6, int iParam7, unknown uParam8, unknown uParam9, boolean bParam10, boolean bParam11, unknown uParam12, unknown uParam13, unknown uParam14)
{
    ...
    if (bParam11)
    {
        ...
        else if ((cellphone3Dstructure._fU40 == 2) || (uParam12))
        {
...
void sub_27829(int iParam0, boolean bParam1)
{
    ...
    if (iParam0->_fU0 > 5)
    {
        sub_27902( ref cellphone3Dstructure._fU8._fU0, (ref ref iParam0->_fU4->_fU0->_fU0) * uVar4, (ref ref iParam0->_fU4->_fU0->_fU4) * uVar4, (ref ref iParam0->_fU4->_fU0->_fU8) * uVar4 );
        sub_27902( ref cellphone3Dstructure._fU8._fU12, (ref ref iParam0->_fU4->_fU12->_fU0) * uVar4, (ref ref iParam0->_fU4->_fU12->_fU4) * uVar4, (ref ref iParam0->_fU4->_fU12->_fU8) * uVar4 );
