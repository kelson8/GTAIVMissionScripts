...
void sub_289()
{
    ...
    l_U181[0] = {946.48760000, 1829.47100000, 19.86310000};
...
void sub_791()
{
    ...
    if ((iVar5 == 0) AND ((iVar4 == 0) AND ((iVar3 == 0) AND ((iVar2 == 0) AND ((NOT (IS_CHAR_DEAD( sub_617() ))) AND ((g_U42894 == 0) AND (g_U12379 == 0)))))))
    {
        if (l_U138 == 0)
        {
        ...
        if (l_U138 == 1)
        {
            if ((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) AND ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (g_U42900 == 0)))
            {
            ...
            if (DOES_BLIP_EXIST( l_U158 ))
            {
                ...
                {
                    if ((l_U133 == 0) AND (IS_WANTED_LEVEL_GREATER( sub_671(), 0 )))
                    {
...
void sub_3967()
{
    if ((g_U15811[58] == 1) AND (g_U42919 >= 50))
    {
        if (l_U143 == 0)
        {
    ...
    if ((g_U15811[60] == 1) AND (g_U42919 >= 40))
    {
        if (l_U144 == 0)
        {
    ...
    if ((g_U15811[64] == 1) AND (g_U42919 >= 30))
    {
        if (l_U145 == 0)
        {
    ...
    if ((g_U15811[62] == 1) AND (g_U42919 >= 20))
    {
        if (l_U146 == 0)
        {
    ...
    if ((g_U15811[57] == 1) AND (g_U42919 >= 10))
    {
        if (l_U147 == 0)
        {
        ...
        if (IS_PLAYER_PLAYING( sub_671() ))
        {
            if (NOT (IS_CHAR_DEAD( sub_617() )))
            {
                if (NOT (IS_THREAD_ACTIVE( g_U818 )))
                {
                    ...
                    {
                        if ((NOT IS_AUTO_SAVE_IN_PROGRESS()) AND (NOT g_U10953._fU0))
                        {
                            if (l_U143 == 1)
                            {
                                if (g_U42902[4] == 0)
...
void sub_8003()
{
    ...
    else if ((iVar10 < 51) AND (iVar10 >= 26))
    {
        StrCopy( ref cVar2, "DrugWarsPickup", 32 );
    }
    else if ((iVar10 < 76) AND (iVar10 >= 51))
    {
