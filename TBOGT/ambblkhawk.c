...
{
    if ((sub_353( uParam0, 0, 0 )) || ((sub_353( uParam0, 2, 0 )) || (sub_353( uParam0, 1, 0 ))))
    {
        return 1;
    }
    return 0;
...
void sub_1425()
{
    ...
    l_U15[13] = {-1672.09000000, -724.36580000, 7.64110000};
...
void sub_1895()
{
    switch (l_U2)
    {
        ...
        l_U3._fU16 = {228.21750000, 1598.52800000, 76.52279000};
        l_U3._fU28 = {329.00000000, 1389.75000000, 50.00000000};
        break;
        case 3:
        l_U3._fU0 = {602.10470000, -624.15300000, 99.90451000};
        ...
        l_U3._fU16 = {1538.44700000, -74.45150000, 58.73450000};
        ...
        break;
        case 11:
        l_U3._fU0 = {602.99080000, -1597.35000000, 49.10060000};
        ...
        l_U3._fU16 = {-1695.49800000, 1202.62200000, 60.18240000};
...
void sub_3529()
{
    if ((NOT (HAS_MODEL_LOADED( sub_1283() ))) || (NOT (HAS_MODEL_LOADED( l_U72 ))))
    {
        REQUEST_MODEL( l_U72 );
        REQUEST_MODEL( l_U73 );
    }
