...
void sub_4147(unknown uParam0)
{
    ...
    iVar7 = 0;
    if ((NOT l_U328._fU88) AND ((NOT (COMPARE_STRING( ref l_U328._fU48, l_U327 ))) AND ((l_U272 == 2) AND (l_U328._fU80 == 1))))
    {
        iVar7 = 1;
    }
    bVar8 = false;
    if (l_U328._fU100)
    {
        ...
        if ((NOT l_U328._fU92) AND ((NOT (COMPARE_STRING( ref l_U328._fU64, l_U327 ))) AND ((bVar9) AND ((l_U272 == 2) AND (l_U328._fU80 == 1)))))
        {
            iVar7 = 1;
            bVar8 = true;
        }
...
void sub_7488()
{
    ...
    if ((LOCATE_CHAR_ANY_MEANS_CAR_3D( sub_2560(), l_U360, fVar2, fVar2, 30.00000000, 0 )) || (IS_CHAR_IN_CAR( sub_2560(), l_U360 )))
    {
        sub_7621();
        return;
    }
...
int sub_11193()
{
    ...
    fVar3 = 0.00000000;
    GET_CAR_SPEED( uVar2, ref fVar3 );
    if ((sub_11268( 1, 1 )) AND (fVar3 < 0.01000000))
    {
        if (NOT l_U282)
        {
...
int sub_11631()
{
    ...
    GET_GAME_TIMER( ref iVar2 );
    bVar3 = false;
    if ((IS_PLAYER_PRESSING_HORN( sub_3803() )) AND ((sub_11268( 1, 1 )) AND (IS_CHAR_IN_ANY_CAR( sub_2560() ))))
    {
        if (l_U282)
        {
            return 0;
...
int sub_12237(unknown uParam0, unknown uParam1)
{
    ...
    if (NOT l_U278)
    {
        ...
        if (IS_CHAR_SITTING_IN_ANY_CAR( sub_2560() ))
        {
            ...
            if ((NOT (IS_VEH_DRIVEABLE( uVar5 ))) || ((l_U284) || (iVar6 < iVar7)))
            {
    ...
    iVar9 = 0;
    bVar10 = false;
    if ((NOT l_U285) AND (IS_CHAR_IN_ANY_CAR( sub_2560() )))
    {
        ...
        if ((NOT bVar10) || (NOT (IS_CHAR_IN_CAR( (uParam0^), uVar5 ))))
        {
            if (NOT (l_U320 == 0))
            {
                ...
                if ((NOT (IS_VEH_DRIVEABLE( uVar5 ))) || (l_U320 < iVar11))
                {
                    SET_PLAYER_CONTROL( sub_3803(), 1 );
                    HINT_CAM( -1.00000000, -1.00000000, -1.00000000, 0, 0, 0, 0 );
...
int sub_14692(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, boolean bParam5, unknown uParam6, int iParam7, int iParam8)
{
    ...
    if (l_U396 == 2)
    {
        ...
        if (LOCATE_CHAR_ANY_MEANS_3D( sub_2560(), uParam2._fU0, uParam2._fU4, fVar13, 2.50000000, 2.50000000, 2.50000000, 1 ))
        {
            if (bVar11)
            {
                if ((sub_17065( iParam8 )) AND (sub_17065( iParam1 )))
                {
                    l_U396++;
                }
            }
    ...
    if (l_U396 == 5)
    {
        if ((NOT (IS_CHAR_DEAD( iParam1 ))) AND (NOT (IS_CHAR_DEAD( sub_2560() ))))
        {
            if (bVar14)
            {
    ...
    if (l_U396 == 7)
    {
        ...
        else if ((IS_CHAR_DEAD( iParam1 )) || (IS_CHAR_DEAD( sub_2560() )))
        {
            l_U396++;
        }
        else
    ...
    if (l_U396 == 12)
    {
        ...
        if ((TIMERA() > 7000) || (sub_23694( iParam1, l_U434, iParam8, l_U437 )))
        {
            l_U396++;
        }
    }
...
int sub_18833()
{
    ...
    if (l_U380 == 1)
    {
        ...
        if ((l_U370 < iVar2) || (fVar4 < 0.04000000))
        {
            SET_PLAYER_CONTROL( sub_3803(), 1 );
            l_U380 = 0;
            return 1;
...
int sub_26587()
{
    ...
    for ( I = 0; I <= (g_U575 - 1); I++ )
    {
        if ((g_U575[I]._fU20) AND ((sub_12935( 1, g_U575[I] )) != 0))
        {
            sub_13186( I );
            return 1;
        }
...
void sub_32093(unknown uParam0)
{
    ...
    if (l_U417._fU12)
    {
        if (g_U20825[l_U319]._fU900._fU40 >= 0)
        {
            ...
            if (NOT l_U417._fU24)
            {
                if (((sub_32561( l_U374 )) > 5) || (sub_40056( ref l_U374 )))
                {
                    bVar5 = true;
                }
            }
...
int sub_32283()
{
    if ((IS_CHAR_INJURED( l_U383 )) || (IS_CHAR_INJURED( l_U382 )))
    {
        return 1;
    }
    return 0;
...
int sub_33127()
{
    if ((IS_CHAR_SHOOTING( l_U383 )) || (IS_CHAR_SHOOTING( l_U382 )))
    {
        return 1;
    }
    return 0;
...
int sub_33187()
{
    if ((IS_CHAR_IN_MELEE_COMBAT( l_U383 )) || (IS_CHAR_IN_MELEE_COMBAT( l_U382 )))
    {
        return 1;
    }
    return 0;
...
int sub_33336()
{
    ...
    if ((l_U417._fU24) || (sub_33345()))
    {
        return 0;
    }
    if ((l_U395 == 1) || (l_U395 == 0))
    {
        return 0;
    }
    if (NOT l_U417._fU8)
    {
        if ((NOT (IS_CHAR_DEAD( l_U383 ))) AND ((NOT (IS_CHAR_DEAD( l_U382 ))) AND (NOT (IS_CHAR_DEAD( sub_2560() )))))
        {
            if (IS_CHAR_IN_ANY_CAR( sub_2560() ))
            {
                STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_2560(), ref uVar2 );
                if ((IS_CHAR_IN_CAR( l_U383, uVar2 )) AND (IS_CHAR_IN_CAR( l_U382, uVar2 )))
                {
                    return 1;
                }
            }
...
int sub_33345()
{
    if ((l_U417._fU48) || ((l_U417._fU44) || ((l_U417._fU40) || ((l_U417._fU36) || (l_U417._fU32)))))
    {
        return 1;
    }
    return 0;
...
int sub_33864(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((uParam2) AND (NOT g_U20825[uParam0]._fU900._fU28))
    {
        ...
        for ( I = 0; I < iVar6; I++ )
        {
            if ((NOT (sub_34265( uParam0, I ))) AND (sub_34025( uParam0, I )))
            {
                sub_34189( uParam0, I );
            }
        }
...
void sub_33979()
{
    ...
    for ( I = 0; I < iVar2; I++ )
    {
        if ((sub_34025( 7, I )) || (sub_34025( 3, I )))
        {
            sub_34108( 3, I );
            sub_34108( 7, I );
        }
        ...
        if ((sub_34265( 7, I )) || (sub_34265( 3, I )))
        {
            sub_34348( 3, I );
            sub_34348( 7, I );
        }
...
int sub_38930()
{
    ...
    if (l_U417._fU24)
    {
        if (NOT sub_33345())
        {
            ...
            if ((iVar2 > l_U417._fU28) AND (NOT (l_U417._fU28 == 0)))
            {
                l_U417._fU28 = 0;
                if (l_U417._fU8)
                {
