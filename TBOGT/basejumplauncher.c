void main()
{
    ...
    while (true)
    {
        ...
        switch (l_U471)
        {
            ...
            break;
            case 1:
            if ((NOT g_U10953._fU4) AND ((NOT IS_AUTO_SAVE_IN_PROGRESS()) AND (NOT g_U12379)))
            {
                if (l_U521 > 1000)
                {
                    if (g_U43002 == 0)
            ...
            if ((g_U15811[29] == 1) AND (g_U43003 == 0))
            {
                if (l_U522 > 500)
                {
                    if ((NOT g_U12379) AND ((NOT g_U10953._fU4) AND ((NOT IS_AUTO_SAVE_IN_PROGRESS()) AND (NOT IS_HELP_MESSAGE_BEING_DISPLAYED()))))
                    {
...
void sub_466(int iParam0, unknown uParam1)
{
    switch ((uParam1^))
    {
        ...
        iParam0->_fU68 = {41.23338000, -0.00000000, -13.19963000};
        ...
        iParam0->_fU28 = {-240.81750000, 230.51020000, 229.71280000};
        iParam0->_fU40 = {-22.57453000, 0.00000000, -71.68533000};
        iParam0->_fU52 = 28.00000000;
        iParam0->_fU56 = {-240.81750000, 230.51020000, 229.71200000};
        ...
        iParam0->_fU28 = {-207.94270000, 317.87870000, 15.61697000};
        ...
        iParam0->_fU120 = {941.91240000, -873.17710000, 325.50110000};
        iParam0->_fU132 = {1107.11100000, -810.20810000, 170.80970000};
        iParam0->_fU144 = {1230.65200000, -739.80860000, 53.53184000};
        break;
        case 9:
        ...
        iParam0->_fU56 = {1316.75900000, 604.85810000, 172.52500000};
        ...
        iParam0->_fU12 = {1790.60400000, 323.10450000, 800.05570000};
        ...
        iParam0->_fU56 = {1776.19600000, 327.73360000, 812.93810000};
        ...
        iParam0->_fU12 = {-2159.97100000, 165.95730000, 650.86150000};
        iParam0->_fU24 = 350.00000000;
        iParam0->_fU28 = {-2164.35100000, 180.96880000, 661.07310000};
        iParam0->_fU40 = {-65.99050000, 0.00000000, -103.29740000};
        iParam0->_fU52 = 45.00000000;
        iParam0->_fU56 = {-2167.59300000, 158.68140000, 659.05060000};
        iParam0->_fU68 = {-47.65579000, 0.00000100, -129.76800000};
        iParam0->_fU80 = 45.00000000;
        ...
        iParam0->_fU144 = {-1652.65200000, -6.80859500, 33.53184000};
        break;
        case 13:
        iParam0->_fU0 = {-1191.15000000, 1692.54500000, 35.42050000};
        iParam0->_fU12 = {-765.97090000, 1580.95700000, 650.86150000};
        iParam0->_fU24 = 270.00000000;
        ...
        iParam0->_fU80 = 45.00000000;
        iParam0->_fU84 = {-750.36930000, 1424.89900000, 2.30463000};
        iParam0->_fU96 = "HELI_ALDERNEY_MANSION";
        iParam0->_fU100 = 13;
        iParam0->_fU104 = 0;
        iParam0->_fU108 = {-766.51760000, 1439.19200000, 486.78760000};
        ...
        iParam0->_fU28 = {-741.33770000, -1705.32400000, 816.50830000};
        ...
        iParam0->_fU80 = 45.00000000;
        iParam0->_fU84 = {-608.11000000, -770.03990000, 20.02000000};
...
int sub_5451()
{
    ...
    fVar3 = 1.60000000;
    if ((NOT sub_5473()) AND (NOT g_U12379))
    {
...
int sub_7574(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_5938() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_5938() )))
            {
                if (((g_U9200) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_5938() )))))
                {
                    if (NOT sub_5473())
                    {
...
void sub_8463(int iParam0, string sParam1)
{
    ...
    if (NOT (IS_STRING_NULL( sParam1 )))
    {
        ...
        {
            if ((l_U284) AND (g_U10534 == iParam0))
            {
