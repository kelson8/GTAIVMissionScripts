void main()
{
    ...
    while (true)
    {
        ...
        if ((NOT g_U95._fU580) AND (NETWORK_HAVE_SUMMONS()))
        {
            if (g_U560 == 9)
            {
                ...
                if (IS_PLAYER_PLAYING( sub_2787() ))
                {
                    switch (g_U560)
                    {
                        ...
                        if (IS_PLAYER_CONTROL_ON( sub_2787() ))
                        {
                            if (sub_2867())
                            {
                                if ((NOT (IS_BUTTON_PRESSED( 0, 4 ))) AND ((sub_3745( 0 )) == 0))
                                {
                                    g_U95._fU376 = 0;
                                    g_U95._fU380 = 1;
                                    if ((g_U828) || (g_U824))
                ...
                if (IS_PLAYER_PLAYING( sub_2787() ))
                {
                    switch (g_U560)
                    {
                        ...
                        if (IS_PLAYER_CONTROL_ON( sub_2787() ))
                        {
                            ...
                            {
                                if ((g_U95._fU376) || (sub_2867()))
                                {
                                    sub_7826( 1 );
                                }
                            }
                            else if ((NOT (IS_CONTROL_PRESSED( 0, 23 ))) AND ((sub_3745( 0 )) == 0))
                            {
                                if (sub_2867())
                                {
                                    g_U95._fU376 = 0;
                        ...
                        else if ((g_U95._fU376) AND ((g_U95._fU52) || (g_U95._fU48)))
                        {
                            sub_7826( 1 );
                        }
                        break;
                    ...
                    switch (l_U6)
                    {
                        ...
                        if (g_U95._fU0 == 1005)
                        {
                            if ((sub_14110( 12, 1, 0 )) || (sub_14007( "9485550100" )))
                            {
...
int sub_12682()
{
    ...
    for ( I = 0; I <= (g_U575 - 1); I++ )
    {
        if ((g_U575[I]._fU20) AND ((sub_1332( 1, g_U575[I] )) != 0))
        {
            sub_12746( I );
            return 1;
        }
...
int sub_14007(unknown uParam0)
{
    ...
    if ((g_U95._fU508 >= 4) AND (g_U95._fU0 == 1005))
    {
        if (g_U95._fU60 == 36)
        {
...
int sub_14546(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3277() ))) AND (IS_CHAR_IN_ANY_CAR( sub_3277() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_15061()))
        {
            return 0;
        }
        g_U95._fU60 = uParam0;
