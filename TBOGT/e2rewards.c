void main()
{
    ...
    while (true)
    {
        ...
        if (IS_PLAYER_PLAYING( sub_358() ))
        {
            ...
            sub_2563();
            sub_4539();
            if ((NOT l_U21) AND ((NOT l_U20) AND (NOT l_U19)))
            {
                iVar2 = 0;
                if (l_U26)
                {
        ...
        if (NOT l_U54)
        {
            if ((g_U15811[42]) AND (g_U15811[68]))
            {
...
void sub_1784()
{
    ...
    if ((NOT g_U15811[42]) || (g_U15811[71]))
    {
        if (l_U20)
        {
            sub_1828();
...
void sub_4750()
{
    ...
    if ((l_U40) || ((NOT g_U15811[42]) || (g_U15811[71])))
    {
        if (DOES_BLIP_EXIST( l_U44 ))
        {
            REMOVE_BLIP_AND_CLEAR_INDEX( ref l_U44 );
...
int sub_6371()
{
    ...
    for ( I = 0; I <= (g_U575 - 1); I++ )
    {
        if ((g_U575[I]._fU20) AND ((sub_6409( 1, g_U575[I] )) != 0))
        {
            sub_6672( I );
            return 1;
        }
