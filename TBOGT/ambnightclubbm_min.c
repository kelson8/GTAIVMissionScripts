...
void sub_8736()
{
        ...
        else if (NOT g_U15811[35])
        {
            if ((NOT g_U30153) AND (NOT g_U12379))
            {
                if (NOT (l_U499 == 2))
                {
                    ...
                    {
                        if ((g_U30110[l_U499]) || (((NOT (sub_3889( sub_3604(), l_U499, 0 ))) AND (l_U471)) || (NOT (sub_9101( sub_3604(), l_U499, 1094713344 )))))
                        {
    ...
    {
        GET_TIME_OF_DAY( ref iVar7, ref uVar8 );
        if (NOT ((l_U499 == 0) AND (g_U30181)))
        {
            if (NOT g_U15811[35])
            {
                if ((sub_3889( sub_3604(), l_U499, 0 )) || ((g_U30153) || (((iVar7 < 6) || (iVar7 >= 21)) || ((IS_THREAD_ACTIVE( g_U30226[l_U499] )) || (g_U12379)))))
                {
    ...
    if ((NOT ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "rocco1" )) > 0)) AND ((IS_PLAYER_PLAYING( sub_2048() )) AND (sub_9804( sub_3604(), l_U499 ))))
    {
        sub_10784();
        if (g_U30154[l_U499])
        {
        ...
        switch (l_U498)
        {
            ...
            {
                if ((NOT g_U30093[l_U499]) AND (sub_19335( sub_3604(), l_U499 )))
                {
            ...
            break;
            case 1:
            if ((NOT (sub_19335( sub_3604(), l_U499 ))) || (NOT (sub_3889( sub_3604(), l_U499, 0 ))))
            {
                sub_1798();
                l_U498 = 0;
            }
        ...
        if ((sub_20120()) || (NOT g_U30149[l_U499]))
        {
            if ((sub_20120()) || (NOT g_U30120[l_U499]))
            {
                if (g_U30128[l_U499])
                {
                ...
                if (g_U30114[l_U499])
                {
                    ...
                    if ((sub_3889( sub_3604(), l_U499, 0 )) || (IS_SCREEN_FADED_OUT()))
                    {
                ...
                if (g_U30109)
                {
                    for ( I = 0; I < l_U380; I++ )
                    {
                        if ((l_U380[I]._fU4 == 12) || (l_U380[I]._fU4 == 10))
                        {
                            l_U380[I]._fU16 = 0;
                        }
                    }
        ...
        else if ((l_U464) || (IS_THREAD_ACTIVE( g_U30226[l_U499] )))
        {
            sub_65074();
            if (g_U30110[l_U499])
            {
...
int sub_9804(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_PLAYER_PLAYING( sub_2048() ))
    {
        ...
        {
            if (((sub_10078( sub_3604() )) == 3) || ((sub_10078( sub_3604() )) == 5))
            {
                bVar4 = true;
            }
        }
...
void sub_15635()
{
    ...
    if (IS_PLAYER_PLAYING( sub_2048() ))
    {
        if ((NOT g_U30179) AND (NOT g_U30153))
        {
            if (NOT l_U454)
            {
                if ((NOT l_U456) AND (NOT g_U30093[l_U499]))
                {
            ...
            else if ((g_U30093[l_U499]) || (NOT (sub_3917( sub_3604(), l_U499 ))))
            {
                SET_CHAR_MAX_MOVE_BLEND_RATIO( sub_3604(), 3.00000000 );
                l_U454 = 0;
            }
...
void sub_16064()
{
    ...
    if (IS_PLAYER_PLAYING( sub_2048() ))
    {
        if ((NOT g_U30179) AND (NOT g_U30153))
        {
            if (NOT l_U456)
            {
                if ((NOT g_U30153) AND (NOT g_U30093[l_U499]))
                {
                    if (sub_3917( sub_3604(), l_U499 ))
                    {
            ...
            else
            {
                ...
                if ((sub_16364( sub_3604() )) || ((NOT bVar3) || ((g_U30153) || ((g_U30093[l_U499]) || (NOT (sub_3917( sub_3604(), l_U499 )))))))
                {
...
void sub_16930()
{
    ...
    if (NOT g_U30167)
    {
        if (((l_U499 == 0) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "Tony6" )) > 0)) || ((IS_PLAYER_CONTROL_ON( sub_2048() )) AND (HAS_CUTSCENE_FINISHED())))
        {
            if (IS_PLAYER_PLAYING( sub_2048() ))
            {
                if (g_U30153)
                ...
                else if (((l_U499 == 0) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "E2EndCredits" )) > 0)) || ((l_U499 == 0) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "Tony6" )) > 0)))
                {
                    if ((NOT (sub_3889( sub_3604(), l_U499, 0 ))) AND (IS_WANTED_LEVEL_GREATER( sub_2048(), 0 )))
                    {
                        sub_17209( l_U499, 2 );
                    }
                    else
                ...
                else if ((g_U30149[l_U499]) || ((g_U30093[l_U499]) || (IS_WANTED_LEVEL_GREATER( sub_2048(), 0 ))))
                {
                    sub_17209( l_U499, 2 );
                }
                else if (l_U499 == 0)
            ...
            if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS( vVar3.x, vVar3.y, vVar3.z, 1.50000000, iVar2 ))
            {
                switch (g_U30192[l_U499])
                {
                    ...
                    if ((NOT (sub_17664( vVar3, 2.00000000 ))) || (IS_SCREEN_FADED_OUT()))
                    {
                        fVar8 = -1.00000000;
                    }
    ...
    if (NOT l_U453)
    {
        if (IS_PLAYER_PLAYING( sub_2048() ))
        {
            if (g_U30149[l_U499])
            {
                ...
                {
                    if ((NOT g_U12379) AND ((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) AND (NOT sub_18557())))
                    {
                        switch (l_U499)
                        {
                            case 0:
...
int sub_18557()
{
    if ((sub_18624()) || ((sub_18573()) || (IS_MESSAGE_BEING_DISPLAYED())))
    {
        return 1;
    }
    return 0;
...
void sub_23550()
{
    if (NOT l_U452)
    {
        if (IS_PLAYER_PLAYING( sub_2048() ))
        {
            if ((NOT (g_U30192[l_U499] == 1)) AND (g_U30093[l_U499]))
            {
                if (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3604() )))
                {
                    if ((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) AND (NOT sub_18557()))
                    {
                        switch (l_U499)
                        {
                            case 0:
...
void sub_24891()
{
    ...
    if ((NOT g_U30093[l_U499]) AND (IS_PLAYER_PLAYING( sub_2048() )))
    {
...
int sub_25021(unknown uParam0)
{
    ...
    if (NOT (IS_CHAR_INJURED( uParam0 )))
    {
        ...
        if (((VMAG2( uVar12 )) > 0.50000000) AND ((sub_25163( uVar12, uVar15 )) > 0.00000000))
        {
            return 1;
        }
    }
...
void sub_25908()
{
    ...
    if (NOT g_U30101)
    {
        if (NOT l_U436)
        {
            ...
            {
                if ((sub_25976()) || (IS_CHAR_SHOOTING( sub_3604() )))
                {
                    g_U30093[l_U499] = 1;
    ...
    if (NOT g_U30093[l_U499])
    {
        if (IS_PLAYER_PLAYING( sub_2048() ))
        {
            if (((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "Tony6" )) > 0) || (sub_9101( sub_3604(), l_U499, 1094713344 )))
            {
        ...
        if ((uParam0^)[I]._fU0)
        {
            if (NOT (IS_CHAR_INJURED( (uParam0^)[I]._fU24 )))
            {
                if (NOT g_U30153)
                {
                    ...
                    {
                        if ((((uParam0^)[I]._fU4 == 9) || ((uParam0^)[I]._fU4 == 8)) || (l_U499 == 0))
                        {
...
void sub_27629()
{
    ...
    if (sub_3889( sub_3604(), l_U499, 0 ))
    {
        if (sub_27662())
        {
            if ((NOT l_U443) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "dancing" )) == 0))
            {
                if (NOT g_U30093[l_U499])
                {
                ...
                if ((iVar8) AND ((sub_29148( 2, 0 )) AND ((g_U30105) || (bVar7))))
                {
                    l_U558 = "DANC_H01";
                    if ((g_U30105) || ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT l_U437)))
                    {
                        if (NOT (IS_CHAR_INJURED( l_U543 )))
                        {
                            if (l_U523 > 30000)
                        ...
                        if ((g_U30105) || (sub_29632( 2, l_U558, 0 )))
                        {
                            g_U30206 = l_U543;
                            g_U30190 = l_U499;
                            l_U472 = 0;
...
void sub_33288(int iParam0)
{
    if (iParam0->_fU0)
    {
            ...
            else if (NOT l_U436)
            {
                if (iParam0->_fU20 > 0)
                {
                    switch (iParam0->_fU4)
                    {
                        ...
                        case 10:
                        case 12:
                        if (((sub_20120()) || (NOT g_U30103)) AND ((sub_19335( sub_3604(), l_U499 )) || (sub_3889( sub_3604(), l_U499, 1 ))))
                        {
                            iParam0->_fU8 = 1;
                        }
                        break;
                        case 14:
                        if ((NOT g_U30180) AND (NOT l_U475))
                        {
                            if ((NOT l_U458) AND (NOT g_U30102))
                            {
        ...
        if (iParam0->_fU8 == 1)
        {
            if ((sub_33909( iParam0 )) AND (NOT l_U436))
            {
                switch (iParam0->_fU4)
                {
                    case 1:
                    ...
                    {
                        if (((sub_20120()) || (NOT g_U30103)) AND ((sub_19335( sub_3604(), l_U499 )) AND (sub_34064( iParam0 ))))
                        {
                            sub_34883( iParam0 );
                        }
                    }
                    ...
                    if (sub_34064( iParam0 ))
                    {
                        if ((sub_33736( (iParam0^) )) || (sub_42421( sub_3604(), l_U499 )))
                        {
                            if ((sub_33736( (iParam0^) )) || (NOT g_U30102))
                            {
                                sub_34883( iParam0 );
                            }
                        }
                    ...
                    break;
                    case 6:
                    if ((sub_3917( sub_3604(), l_U499 )) || (sub_42421( sub_3604(), l_U499 )))
                    {
                        if (sub_34064( iParam0 ))
                        {
                            sub_34883( iParam0 );
                    ...
                    if (sub_3889( sub_3604(), l_U499, 1 ))
                    {
                        if ((NOT g_U30103) AND ((sub_19335( sub_3604(), l_U499 )) AND (sub_34064( iParam0 ))))
                        {
                            sub_34883( iParam0 );
                        }
                    }
        ...
        if (iParam0->_fU8 == 2)
        {
            ...
            else
            {
                switch (iParam0->_fU4)
                {
                    ...
                    case 10:
                    case 12:
                    if (((sub_20120()) || (NOT g_U30103)) AND (sub_19335( sub_3604(), l_U499 )))
                    {
                        sub_43039( iParam0 );
                    }
                    else
                    ...
                    break;
                    case 4:
                    if ((NOT g_U30103) AND (sub_19335( sub_3604(), l_U499 )))
                    {
                        sub_43039( iParam0 );
                    }
                    else
                    ...
                    else if ((NOT g_U30102) AND (sub_42421( sub_3604(), l_U499 )))
                    {
                        sub_43039( iParam0 );
                    }
                    else
    ...
    else if (NOT g_U30097[l_U499])
    {
        if (NOT (iParam0->_fU4 == 0))
        {
            ...
            else if ((NOT (iParam0->_fU4 == 9)) AND ((NOT (iParam0->_fU4 == 13)) AND ((NOT (iParam0->_fU4 == 2)) AND (NOT (sub_3889( sub_3604(), l_U499, 0 ))))))
            {
                iParam0->_fU0 = 1;
            }
...
{
    if ((iParam0->_fU4 == 7) || ((iParam0->_fU4 == 6) || ((iParam0->_fU4 == 13) || ((iParam0->_fU4 == 2) || (g_U30162[l_U499])))))
    {
...
void sub_34883(int iParam0)
{
    ...
    if (iParam0->_fU0)
    {
        if ((l_U463) || (sub_34904( iParam0 )))
        {
            if ((l_U463) || ((g_U30114[l_U499]) || (sub_34975( iParam0 ))))
            {
                if ((l_U463) || (NOT (sub_35806( iParam0->_fU28, g_U30251, g_U30254 ))))
                {
                    if ((l_U463) || (sub_35906( iParam0 )))
                    {
                        if (HAS_MODEL_LOADED( iParam0->_fU48 ))
                        {
                            if (NOT (DOES_CHAR_EXIST( iParam0->_fU24 )))
                            {
                                if ((l_U463) || ((sub_3889( sub_3604(), l_U499, 0 )) || (NOT g_U30093[l_U499])))
                                {
...
int sub_34975(int iParam0)
{
    ...
    if ((IS_PLAYER_CONTROL_ON( sub_2048() )) AND ((NOT g_U30114[l_U499]) AND (NOT IS_SCREEN_FADED_OUT())))
    {
...
int sub_36051(unknown uParam0)
{
    ...
    switch (uParam0)
    {
        ...
        break;
        case 15:
        if (((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "Tony6" )) > 0) AND (l_U499 == 0))
        {
            return 1;
        }
        else
...
string sub_37641(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((sub_35806( uParam0, -473.07430000, 139.93400000, 5.00000000, -467.99930000, 142.23400000, 11.86410000 )) || (sub_35806( uParam0, -471.45100000, 139.90120000, 5.00000000, -468.07600000, 156.20120000, 11.86410000 )))
    {
    ...
    if ((sub_35806( uParam0, -397.59980000, 431.71720000, 4.00000000, -383.42480000, 441.21720000, 12.05160000 )) || (sub_35806( uParam0, -398.37480000, 417.79220000, 4.00000000, -377.19980000, 431.96720000, 12.05160000 )))
    {
        return "gaydanceflr";
    }
    ...
    if (DOES_CHAR_EXIST( iParam0->_fU24 ))
    {
        if (NOT (IS_CHAR_INJURED( iParam0->_fU24 )))
        {
            if (NOT (sub_2334( iParam0->_fU24 )))
            {
                ...
                if (NOT (iParam0->_fU12 == 99))
                {
                    if ((sub_40955( iParam0->_fU56 )) || (sub_3003( iParam0->_fU56 )))
                    {
                        BLOCK_CHAR_AMBIENT_ANIMS( iParam0->_fU24, 1 );
                    }
                }
                        ...
                        switch (iParam0->_fU4)
                        {
                            ...
                            if (NOT g_U30118)
                            {
                                switch (iParam0->_fU12)
                                {
                                    ...
                                    if (NOT g_U30093[l_U499])
                                    {
                                        ...
                                        if (NOT sub_25473())
                                        {
                                            if ((iParam0->_fU24 == l_U538) || (iParam0->_fU24 == l_U537))
                                            {
                                                CLEAR_CHAR_TASKS( iParam0->_fU24 );
                                                iParam0->_fU20 = 0;
                                                iParam0->_fU12 = 1;
                                    ...
                                    else if ((iParam0->_fU24 == l_U538) || (iParam0->_fU24 == l_U537))
                                    {
                                        GET_SCRIPT_TASK_STATUS( iParam0->_fU24, 91, ref l_U559 );
                                        if (l_U559 == 7)
                                        {
                                    ...
                                    break;
                                    case 2:
                                    if ((sub_3889( sub_3604(), l_U499, 0 )) AND (NOT sub_25473()))
                                    {
                                        GET_SCRIPT_TASK_STATUS( iParam0->_fU24, 29, ref l_U559 );
                                        if (l_U559 == 7)
                                        {
                            ...
                            else
                            {
                                switch (iParam0->_fU12)
                                {
                                    ...
                                    {
                                        GET_SCRIPT_TASK_STATUS( iParam0->_fU24, 29, ref l_U559 );
                                        if ((iParam0->_fU20 > 30000) || (l_U559 == 7))
                                        {
                                            if (NOT (iParam0->_fU16 == -1))
                                            {
                            ...
                            break;
                            default:
                            if ((NOT (LOCATE_CHAR_ANY_MEANS_3D( iParam0->_fU24, ref iParam0->_fU28->_fU0, ref iParam0->_fU28->_fU4, ref iParam0->_fU28->_fU8, 5.00000000, 5.00000000, 5.00000000, 0 ))) || (sub_48777( iParam0 )))
                            {
                                iParam0->_fU12 = 99;
                            }
                            else
                            {
                                switch (iParam0->_fU12)
                                {
                                    ...
                                    else if ((NOT (sub_16536( uVar14 ))) AND (NOT (sub_16536( uVar13 ))))
                                    {
                                    ...
                                    if (sub_16536( sVar15 ))
                                    {
                                        ...
                                        if (l_U559 == 7)
                                        {
                                            ...
                                            if ((NOT (sub_16536( uVar14 ))) AND (NOT (sub_16536( uVar13 ))))
                                            {
                                                if (NOT (IS_CHAR_PLAYING_ANIM( iParam0->_fU24, uVar14, uVar13 )))
                                                {
...
void sub_48923(int iParam0)
{
    ...
    for ( I = 0; I < l_U415; I++ )
    {
        if ((NOT (l_U415[I]._fU20 == iParam0->_fU24)) AND (NOT (I == iParam0->_fU16)))
        {
...
int sub_49246(unknown uParam0)
{
    ...
    {
        if ((sub_16536( sub_43168( l_U415[uParam0]._fU24 ) )) || (sub_16536( l_U396[l_U415[uParam0]._fU24]._fU0 )))
        {
            return 1;
        }
    }
                        ...
                        if (iParam0->_fU20 > 10000)
                        {
                            switch (iParam0->_fU4)
                            {
                                ...
                                if (l_U460)
                                {
                                    ...
                                    {
                                        if ((NOT (IS_AMBIENT_SPEECH_PLAYING( iParam0->_fU24 ))) AND (NOT (IS_AMBIENT_SPEECH_PLAYING( l_U542 ))))
                                        {
                                ...
                                if (DOES_CHAR_EXIST( l_U540 ))
                                {
                                    ...
                                    {
                                        if ((l_U540 == iParam0->_fU24) || (IS_AMBIENT_SPEECH_PLAYING( l_U540 )))
                                        {
                                            bVar3 = false;
                                        }
                                    }
                                ...
                                if (NOT bVar4)
                                {
                                    if (bVar3)
                                    {
                                        if (NOT l_U461)
                                        {
                                            if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3604(), iParam0->_fU24, 2.00000000, 2.00000000, 2.00000000, 0 )) AND ((iParam0->_fU20 > 20000) AND (l_U519 > 6000)))
                                            {
                                                GENERATE_RANDOM_INT_IN_RANGE( 0, 5, ref iVar5 );
                                                if (iVar5 < 2)
                                                {
                                                    if ((l_U499 == 0) || (sub_57302( iParam0->_fU24 )))
                                                    {
                                                ...
                                                else if ((l_U524 > 20000) AND (sub_58145( iParam0->_fU24 )))
                                                {
                                                    l_U540 = iParam0->_fU24;
                                ...
                                else if ((iParam0->_fU20 > 5000) AND (l_U519 > 5000))
                                {
                                ...
                                if (DOES_CHAR_EXIST( l_U541 ))
                                {
                                    ...
                                    {
                                        if ((l_U541 == iParam0->_fU24) || (IS_AMBIENT_SPEECH_PLAYING( l_U541 )))
                                        {
                                            bVar3 = false;
                                        }
                                    }
...
void sub_69144()
{
    ...
    if ((g_U30178) || (l_U436))
    {
        if ((NOT l_U469) AND (NOT (l_U533 == -1)))
        {
    ...
    if (NOT (g_U30197 == -1))
    {
        ...
        else if (((NOT g_U30154[l_U499]) AND (g_U30149[l_U499])) || ((g_U30177) || (NOT (sub_9101( sub_3604(), g_U30197, l_U492 )))))
        {
            if (l_U465)
            {
                if (g_U30177)
    ...
    switch (l_U526)
    {
        ...
        if (fVar2 < l_U491)
        {
            if (g_U30197 == -1)
            {
                if ((g_U30154[l_U499]) || ((NOT ((NOT g_U30154[l_U499]) AND (g_U30149[l_U499]))) AND ((NOT g_U30177) AND (sub_9101( sub_3604(), l_U499, l_U492 )))))
                {
