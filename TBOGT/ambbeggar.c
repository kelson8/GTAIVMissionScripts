    ...
    if (DOES_CHAR_EXIST( l_U113 ))
    {
        if (NOT (IS_CHAR_INJURED( l_U113 )))
        {
            if (NOT (IS_CHAR_IN_ANY_CAR( l_U113 )))
            {
                ...
                {
                    if ((NOT sub_1194()) AND (NOT g_U12379))
                    {
...
void sub_1476()
{
    ...
    if ((NOT (HAS_MODEL_LOADED( l_U117 ))) || (NOT (HAVE_ANIMS_LOADED( l_U141 ))))
    {
        ;
    }
    else
...
void sub_1596()
{
    ...
    {
        case 0:
        if ((NOT (IS_WANTED_LEVEL_GREATER( sub_608(), 0 ))) AND (IS_SCORE_GREATER( sub_608(), 9 )))
        {
            l_U105 = 1;
        }
        else
        ...
        if (NOT g_U9272)
        {
            if ((NOT (IS_WANTED_LEVEL_GREATER( sub_608(), 0 ))) AND (LOCATE_CHAR_ON_FOOT_CHAR_3D( l_U113, sub_1134(), 10.00000000, 10.00000000, 2.00000000, 0 )))
            {
                sub_1900();
            }
        }
...
void sub_1618()
{
    if ((IS_PED_IN_COMBAT( sub_1134() )) || (IS_PED_IN_COMBAT( l_U113 )))
    {
        sub_338( 2, ref l_U142 );
        l_U105 = 9;
    }
...
int sub_2666(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_608() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_608() )))
            {
                if (((g_U9200) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_608() )))))
                {
                    if (NOT sub_2762())
                    {
