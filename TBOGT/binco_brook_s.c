    ...
    while (l_U1317)
    {
        ...
        if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
        {
            switch (l_U194)
            {
                ...
                else if (((sub_9395( sub_592(), l_U1329 )) AND (LOCATE_CHAR_ON_FOOT_3D( sub_592(), l_U1383._fU0 + l_U1342._fU0, l_U1383._fU4 + l_U1342._fU4, l_U1383._fU8 + l_U1342._fU8, l_U1345._fU0, l_U1345._fU4, l_U1345._fU8, 0 ))) || (LOCATE_CHAR_ON_FOOT_3D( sub_592(), l_U1339._fU0, l_U1339._fU4, l_U1339._fU8, 1.60000000, 1.60000000, 2.00000000, 0 )))
                {
                    if (sub_9452( l_U1329, l_U1383 ))
                    {
                        if (NOT sub_9690())
                        {
                            if ((g_U8834) || (g_U15811[6]))
                            {
                                l_U194 = 5;
                            }
                            else
                ...
                if (sub_9452( l_U1329, l_U1383 ))
                {
                    if (sub_9748())
                    {
                        ...
                        {
                            if ((NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "SHOP_H_EXIT" ))) AND (LOCATE_CHAR_ON_FOOT_3D( sub_592(), l_U278[l_U1378]._fU8._fU0, l_U278[l_U1378]._fU8._fU4, l_U278[l_U1378]._fU8._fU8, l_U278[l_U1378]._fU32._fU0, l_U278[l_U1378]._fU32._fU4, l_U278[l_U1378]._fU32._fU8, 0 )))
                            {
...
void sub_386()
{
    ...
    if (NOT (IS_CHAR_DEAD( sub_592() )))
    {
        ...
        if ((l_U1318) AND (IS_PLAYER_PLAYING( sub_659() )))
        {
    ...
    if (NOT (IS_CHAR_DEAD( uParam0 )))
    {
        ...
        if (uParam1._fU0 != uVar21._fU0)
        {
            ...
            else
            {
                ...
                if (((GET_CHAR_TEXTURE_VARIATION( sub_592(), 8 )) != 0) || ((GET_CHAR_DRAWABLE_VARIATION( sub_592(), 8 )) != 1))
                {
...
void sub_2433()
{
    ...
    if (iVar3 > 0)
    {
        for ( I = 0; I < iVar3; I++ )
        {
            ...
            if ((IS_PLAYER_PLAYING( sub_659() )) AND (NOT (IS_CHAR_INJURED( uVar5 ))))
            {
...
void sub_2859()
{
    ...
    sub_2937( 2, 3.70000000, -5.20000000, 1.40000000, 1.25000000, 0.50000000, 1.50000000, 3.90000000, -5.20000000, 1.40000000, 889.30950000, -437.99200000, 14.86010000, 360.00000000 );
    ...
    sub_2937( 12, -6.10000000, 5.40000000, 1.40000000, 0.75000000, 0.40000000, 1.50000000, -6.30000000, 5.80000000, 1.40000000, 879.62440000, -447.51200000, 14.86010000, 287.64000000 );
    sub_2937( 13, -5.25000000, 5.40000000, 1.40000000, 0.75000000, 0.45000000, 1.50000000, -6.30000000, 5.80000000, 1.40000000, 879.62440000, -446.51200000, 14.86010000, 270.00000000 );
    sub_2937( 14, -4.40000000, 5.40000000, 1.40000000, 0.75000000, 0.40000000, 1.50000000, -4.80000000, 5.80000000, 1.40000000, 879.62440000, -445.61200000, 14.86010000, 270.00000000 );
    sub_2937( 15, -3.20000000, 5.30000000, 1.40000000, 0.75000000, 0.80000000, 1.50000000, -3.30000000, 5.80000000, 1.40000000, 879.62440000, -444.63640000, 14.86010000, 270.00000000 );
    sub_2937( 16, -1.80000000, 5.30000000, 1.40000000, 0.75000000, 0.60000000, 1.50000000, 1.40000000, 5.80000000, 1.40000000, 879.62440000, -443.12100000, 14.86010000, 270.00000000 );
    sub_2937( 17, -0.60000000, 5.30000000, 1.40000000, 0.75000000, 0.60000000, 1.50000000, 1.40000000, 5.80000000, 1.40000000, 879.62440000, -441.82100000, 14.86010000, 206.28000000 );
    sub_2937( 18, 0.60000000, 5.30000000, 1.40000000, 0.75000000, 0.60000000, 1.50000000, 2.90000000, 5.80000000, 1.40000000, 879.62440000, -440.49660000, 14.86010000, 300.00000000 );
    ...
    sub_2937( 28, -3.60000000, 3.10000000, 1.40000000, 1.30000000, 1.30000000, 1.50000000, -3.60000000, 3.00000000, 1.40000000, 880.33720000, -444.14280000, 14.86020000, 199.80000000 );
...
void sub_5316()
{
    ...
    sub_5364( 14, 880.94420000, -446.11930000, 16.20920000, -1.29170000, -0.00000000, 72.99700000, 45.00000000 );
    ...
    sub_5364( 19, 887.69170000, -443.60670000, 15.66380000, -0.00400000, 0.00000000, 72.43540000, 45.00000000 );
    ...
    sub_5364( 23, 882.37370000, -441.00780000, 15.84000000, -2.04930000, -0.00000000, -69.20680000, 45.00000000 );
...
int sub_9748()
{
    ...
    if (NOT (IS_CHAR_INJURED( l_U1324 )))
    {
        ...
        if ((LOCATE_CHAR_ON_FOOT_3D( sub_592(), l_U1383._fU0 + vVar2.x, l_U1383._fU4 + vVar2.y, l_U1383._fU8 + vVar2.z, vVar5.x + 2.50000000, vVar5.y + 2.50000000, vVar5.z + 2.50000000, 0 )) AND (sub_9395( sub_592(), l_U1329 )))
        {
            if (sub_9395( l_U1324, l_U1329 ))
            {
                if ((IS_WANTED_LEVEL_GREATER( sub_659(), 0 )) || (IS_CHAR_IN_ANY_CAR( sub_592() )))
                {
                    if (NOT l_U1400)
                    {
                ...
                if ((l_U1399) || (IS_CHAR_SHOOTING( sub_592() )))
                {
                ...
                else
                {
                    ...
                    else if ((iVar8 > (l_U1375 + 2500)) || (sub_12220( l_U1324, 34 )))
                    {
                        CLEAR_CHAR_TASKS( l_U1324 );
                        TASK_TURN_CHAR_TO_FACE_CHAR( l_U1324, sub_592() );
                        GET_GAME_TIMER( ref l_U1376 );
                    }
                    if ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_659(), l_U1324 )) || (IS_PLAYER_TARGETTING_CHAR( sub_659(), l_U1324 )))
                    {
                        if (NOT l_U1402)
                        {
                ...
                if ((NOT l_U1403) AND (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U1324, sub_592(), 0 )))
                {
...
int sub_13629()
{
    ...
    switch (l_U195)
    {
        ...
        else
        {
            ...
            {
                if ((sub_14078( uVar3, l_U1329 )) || (LOCATE_CAR_3D( uVar3, l_U1339._fU0, l_U1339._fU4, l_U1339._fU8, 7.50000000, 7.50000000, 7.50000000, 0 )))
                {
            ...
            SET_CAM_POS( l_U1394[0], 890.22430000, -438.83030000, 16.89151000 );
            SET_CAM_ROT( l_U1394[0], -9.57918400, 0.00000000, 112.57860000 );
...
int sub_13675(unknown uParam0, int iParam1)
{
    if ((uParam0^))
    {
        if ((iParam1 > 0) AND ((IS_SCREEN_FADED_IN()) AND (sub_13692())))
        {
            return 1;
        }
        else
...
int sub_18018(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, unknown uParam17, unknown uParam18, unknown uParam19, unknown uParam20, unknown uParam21, unknown uParam22, unknown uParam23, unknown uParam24, unknown uParam25, unknown uParam26, unknown uParam27, unknown uParam28, unknown uParam29, unknown uParam30, unknown uParam31, unknown uParam32, int iParam33, unknown uParam34, unknown uParam35, unknown uParam36, unknown uParam37, unknown uParam38, unknown uParam39, unknown uParam40, unknown uParam41, unknown uParam42, unknown uParam43, unknown uParam44, unknown uParam45)
{
    ...
    if ((sub_12220( sub_592(), 88 )) AND (sub_12220( sub_592(), 80 )))
    {
        if (TIMERA() > iParam33)
        {
    ...
    if (sub_18299())
    {
        if ((NOT sub_18379()) AND (NOT (IS_SCORE_GREATER( sub_659(), iVar48 - 1 ))))
        {
            CLEAR_PRINTS();
...
int sub_23235(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_659() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_659() )))
            {
                if (((g_U9200) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_659() )))))
                {
                    if (NOT sub_23331())
                    {
...
int sub_28919(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7)
{
    ...
    if (((iVar13 != -1) AND (iVar13 != 0)) || (IS_BUTTON_PRESSED( 0, 0 )))
    {
