...
void sub_2406(unknown uParam0)
{
    ...
    if ((HAS_MODEL_LOADED( l_U97 )) AND ((HAS_MODEL_LOADED( 957096072 )) AND (NOT (IS_OBJECT_ON_SCREEN( uParam0 )))))
    {
...
void sub_3125()
{
    switch (l_U14)
    {
        ...
        if (l_U100 == nil)
        {
            if ((HAS_MODEL_LOADED( l_U95 )) AND ((HAS_MODEL_LOADED( 583751396 )) AND (HAVE_ANIMS_LOADED( "amb@kiosk" ))))
            {
        ...
        if (l_U100 == nil)
        {
            if ((HAS_MODEL_LOADED( l_U96 )) AND (HAVE_ANIMS_LOADED( "amb@kiosk" )))
            {
                BEGIN_CHAR_SEARCH_CRITERIA();
                SEARCH_CRITERIA_REJECT_PEDS_WITH_FLAG_TRUE( 36 );
                SEARCH_CRITERIA_REJECT_PEDS_WITH_FLAG_TRUE( 44 );
        ...
        if (l_U100 == nil)
        {
            if ((HAS_MODEL_LOADED( l_U94 )) AND (HAVE_ANIMS_LOADED( "amb@kiosk" )))
            {
                BEGIN_CHAR_SEARCH_CRITERIA();
                SEARCH_CRITERIA_REJECT_PEDS_WITH_FLAG_TRUE( 36 );
                SEARCH_CRITERIA_REJECT_PEDS_WITH_FLAG_TRUE( 44 );
...
int sub_6719(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_665() ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            ...
            {
                if (((g_U9200) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_665() )))))
                {
                    if (NOT sub_5634())
                    {
        ...
        if (NOT (IS_CHAR_INJURED( l_U100 )))
        {
            if (NOT (IS_CHAR_INJURED( l_U99 )))
            {
                switch (l_U15)
                {
                    ...
                    if ((l_U66[0] == 0) AND (l_U58 > 0.48300000))
                    {
                        if (DOES_OBJECT_EXIST( l_U106 ))
                        {
                    ...
                    if ((l_U66[1] == 0) AND (l_U58 > 0.64000000))
                    {
                        if (DOES_OBJECT_EXIST( l_U106 ))
                        {
                    ...
                    if ((l_U66[2] == 0) AND (l_U60 > 0.47100000))
                    {
                        if (DOES_OBJECT_EXIST( l_U107 ))
                        {
                    ...
                    if ((l_U66[3] == 0) AND (l_U60 > 0.61200000))
                    {
                    ...
                    if ((l_U66[4] == 0) AND (l_U60 > 0.72000000))
                    {
                        sub_3924( l_U107 );
                        l_U66[4] = 1;
                    }
...
int sub_13173()
{
    if ((sub_13221()) || ((IS_BUTTON_PRESSED( 0, 16 )) || ((IS_BUTTON_PRESSED( 0, 15 )) || ((IS_BUTTON_PRESSED( 0, 14 )) || (IS_BUTTON_PRESSED( 0, 17 ))))))
    {
        return 1;
    }
    return 0;
