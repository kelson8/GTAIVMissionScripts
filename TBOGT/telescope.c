...
int sub_1912(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_753() ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            ...
            {
                if (((g_U9200) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_753() )))))
                {
                    if (NOT sub_2008())
                    {
...
int sub_5054()
{
    if ((sub_5102()) || ((IS_BUTTON_PRESSED( 0, 16 )) || ((IS_BUTTON_PRESSED( 0, 15 )) || ((IS_BUTTON_PRESSED( 0, 14 )) || (IS_BUTTON_PRESSED( 0, 17 ))))))
    {
        CLEAR_CHAR_TASKS_IMMEDIATELY( sub_1148() );
        SET_PLAYER_CONTROL( sub_753(), 1 );
        return 1;
...
void sub_5780()
{
    ...
    uVar5 = l_U20;
    uVar6 = l_U21;
    if ((IS_USING_CONTROLLER()) AND (IS_SNIPER_INVERTED()))
    {
        l_U65 = 0;
        l_U18 = uVar3;
        l_U19 = uVar4;
