...
void sub_232()
{
    ...
    l_U222[1] = {366.79550000, -731.30110000, 4.15270000};
    ...
    l_U266[1] = {333.54860000, -697.44460000, 3.69190000};
    ...
    l_U284[2] = {378.68210000, -721.63060000, 4.69190000};
    l_U284[3] = {385.66610000, -726.54310000, 4.69190000};
...
int sub_1413()
{
    if (IS_PLAYER_PLAYING( sub_1248() ))
    {
        if (g_U10973[2]._fU0)
        {
            if ((l_U108 == 5) || (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()))
            {
                if (sub_1474())
                {
                    if (NOT g_U12379)
...
void sub_1666()
{
    ...
    {
        iVar3 = sub_1694( 19 );
        if ((g_U10973[g_U11209[I]._fU0]._fU0) AND (sub_1739( 19, iVar3 )))
        {
    ...
    {
        iVar3 = sub_1694( 16 );
        if ((g_U10973[g_U11300[I]._fU0]._fU0) AND (sub_1739( 16, iVar3 )))
        {
    ...
    {
        iVar3 = sub_2239( I );
        if ((g_U10973[g_U11582[I]._fU28]._fU0) AND (sub_1739( g_U11582[I]._fU12, iVar3 )))
        {
...
void sub_2836()
{
    ...
    for ( I = 0; I < 72; I++ )
    {
        if ((g_U10973[g_U11582[I]._fU28]._fU0) AND (sub_2239( I )))
        {
            iVar4++;
        }
    }
                        ...
                        if (IS_CHAR_SITTING_IN_CAR( l_U172[l_U335], l_U213[l_U335] ))
                        {
                            switch (l_U110[l_U335])
                            {
                                ...
                                if (HAS_CAR_RECORDING_BEEN_LOADED( l_U339[l_U335] ))
                                {
                                    ...
                                    if ((sub_5782( l_U213[l_U335], l_U335 )) || (l_U211 == 7))
                                    {
                                        if ((sub_5782( l_U213[l_U335], l_U335 )) || (LOCATE_CAR_3D( l_U213[l_U335], uVar10._fU0, uVar10._fU4, uVar10._fU8, 15.00000000, 15.00000000, 15.00000000, 0 )))
                                        {
                                ...
                                break;
                                case 4:
                                if ((LOCATE_CAR_3D( l_U213[l_U335], l_U222[l_U335]._fU0, l_U222[l_U335]._fU4, l_U222[l_U335]._fU8, 5.00000000, 5.00000000, 5.00000000, 0 )) || (NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U213[l_U335] ))))
                                {
                                    if (NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U213[l_U335] )))
                                    {
                                        l_U110[l_U335] = 5;
    ...
    for ( J = 0; J < 5; J++ )
    {
        if (NOT (IS_CHAR_INJURED( l_U203[J] )))
        {
            if (NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U203[J], l_U244[J]._fU0, l_U244[J]._fU4, l_U244[J]._fU8, 2.00000000, 2.00000000, 2.00000000, 0 )))
            {
                ...
                if ((NOT (IS_PED_IN_COMBAT( l_U203[J] ))) AND (l_U211 == 7))
                {
                    CLEAR_CHAR_TASKS( l_U203[J] );
                    OPEN_SEQUENCE_TASK( ref l_U210 );
...
void sub_11664()
{
    if ((NOT (HAVE_ANIMS_LOADED( l_U428 ))) || ((NOT (HAS_MODEL_LOADED( l_U171 ))) || ((NOT (HAS_MODEL_LOADED( l_U170 ))) || (NOT (HAS_MODEL_LOADED( l_U169 ))))))
    {
        REQUEST_MODEL( l_U169 );
        REQUEST_MODEL( l_U170 );
        REQUEST_MODEL( l_U171 );
...
void sub_12994()
{
    ...
    for ( l_U335 = 0; l_U335 < 5; l_U335++ )
    {
        if ((NOT l_U129[l_U335]) AND (IS_VEH_DRIVEABLE( l_U213[l_U335] )))
        {
            if (NOT (IS_CHAR_INJURED( l_U172[l_U335] )))
            {
                if (IS_CHAR_SITTING_IN_CAR( l_U172[l_U335], l_U213[l_U335] ))
                    ...
                    if (NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U213[l_U335] )))
                    {
                        if (IS_CAR_PASSENGER_SEAT_FREE( l_U213[l_U335], 0 ))
                        {
                            if (NOT l_U123[l_U335])
                            {
                                if (NOT (IS_CHAR_DEAD( sub_1291() )))
                                {
                                    if ((NOT (IS_WANTED_LEVEL_GREATER( sub_1248(), 0 ))) AND (LOCATE_CHAR_ON_FOOT_CAR_3D( sub_1291(), l_U213[l_U335], 3.50000000, 3.50000000, 2.00000000, 0 )))
                                    {
                                        if ((sub_13284()) AND (IS_SCORE_GREATER( sub_1248(), 149 )))
                                        {
...
void sub_19764()
{
    ...
    if (IS_VEH_DRIVEABLE( l_U212 ))
    {
        if ((IS_CHAR_SITTING_IN_CAR( sub_1291(), l_U212 )) AND (NOT (IS_CHAR_INJURED( l_U209 ))))
        {
            SET_PLAYER_CAN_DO_DRIVE_BY( sub_1248(), 0 );
            if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U212 ))
            {
                ...
                if (l_U317)
                {
                    ...
                    else if (l_U119)
                    {
                        if (NOT l_U121)
                        {
                            if ((l_U122) || (NOT IS_HELP_MESSAGE_BEING_DISPLAYED()))
                            {
                                CLEAR_HELP();
                                ADD_NEXT_MESSAGE_TO_PREVIOUS_BRIEFS( 0 );
                                PRINT_HELP( "HETR_03" );
                ...
                if (l_U358 < l_U372)
                {
                    ...
                    else if (((l_U358 - 1) <= l_U374) AND (l_U358 > l_U373))
                    {
                        if (NOT l_U168)
                        {
                            if (NOT (sub_20566( l_U435 )))
...
void sub_26147()
{
    if (IS_VEH_DRIVEABLE( l_U212 ))
    {
        switch (l_U109)
        {
            ...
            if ((g_U9303) AND ((g_U9302) AND ((g_U9301) AND ((g_U9300) AND (g_U9299)))))
            {
