...
void sub_19382()
{
        ...
        else if (NOT g_U15811[35])
        {
            if ((NOT g_U30153) AND (NOT g_U12379))
            {
                if (NOT (l_U1938 == 2))
                {
                    ...
                    {
                        if ((g_U30110[l_U1938]) || (((NOT (sub_3889( sub_3604(), l_U1938, 0 ))) AND (l_U1910)) || (NOT (sub_19747( sub_3604(), l_U1938, 1094713344 )))))
                        {
    ...
    {
        GET_TIME_OF_DAY( ref iVar7, ref uVar8 );
        if (NOT ((l_U1938 == 0) AND (g_U30181)))
        {
            if (NOT g_U15811[35])
            {
                if ((sub_3889( sub_3604(), l_U1938, 0 )) || ((g_U30153) || (((iVar7 < 6) || (iVar7 >= 21)) || ((IS_THREAD_ACTIVE( g_U30226[l_U1938] )) || (g_U12379)))))
                {
    ...
    if ((NOT ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "rocco1" )) > 0)) AND ((IS_PLAYER_PLAYING( sub_2048() )) AND (sub_20450( sub_3604(), l_U1938 ))))
    {
        sub_21430();
        if (g_U30154[l_U1938])
        {
        ...
        switch (l_U1937)
        {
            ...
            {
                if ((NOT g_U30093[l_U1938]) AND (sub_29981( sub_3604(), l_U1938 )))
                {
            ...
            break;
            case 1:
            if ((NOT (sub_29981( sub_3604(), l_U1938 ))) || (NOT (sub_3889( sub_3604(), l_U1938, 0 ))))
            {
                sub_1798();
                l_U1937 = 0;
            }
        ...
        if ((sub_30766()) || (NOT g_U30149[l_U1938]))
        {
            if ((sub_30766()) || (NOT g_U30120[l_U1938]))
            {
                if (g_U30128[l_U1938])
                {
                ...
                if (g_U30114[l_U1938])
                {
                    ...
                    if ((sub_3889( sub_3604(), l_U1938, 0 )) || (IS_SCREEN_FADED_OUT()))
                    {
                ...
                if (g_U30109)
                {
                    for ( I = 0; I < l_U1685; I++ )
                    {
                        if ((l_U1685[I]._fU4 == 12) || (l_U1685[I]._fU4 == 10))
                        {
                            l_U1685[I]._fU16 = 0;
                        }
                    }
        ...
        else if ((l_U1903) || (IS_THREAD_ACTIVE( g_U30226[l_U1938] )))
        {
            sub_75720();
            if (g_U30110[l_U1938])
            {
...
int sub_20450(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_PLAYER_PLAYING( sub_2048() ))
    {
        ...
        {
            if (((sub_20724( sub_3604() )) == 3) || ((sub_20724( sub_3604() )) == 5))
            {
                bVar4 = true;
            }
        }
...
void sub_26281()
{
    ...
    if (IS_PLAYER_PLAYING( sub_2048() ))
    {
        if ((NOT g_U30179) AND (NOT g_U30153))
        {
            if (NOT l_U1893)
            {
                if ((NOT l_U1895) AND (NOT g_U30093[l_U1938]))
                {
            ...
            else if ((g_U30093[l_U1938]) || (NOT (sub_3917( sub_3604(), l_U1938 ))))
            {
                SET_CHAR_MAX_MOVE_BLEND_RATIO( sub_3604(), 3.00000000 );
                l_U1893 = 0;
            }
...
void sub_26710()
{
    ...
    if (IS_PLAYER_PLAYING( sub_2048() ))
    {
        if ((NOT g_U30179) AND (NOT g_U30153))
        {
            if (NOT l_U1895)
            {
                if ((NOT g_U30153) AND (NOT g_U30093[l_U1938]))
                {
                    if (sub_3917( sub_3604(), l_U1938 ))
                    {
            ...
            else
            {
                ...
                if ((sub_27010( sub_3604() )) || ((NOT bVar3) || ((g_U30153) || ((g_U30093[l_U1938]) || (NOT (sub_3917( sub_3604(), l_U1938 )))))))
                {
...
void sub_27576()
{
    ...
    if (NOT g_U30167)
    {
        if (((l_U1938 == 0) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "Tony6" )) > 0)) || ((IS_PLAYER_CONTROL_ON( sub_2048() )) AND (HAS_CUTSCENE_FINISHED())))
        {
            if (IS_PLAYER_PLAYING( sub_2048() ))
            {
                if (g_U30153)
                ...
                else if (((l_U1938 == 0) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "E2EndCredits" )) > 0)) || ((l_U1938 == 0) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "Tony6" )) > 0)))
                {
                    if ((NOT (sub_3889( sub_3604(), l_U1938, 0 ))) AND (IS_WANTED_LEVEL_GREATER( sub_2048(), 0 )))
                    {
                        sub_27855( l_U1938, 2 );
                    }
                    else
                ...
                else if ((g_U30149[l_U1938]) || ((g_U30093[l_U1938]) || (IS_WANTED_LEVEL_GREATER( sub_2048(), 0 ))))
                {
                    sub_27855( l_U1938, 2 );
                }
                else if (l_U1938 == 0)
            ...
            if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS( vVar3.x, vVar3.y, vVar3.z, 1.50000000, iVar2 ))
            {
                switch (g_U30192[l_U1938])
                {
                    ...
                    if ((NOT (sub_28310( vVar3, 2.00000000 ))) || (IS_SCREEN_FADED_OUT()))
                    {
                        fVar8 = -1.00000000;
                    }
    ...
    if (NOT l_U1892)
    {
        if (IS_PLAYER_PLAYING( sub_2048() ))
        {
            if (g_U30149[l_U1938])
            {
                ...
                {
                    if ((NOT g_U12379) AND ((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) AND (NOT sub_29203())))
                    {
                        switch (l_U1938)
                        {
                            case 0:
...
int sub_29203()
{
    if ((sub_29270()) || ((sub_29219()) || (IS_MESSAGE_BEING_DISPLAYED())))
    {
        return 1;
    }
    return 0;
...
void sub_34196()
{
    if (NOT l_U1891)
    {
        if (IS_PLAYER_PLAYING( sub_2048() ))
        {
            if ((NOT (g_U30192[l_U1938] == 1)) AND (g_U30093[l_U1938]))
            {
                if (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3604() )))
                {
                    if ((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) AND (NOT sub_29203()))
                    {
                        switch (l_U1938)
                        {
                            case 0:
...
void sub_35537()
{
    ...
    if ((NOT g_U30093[l_U1938]) AND (IS_PLAYER_PLAYING( sub_2048() )))
    {
        if ((NOT g_U43025) AND ((NOT (IS_WANTED_LEVEL_GREATER( sub_2048(), 0 ))) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3604() )))))
        {
            if (NOT l_U1887)
            {
                if (NOT l_U1874)
...
int sub_35667(unknown uParam0)
{
    ...
    if (NOT (IS_CHAR_INJURED( uParam0 )))
    {
        ...
        if (((VMAG2( uVar12 )) > 0.50000000) AND ((sub_35809( uVar12, uVar15 )) > 0.00000000))
        {
            return 1;
        }
    }
...
void sub_36554()
{
    ...
    if (NOT g_U30101)
    {
        if (NOT l_U1875)
        {
            ...
            {
                if ((sub_36622()) || (IS_CHAR_SHOOTING( sub_3604() )))
                {
                    g_U30093[l_U1938] = 1;
    ...
    if (NOT g_U30093[l_U1938])
    {
        if (IS_PLAYER_PLAYING( sub_2048() ))
        {
            if (((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "Tony6" )) > 0) || (sub_19747( sub_3604(), l_U1938, 1094713344 )))
            {
        ...
        if ((uParam0^)[I]._fU0)
        {
            if (NOT (IS_CHAR_INJURED( (uParam0^)[I]._fU24 )))
            {
                if (NOT g_U30153)
                {
                    if (NOT sub_36119())
                    {
                        if ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_2048(), (uParam0^)[I]._fU24 )) || (IS_PLAYER_TARGETTING_CHAR( sub_2048(), (uParam0^)[I]._fU24 )))
                        {
                            g_U30093[l_U1938] = 1;
                    ...
                    {
                        if ((((uParam0^)[I]._fU4 == 9) || ((uParam0^)[I]._fU4 == 8)) || (l_U1938 == 0))
                        {
...
void sub_38275()
{
    ...
    if (sub_3889( sub_3604(), l_U1938, 0 ))
    {
        if (sub_38308())
        {
            if ((NOT l_U1882) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "dancing" )) == 0))
            {
                if (NOT g_U30093[l_U1938])
                {
                ...
                if ((iVar8) AND ((sub_39794( 2, 0 )) AND ((g_U30105) || (bVar7))))
                {
                    l_U1998 = "DANC_H01";
                    if ((g_U30105) || ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT l_U1876)))
                    {
                        if (NOT (IS_CHAR_INJURED( l_U1983 )))
                        {
                            if (l_U1963 > 30000)
                        ...
                        if ((g_U30105) || (sub_40278( 2, l_U1998, 0 )))
                        {
                            g_U30206 = l_U1983;
                            g_U30190 = l_U1938;
                            l_U1911 = 0;
...
int sub_39794(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_2048() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_2048() )))
            {
                if (((g_U9200) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_2048() )))))
                {
                    if (NOT sub_39890())
                    {
...
void sub_43934(int iParam0)
{
    if (iParam0->_fU0)
    {
            ...
            else if (NOT l_U1875)
            {
                if (iParam0->_fU20 > 0)
                {
                    switch (iParam0->_fU4)
                    {
                        ...
                        case 10:
                        case 12:
                        if (((sub_30766()) || (NOT g_U30103)) AND ((sub_29981( sub_3604(), l_U1938 )) || (sub_3889( sub_3604(), l_U1938, 1 ))))
                        {
                            iParam0->_fU8 = 1;
                        }
                        break;
                        case 14:
                        if ((NOT g_U30180) AND (NOT l_U1914))
                        {
                            if ((NOT l_U1897) AND (NOT g_U30102))
                            {
        ...
        if (iParam0->_fU8 == 1)
        {
            if ((sub_44555( iParam0 )) AND (NOT l_U1875))
            {
                switch (iParam0->_fU4)
                {
                    case 1:
                    ...
                    {
                        if (((sub_30766()) || (NOT g_U30103)) AND ((sub_29981( sub_3604(), l_U1938 )) AND (sub_44710( iParam0 ))))
                        {
                            sub_45529( iParam0 );
                        }
                    }
                    ...
                    if (sub_44710( iParam0 ))
                    {
                        if ((sub_44382( (iParam0^) )) || (sub_53067( sub_3604(), l_U1938 )))
                        {
                            if ((sub_44382( (iParam0^) )) || (NOT g_U30102))
                            {
                                sub_45529( iParam0 );
                            }
                        }
                    ...
                    break;
                    case 6:
                    if ((sub_3917( sub_3604(), l_U1938 )) || (sub_53067( sub_3604(), l_U1938 )))
                    {
                        if (sub_44710( iParam0 ))
                        {
                            sub_45529( iParam0 );
                    ...
                    if (sub_3889( sub_3604(), l_U1938, 1 ))
                    {
                        if ((NOT g_U30103) AND ((sub_29981( sub_3604(), l_U1938 )) AND (sub_44710( iParam0 ))))
                        {
                            sub_45529( iParam0 );
                        }
                    }
        ...
        if (iParam0->_fU8 == 2)
        {
            ...
            else
            {
                switch (iParam0->_fU4)
                {
                    ...
                    case 10:
                    case 12:
                    if (((sub_30766()) || (NOT g_U30103)) AND (sub_29981( sub_3604(), l_U1938 )))
                    {
                        sub_53685( iParam0 );
                    }
                    else
                    ...
                    break;
                    case 4:
                    if ((NOT g_U30103) AND (sub_29981( sub_3604(), l_U1938 )))
                    {
                        sub_53685( iParam0 );
                    }
                    else
                    ...
                    else if ((NOT g_U30102) AND (sub_53067( sub_3604(), l_U1938 )))
                    {
                        sub_53685( iParam0 );
                    }
                    else
    ...
    else if (NOT g_U30097[l_U1938])
    {
        if (NOT (iParam0->_fU4 == 0))
        {
            ...
            else if ((NOT (iParam0->_fU4 == 9)) AND ((NOT (iParam0->_fU4 == 13)) AND ((NOT (iParam0->_fU4 == 2)) AND (NOT (sub_3889( sub_3604(), l_U1938, 0 ))))))
            {
                iParam0->_fU0 = 1;
            }
...
{
    if ((iParam0->_fU4 == 7) || ((iParam0->_fU4 == 6) || ((iParam0->_fU4 == 13) || ((iParam0->_fU4 == 2) || (g_U30162[l_U1938])))))
    {
...
void sub_45529(int iParam0)
{
    ...
    if (iParam0->_fU0)
    {
        if ((l_U1902) || (sub_45550( iParam0 )))
        {
            if ((l_U1902) || ((g_U30114[l_U1938]) || (sub_45621( iParam0 ))))
            {
                if ((l_U1902) || (NOT (sub_46452( iParam0->_fU28, g_U30251, g_U30254 ))))
                {
                    if ((l_U1902) || (sub_46552( iParam0 )))
                    {
                        if (HAS_MODEL_LOADED( iParam0->_fU48 ))
                        {
                            if (NOT (DOES_CHAR_EXIST( iParam0->_fU24 )))
                            {
                                if ((l_U1902) || ((sub_3889( sub_3604(), l_U1938, 0 )) || (NOT g_U30093[l_U1938])))
                                {
...
int sub_45621(int iParam0)
{
    ...
    if ((IS_PLAYER_CONTROL_ON( sub_2048() )) AND ((NOT g_U30114[l_U1938]) AND (NOT IS_SCREEN_FADED_OUT())))
    {
        ...
        if ((iParam0->_fU20 > 0) AND (iParam0->_fU16 == -1))
        {
            ...
            {
                GET_GAME_VIEWPORT_ID( ref uVar4 );
                if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3604(), ref iParam0->_fU28->_fU0, ref iParam0->_fU28->_fU4, ref iParam0->_fU28->_fU8, 5.00000000, 5.00000000, 5.00000000, 0 )) || (CAM_IS_SPHERE_VISIBLE( uVar4, ref iParam0->_fU28->_fU0, ref iParam0->_fU28->_fU4, ref iParam0->_fU28->_fU8, 2.00000000 )))
                {
                    return 0;
                }
            }
        ...
        {
            GET_GAME_VIEWPORT_ID( ref uVar4 );
            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3604(), ref iParam0->_fU28->_fU0, ref iParam0->_fU28->_fU4, ref iParam0->_fU28->_fU8, 7.00000000, 7.00000000, 5.00000000, 0 )) AND (CAM_IS_SPHERE_VISIBLE( uVar4, ref iParam0->_fU28->_fU0, ref iParam0->_fU28->_fU4, ref iParam0->_fU28->_fU8, 1.50000000 )))
            {
                return 0;
            }
        }
...
int sub_46697(unknown uParam0)
{
    ...
    switch (uParam0)
    {
        ...
        break;
        case 15:
        if (((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "Tony6" )) > 0) AND (l_U1938 == 0))
        {
            return 1;
        }
        else
...
string sub_48287(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((sub_46452( uParam0, -473.07430000, 139.93400000, 5.00000000, -467.99930000, 142.23400000, 11.86410000 )) || (sub_46452( uParam0, -471.45100000, 139.90120000, 5.00000000, -468.07600000, 156.20120000, 11.86410000 )))
    {
    ...
    if ((sub_46452( uParam0, -397.59980000, 431.71720000, 4.00000000, -383.42480000, 441.21720000, 12.05160000 )) || (sub_46452( uParam0, -398.37480000, 417.79220000, 4.00000000, -377.19980000, 431.96720000, 12.05160000 )))
    {
        return "gaydanceflr";
    }
    ...
    if (DOES_CHAR_EXIST( iParam0->_fU24 ))
    {
        if (NOT (IS_CHAR_INJURED( iParam0->_fU24 )))
        {
            if (NOT (sub_2334( iParam0->_fU24 )))
            {
                ...
                if (NOT (iParam0->_fU12 == 99))
                {
                    if ((sub_51601( iParam0->_fU56 )) || (sub_3003( iParam0->_fU56 )))
                    {
                        BLOCK_CHAR_AMBIENT_ANIMS( iParam0->_fU24, 1 );
                    }
                }
                if (NOT l_U1875)
                {
                    if (sub_55800( iParam0 ))
                    {
                        ...
                        else if (iParam0->_fU12 == 99)
                        {
                            ...
                            if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3604(), iParam0->_fU24, 15.00000000, 15.00000000, 5.00000000, 0 ))) AND (NOT (IS_CHAR_ON_SCREEN( iParam0->_fU24 ))))
                            {
                                if (l_U1877)
                                {
                        ...
                        switch (iParam0->_fU4)
                        {
                            ...
                            if (NOT g_U30118)
                            {
                                switch (iParam0->_fU12)
                                {
                                    ...
                                    if (NOT g_U30093[l_U1938])
                                    {
                                        ...
                                        if (NOT sub_36119())
                                        {
                                            if ((iParam0->_fU24 == l_U1978) || (iParam0->_fU24 == l_U1977))
                                            {
                                                CLEAR_CHAR_TASKS( iParam0->_fU24 );
                                                iParam0->_fU20 = 0;
                                                iParam0->_fU12 = 1;
                                    ...
                                    else if ((iParam0->_fU24 == l_U1978) || (iParam0->_fU24 == l_U1977))
                                    {
                                        GET_SCRIPT_TASK_STATUS( iParam0->_fU24, 91, ref l_U1999 );
                                        if (l_U1999 == 7)
                                        {
                                    ...
                                    break;
                                    case 2:
                                    if ((sub_3889( sub_3604(), l_U1938, 0 )) AND (NOT sub_36119()))
                                    {
                                        GET_SCRIPT_TASK_STATUS( iParam0->_fU24, 29, ref l_U1999 );
                                        if (l_U1999 == 7)
                                        {
                            ...
                            else
                            {
                                switch (iParam0->_fU12)
                                {
                                    ...
                                    {
                                        GET_SCRIPT_TASK_STATUS( iParam0->_fU24, 29, ref l_U1999 );
                                        if ((iParam0->_fU20 > 30000) || (l_U1999 == 7))
                                        {
                                            if (NOT (iParam0->_fU16 == -1))
                                            {
                            ...
                            break;
                            default:
                            if ((NOT (LOCATE_CHAR_ANY_MEANS_3D( iParam0->_fU24, ref iParam0->_fU28->_fU0, ref iParam0->_fU28->_fU4, ref iParam0->_fU28->_fU8, 5.00000000, 5.00000000, 5.00000000, 0 ))) || (sub_59423( iParam0 )))
                            {
                                iParam0->_fU12 = 99;
                            }
                            else
                            {
                                switch (iParam0->_fU12)
                                {
                                    ...
                                    else if ((NOT (sub_27182( uVar14 ))) AND (NOT (sub_27182( uVar13 ))))
                                    {
                                    ...
                                    if (sub_27182( sVar15 ))
                                    {
                                        ...
                                        if (l_U1999 == 7)
                                        {
                                            ...
                                            if ((NOT (sub_27182( uVar14 ))) AND (NOT (sub_27182( uVar13 ))))
                                            {
                                                if (NOT (IS_CHAR_PLAYING_ANIM( iParam0->_fU24, uVar14, uVar13 )))
                                                {
...
int sub_59423(int iParam0)
{
    if (NOT (IS_CHAR_INJURED( iParam0->_fU24 )))
    {
        if ((IS_PED_RAGDOLL( iParam0->_fU24 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( iParam0->_fU24, sub_3604(), 0 )))
        {
            return 1;
        }
    }
...
void sub_59569(int iParam0)
{
    ...
    for ( I = 0; I < l_U1763; I++ )
    {
        if ((NOT (l_U1763[I]._fU20 == iParam0->_fU24)) AND (NOT (I == iParam0->_fU16)))
        {
...
int sub_59892(unknown uParam0)
{
    ...
    {
        if ((sub_27182( sub_53814( l_U1763[uParam0]._fU24 ) )) || (sub_27182( l_U1716[l_U1763[uParam0]._fU24]._fU0 )))
        {
            return 1;
        }
    }
...
int sub_62026(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14)
{
    if (NOT (IS_CHAR_INJURED( uParam0._fU24 )))
    {
        if (NOT (sub_3889( uParam0._fU24, l_U1938, 0 )))
        {
            ...
            {
                if ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_2048(), uParam0._fU24 )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3604(), uParam0._fU24, 60.00000000, 60.00000000, 60.00000000, 0 )))
                {
                    return 1;
                }
            }
                        ...
                        if (iParam0->_fU20 > 10000)
                        {
                            switch (iParam0->_fU4)
                            {
                                ...
                                if (l_U1899)
                                {
                                    ...
                                    {
                                        if ((NOT (IS_AMBIENT_SPEECH_PLAYING( iParam0->_fU24 ))) AND (NOT (IS_AMBIENT_SPEECH_PLAYING( l_U1982 ))))
                                        {
                                ...
                                if (DOES_CHAR_EXIST( l_U1980 ))
                                {
                                    ...
                                    {
                                        if ((l_U1980 == iParam0->_fU24) || (IS_AMBIENT_SPEECH_PLAYING( l_U1980 )))
                                        {
                                            bVar3 = false;
                                        }
                                    }
                                ...
                                if (NOT bVar4)
                                {
                                    if (bVar3)
                                    {
                                        if (NOT l_U1900)
                                        {
                                            if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3604(), iParam0->_fU24, 2.00000000, 2.00000000, 2.00000000, 0 )) AND ((iParam0->_fU20 > 20000) AND (l_U1959 > 6000)))
                                            {
                                                GENERATE_RANDOM_INT_IN_RANGE( 0, 5, ref iVar5 );
                                                if (iVar5 < 2)
                                                {
                                                    if ((l_U1938 == 0) || (sub_67948( iParam0->_fU24 )))
                                                    {
                                                ...
                                                else if ((l_U1964 > 20000) AND (sub_68791( iParam0->_fU24 )))
                                                {
                                                    l_U1980 = iParam0->_fU24;
                                ...
                                else if ((iParam0->_fU20 > 5000) AND (l_U1959 > 5000))
                                {
                                ...
                                if (DOES_CHAR_EXIST( l_U1981 ))
                                {
                                    ...
                                    {
                                        if ((l_U1981 == iParam0->_fU24) || (IS_AMBIENT_SPEECH_PLAYING( l_U1981 )))
                                        {
                                            bVar3 = false;
                                        }
                                    }
...
void sub_79790()
{
    ...
    if ((g_U30178) || (l_U1875))
    {
        if ((NOT l_U1908) AND (NOT (l_U1973 == -1)))
        {
    ...
    if (NOT (g_U30197 == -1))
    {
        ...
        else if (((NOT g_U30154[l_U1938]) AND (g_U30149[l_U1938])) || ((g_U30177) || (NOT (sub_19747( sub_3604(), g_U30197, l_U1931 )))))
        {
            if (l_U1904)
            {
                if (g_U30177)
    ...
    switch (l_U1966)
    {
        ...
        if (fVar2 < l_U1930)
        {
            if (g_U30197 == -1)
            {
                if ((g_U30154[l_U1938]) || ((NOT ((NOT g_U30154[l_U1938]) AND (g_U30149[l_U1938]))) AND ((NOT g_U30177) AND (sub_19747( sub_3604(), l_U1938, l_U1931 )))))
                {
...
void sub_83594(int iParam0)
{
    ...
    if ((IS_PLAYER_CONTROL_ON( sub_2048() )) || (g_U10597))
    {
...
int sub_83645(unknown uParam0)
{
    ...
    {
        case 1:
        if ((IS_CHAR_IN_AREA_3D( sub_3604(), -468.32000000, 156.33000000, 11.46000000, -476.07000000, 166.44000000, 8.74000000, 0 )) || (IS_CHAR_IN_AREA_3D( sub_3604(), -474.97280000, 143.74440000, 8.86370000, -471.82280000, 150.54440000, 11.86370000, 0 )))
        {
            return 1;
        }
        break;
