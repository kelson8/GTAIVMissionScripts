void main()
{
    ...
    while (true)
    {
        ...
        switch (l_U183)
        {
            ...
            {
                if ((NOT g_U43741[l_U238]) AND (g_U43709[l_U238]))
                {
                    if ((l_U225[l_U238] == 12) AND (l_U212[l_U238] == 31))
                    {
            ...
            switch (l_U184)
            {
                    ...
                    else if (l_U310 > 3)
                    {
                        ...
                        if (l_U314 == 1)
                        {
                            ...
                            if (NOT (sub_12282() == 0))
                            {
                                ...
                                if ((sub_12282() == 1) || ((sub_12282() == 2) || (sub_12282() == 8)))
                                {
                                    sub_6560( 1 );
                                }
                            }
                ...
                if (l_U316 == 0)
                {
                    if ((sub_1870( l_U348 )) AND (sub_2480()))
                    {
...
int sub_4920()
{
    ...
    for ( I = 0; I <= (g_U575 - 1); I++ )
    {
        if ((g_U575[I]._fU20) AND ((sub_4958( 1, g_U575[I] )) != 0))
        {
            sub_5221( I );
            return 1;
        }
...
int sub_9126(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_2627() ))) AND (IS_CHAR_IN_ANY_CAR( sub_2627() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_9641()))
        {
            return 0;
        }
        g_U95._fU60 = uParam0;
