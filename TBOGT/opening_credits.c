                ...
                while (NOT HAS_CUTSCENE_FINISHED())
                {
                    ...
                    switch (l_U1808)
                    {
                        ...
                        switch (l_U1967)
                        {
                            ...
                            if (l_U1807 > 4200)
                            {
                                if ((l_U1978 == 0) AND (HAS_MODEL_LOADED( -1149743642 )))
                                {
                                    l_U1978 = 1;
                                }
                            }
                            if (l_U1807 > 7500)
                            {
                                ...
                                {
                                    if ((HAS_MODEL_LOADED( -1188246269 )) AND ((HAS_MODEL_LOADED( 2084514704 )) AND (HAVE_ANIMS_LOADED( "AMB@BUSKER" ))))
                                    {
...
void sub_2020()
{
    ...
    {
        if ((g_U575[I]._fU20) AND ((sub_2058( 5, g_U575[I] )) == 1))
        {
...
void sub_16251(unknown uParam0, float fParam1)
{
    ...
    if (NOT l_U214)
    {
        ...
        if ((IS_SCREEN_FADED_OUT()) || (l_U889 == 0))
        {
            iVar10 = 1;
        }
...
void sub_18560(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        for ( I = 0; I < 50; I++ )
        {
            ...
            if (l_U960[I] == 0)
            {
                if ((NOT (l_U1131[I] == 0)) AND ((l_U909[I] < 3000) AND (l_U909[I] > 0)))
                {
                    if (NOT l_U202)
                    {
            ...
            if (l_U960[I] == 2)
            {
                if (HAS_MODEL_LOADED( l_U1131[I] ))
                {
                    if (NOT (DOES_VEHICLE_EXIST( l_U1655[I] )))
                    {
                        ...
                        {
                            bVar17 = false;
                            if ((NOT (sub_19896( l_U1259[I] ))) AND (NOT (sub_18087( l_U1259[I], 5.00000000, 1120403456 ))))
                            {
                                bVar17 = true;
                            }
                            if (l_U228)
                        ...
                        if (6 > l_U1114)
                        {
                            ...
                            if (HAS_CAR_RECORDING_BEEN_LOADED( l_U909[I] ))
                            {
                                if (fVar14 < (GET_TOTAL_DURATION_OF_CAR_RECORDING( l_U909[I] )))
                                {
                                    ...
                                    if ((sub_18087( uVar11, 5.00000000, 1120403456 )) AND (NOT (sub_18087( uVar8, 5.00000000, 1120403456 ))))
                                    {
                                        sub_18960( I, 1090519040 );
                                    }
                    ...
                    if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U1655[I] ))
                    {
                        ...
                        if (DOES_CHAR_EXIST( uVar6 ))
                        {
                            if (NOT (IS_CHAR_INJURED( uVar6 )))
                            {
                                if (IS_PLAYER_PLAYING( sub_3376() ))
                                {
                                    if ((NOT l_U217) AND ((NOT l_U205) AND ((NOT l_U208) AND (IS_CHAR_TOUCHING_VEHICLE( sub_3804(), l_U1655[I] )))))
                                    {
                                        if (IS_CHAR_IN_ANY_CAR( sub_3804() ))
                                        {
                                            bVar16 = false;
                                    ...
                                    else if ((NOT l_U217) AND (sub_22753( uParam0, l_U1655[I] )))
                                    {
                                        sub_22626( l_U1655[I] );
                                        l_U960[I]++;
                                    }
        ...
        if (IS_PLAYER_PLAYING( sub_3376() ))
        {
            ...
            for ( I = 0; I < 50; I++ )
            {
                ...
                if (DOES_VEHICLE_EXIST( l_U1655[I] ))
                {
                    if (IS_VEH_DRIVEABLE( l_U1655[I] ))
                    {
                        if ((sub_24207( l_U1655[I], uVar6 )) || (sub_24207( l_U1655[I], (uParam0^) )))
                        {
            ...
            if (l_U1063[I] == 1)
            {
                if (6 > l_U1117)
                {
                    if (HAS_MODEL_LOADED( l_U1182[I] ))
                    {
                        ...
                        {
                            if ((l_U228) || ((l_U202) || (NOT (sub_18087( l_U1410[I], 5.00000000, 1120403456 )))))
                            {
                                if (l_U221)
                                {
...
void sub_26069(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        for ( I = 0; I < 25; I++ )
        {
            if ((NOT (l_U1233[I] == 0)) AND ((l_U1011[I] < 3000) AND (l_U1011[I] > 0)))
            {
                if (l_U1037[I] == 0)
                {
                    if (NOT l_U202)
                ...
                if (l_U1037[I] == 2)
                {
                    if (HAS_MODEL_LOADED( l_U1233[I] ))
                    {
                        if (NOT (DOES_VEHICLE_EXIST( l_U1764[I] )))
                        {
                            ...
                            if (bVar15)
                            {
                                if ((l_U228) || (NOT (sub_18087( l_U1561[I], 5.00000000, 1120403456 ))))
                                {
                            ...
                            if (6 > l_U1116)
                            {
                                ...
                                if (HAS_CAR_RECORDING_BEEN_LOADED( l_U1011[I] ))
                                {
                                    if (fVar13 < (GET_TOTAL_DURATION_OF_CAR_RECORDING( l_U1011[I] )))
                                    {
                                        ...
                                        if ((NOT l_U228) AND ((sub_18087( uVar10, 5.00000000, 1120403456 )) AND (NOT (sub_18087( uVar7, 5.00000000, 1120403456 )))))
                                        {
                                            l_U1116++;
                                            l_U1037[I]++;
                                        }
                        ...
                        if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U1764[I] ))
                        {
                            ...
                            if (DOES_CHAR_EXIST( uVar5 ))
                            {
                                if (NOT (IS_CHAR_INJURED( uVar5 )))
                                {
                                    if (IS_PLAYER_PLAYING( sub_3376() ))
                                    {
                                        if ((NOT l_U238) AND ((NOT l_U205) AND ((NOT l_U208) AND (IS_CHAR_TOUCHING_VEHICLE( sub_3804(), l_U1764[I] )))))
                                        {
                                            if (IS_CHAR_IN_ANY_CAR( sub_3804() ))
                                            {
                                                bVar15 = false;
...
int sub_29822(unknown uParam0, unknown uParam1)
{
    ...
    sub_25115( (uParam0^) );
    if ((l_U1130 == 0) AND ((l_U1129 == 0) AND (l_U1128 == 0)))
    {
        l_U205 = 0;
        l_U202 = 0;
        l_U231 = 0;
...
void sub_31056()
{
    ...
    l_U1259[14] = {-80.68589000, -166.21030000, 14.41190000};
