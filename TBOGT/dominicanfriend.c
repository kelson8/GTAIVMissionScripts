...
int sub_3417()
{
    ...
    if ((IS_KEYBOARD_KEY_PRESSED( 31 )) AND (l_U368))
    {
        l_U378 = 1;
        sub_3451();
        return 0;
    }
    if ((IS_KEYBOARD_KEY_PRESSED( 33 )) AND (l_U368))
    {
        l_U367 = 11;
        sub_16928();
        return 0;
...
void sub_9123()
{
    ...
    {
        if ((g_U575[I]._fU20) AND ((sub_9161( 5, g_U575[I] )) == 1))
        {
...
void sub_12076(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    ...
    if ((uParam3) || ((uParam2) || ((uParam1) || (uParam0))))
    {
        return;
    }
    if (l_U196 == 0)
    ...
    for ( I = 0; I < l_U196; I++ )
    {
        if ((l_U187[I]._fU0 >= 0) AND (l_U187[I]._fU0 < 24))
        {
...
void sub_14722(boolean bParam0)
{
    ...
    l_U245 = 0;
    if ((NOT (IS_CHAR_DEAD( l_U349 ))) AND (NOT (l_U349 == nil)))
    {
...
void sub_17005()
{
    ...
    if ((IS_CHAR_IN_ANY_TRAIN( sub_1473() )) || (IS_CHAR_IN_MODEL( sub_1473(), -960289747 )))
    {
        return;
    }
...
int sub_20006()
{
    ...
    for ( I = 0; I <= (g_U575 - 1); I++ )
    {
        if ((g_U575[I]._fU20) AND ((sub_9161( 1, g_U575[I] )) != 0))
        {
            sub_9447( I );
            return 1;
        }
...
void sub_22298(unknown uParam0, int iParam1)
{
    ...
    if (IS_CHAR_SITTING_IN_ANY_CAR( sub_1473() ))
    {
        ...
        if (bVar11)
        {
            ...
            while (bVar11)
            {
                ...
                {
                    if ((IS_CHAR_GETTING_IN_TO_A_CAR( sub_1473() )) || (IS_CHAR_SITTING_IN_ANY_CAR( sub_1473() )))
                    {
                        if (NOT (IS_CHAR_INJURED( uParam0 )))
                        {
                            if (bVar9)
    ...
    if ((NOT bVar9) AND (NOT (IS_CHAR_INJURED( uParam0 ))))
    {
        TASK_SMART_FLEE_POINT( uParam0, uVar13._fU0, uVar13._fU4, uVar13._fU8, 300.00000000, -2 );
        bVar12 = true;
    ...
    if (bVar4)
    {
        if ((NOT bVar10) AND (NOT (IS_CHAR_INJURED( iParam1 ))))
        {
            TASK_SMART_FLEE_POINT( iParam1, uVar13._fU0, uVar13._fU4, uVar13._fU8, 300.00000000, -2 );
            bVar12 = true;
    ...
    if (bVar12)
    {
        while (bVar18)
        {
            WAIT( 0 );
            bVar18 = false;
            if ((NOT (sub_23176( l_U275 ))) || ((DOES_CHAR_EXIST( iParam1 )) || (DOES_CHAR_EXIST( uParam0 ))))
            {
                GET_GAME_TIMER( ref iVar8 );
                if (iVar17 > iVar8)
                {
...
void sub_25640(unknown uParam0)
{
    ...
    iVar7 = 0;
    if ((NOT l_U295._fU88) AND ((NOT (COMPARE_STRING( ref l_U295._fU48, l_U294 ))) AND ((l_U239 == 2) AND (l_U295._fU80 == 1))))
    {
        iVar7 = 1;
    }
    bVar8 = false;
    if (l_U295._fU100)
    {
        ...
        if ((NOT l_U295._fU92) AND ((NOT (COMPARE_STRING( ref l_U295._fU64, l_U294 ))) AND ((bVar9) AND ((l_U239 == 2) AND (l_U295._fU80 == 1)))))
        {
            iVar7 = 1;
            bVar8 = true;
        }
...
void sub_28359(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    fVar5 = sub_25340();
    if ((IS_BIT_SET( g_U10938._fU0, 4 )) || ((g_U12379) || (fVar5 > 100.00000000)))
    {
        sub_28412( uParam1 );
        sub_14880( uParam0 );
...
void sub_28493()
{
    ...
    if ((LOCATE_CHAR_ANY_MEANS_CAR_3D( sub_1473(), l_U327, fVar2, fVar2, 30.00000000, 0 )) || (IS_CHAR_IN_CAR( sub_1473(), l_U327 )))
    {
        sub_28626();
        return;
    }
...
int sub_29374(float fParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((NOT bVar5) AND ((NOT (IS_BIT_SET( g_U10938._fU0, 4 ))) AND (NOT g_U12379)))
    {
...
int sub_29667(float fParam0)
{
    ...
    if ((NOT bVar3) AND ((NOT (IS_BIT_SET( g_U10938._fU0, 4 ))) AND (NOT g_U12379)))
    {
...
int sub_29806()
{
    ...
    if (l_U347 == 1)
    {
        ...
        if ((l_U337 < iVar2) || (fVar4 < 0.04000000))
        {
            SET_PLAYER_CONTROL( sub_3523(), 1 );
            l_U347 = 0;
            return 1;
...
int sub_30120(unknown uParam0, unknown uParam1)
{
    ...
    if (NOT l_U245)
    {
        ...
        if (IS_CHAR_SITTING_IN_ANY_CAR( sub_1473() ))
        {
            ...
            if ((NOT (IS_VEH_DRIVEABLE( uVar5 ))) || ((l_U251) || (iVar6 < iVar7)))
            {
        ...
        if ((NOT (iVar8 == 7)) AND (NOT (iVar8 == 1)))
        {
            return 1;
        }
        if (NOT (COMPARE_STRING( ref l_U295._fU0, l_U294 )))
    ...
    iVar9 = 0;
    bVar10 = false;
    if ((NOT l_U252) AND (IS_CHAR_IN_ANY_CAR( sub_1473() )))
    {
        ...
        if ((NOT bVar10) || (NOT (IS_CHAR_IN_CAR( (uParam0^), uVar5 ))))
        {
            if (NOT (l_U287 == 0))
            {
                iVar11 = 0;
                GET_GAME_TIMER( ref iVar11 );
                if ((NOT (IS_VEH_DRIVEABLE( uVar5 ))) || (l_U287 < iVar11))
                {
                    SET_PLAYER_CONTROL( sub_3523(), 1 );
                    HINT_CAM( -1.00000000, -1.00000000, -1.00000000, 0, 0, 0, 0 );
...
int sub_33236()
{
    ...
    fVar3 = 0.00000000;
    GET_CAR_SPEED( uVar2, ref fVar3 );
    if ((sub_33311( 1, 1 )) AND (fVar3 < 0.01000000))
    {
        if (NOT l_U249)
        {
            SET_PLAYER_CONTROL( sub_3523(), 0 );
...
int sub_33674()
{
    ...
    GET_GAME_TIMER( ref iVar2 );
    bVar3 = false;
    if ((IS_PLAYER_PRESSING_HORN( sub_3523() )) AND ((sub_33311( 1, 1 )) AND (IS_CHAR_IN_ANY_CAR( sub_1473() ))))
    {
        if (l_U249)
        {
            return 0;
...
int sub_38465(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, boolean bParam5, unknown uParam6, int iParam7, int iParam8)
{
    ...
    if (l_U363 == 2)
    {
        ...
        if (LOCATE_CHAR_ANY_MEANS_3D( sub_1473(), uParam2._fU0, uParam2._fU4, fVar13, 2.50000000, 2.50000000, 2.50000000, 1 ))
        {
            if (bVar11)
            {
                if ((sub_17095( iParam8 )) AND (sub_17095( iParam1 )))
                {
                    l_U363++;
                }
            }
    ...
    if (l_U363 == 5)
    {
        if ((NOT (IS_CHAR_DEAD( iParam1 ))) AND (NOT (IS_CHAR_DEAD( sub_1473() ))))
        {
            if (bVar14)
            {
    ...
    if (l_U363 == 7)
    {
        ...
        else if ((IS_CHAR_DEAD( iParam1 )) || (IS_CHAR_DEAD( sub_1473() )))
        {
            l_U363++;
        }
        else
        {
            ...
            if ((TIMERA() > 7000) || (fVar31 < 5.00000000))
            {
                l_U363++;
            }
        }
    ...
    if (l_U363 == 11)
    {
        ...
        if (NOT (sub_23176( l_U275 )))
        {
            ...
            if (bVar11)
            {
                if ((NOT (IS_CHAR_DEAD( iParam8 ))) AND (NOT (iParam8 == nil)))
                {
    ...
    if (l_U363 == 12)
    {
        ...
        if ((TIMERA() > 7000) || (sub_46694( iParam1, l_U401, iParam8, l_U404 )))
        {
            l_U363++;
        }
    }
...
int sub_46694(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7)
{
    ...
    if (l_U348 == 1)
    {
        ...
        if ((NOT (IS_CHAR_IN_ANY_CAR( uParam4 ))) AND (NOT (IS_CHAR_IN_ANY_CAR( uParam0 ))))
        {
            l_U348 = 2;
        }
    }
...
void sub_47825()
{
    if (NOT l_U368)
    {
        if ((NOT (DOES_CHAR_EXIST( l_U350 ))) || (NOT (DOES_CHAR_EXIST( l_U349 ))))
        {
            return;
        }
    }
...
void sub_51641()
{
    ...
    {
        STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_1473(), ref uVar2 );
        if ((NOT (IS_CHAR_IN_MODEL( sub_1473(), -488123221 ))) AND (NOT (IS_CHAR_IN_MODEL( sub_1473(), 837858166 ))))
        {
            GET_CAR_SPEED( uVar2, ref fVar3 );
            if (fVar3 < 0.40000000)
            {
...
void sub_55080()
{
    ...
    if (l_U206 == 1)
    {
        if (l_U199 == 22)
        {
            if ((iVar2 > l_U204) || (IS_SCREEN_FADED_OUT()))
            {
                l_U206++;
            }
        }
...
{
    if ((LOCATE_CHAR_ON_FOOT_3D( sub_1473(), -481.88600000, 157.56130000, 6.54900000, 5.00000000, 5.00000000, 2.00000000, 0 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_1473(), -434.15340000, 353.02990000, 10.71170000, 5.00000000, 5.00000000, 2.00000000, 0 )))
    {
...
void sub_70109(unknown uParam0)
{
    ...
    if (l_U384._fU12)
    {
        if (g_U20825[l_U286]._fU900._fU40 >= 0)
        {
            ...
            if (NOT l_U384._fU24)
            {
                if (((sub_57813( l_U341 )) > 5) || (sub_77945( ref l_U341 )))
                {
                    bVar5 = true;
                }
            }
...
int sub_70299()
{
    if ((IS_CHAR_INJURED( l_U350 )) || (IS_CHAR_INJURED( l_U349 )))
    {
        return 1;
    }
    return 0;
...
int sub_71016()
{
    if ((IS_CHAR_SHOOTING( l_U350 )) || (IS_CHAR_SHOOTING( l_U349 )))
    {
        return 1;
    }
    return 0;
...
int sub_71076()
{
    if ((IS_CHAR_IN_MELEE_COMBAT( l_U350 )) || (IS_CHAR_IN_MELEE_COMBAT( l_U349 )))
    {
        return 1;
    }
    return 0;
...
int sub_71225()
{
    ...
    if ((l_U384._fU24) || (sub_71234()))
    {
        return 0;
    }
    if ((l_U362 == 1) || (l_U362 == 0))
    {
        return 0;
    }
    if (NOT l_U384._fU8)
    {
        if ((NOT (IS_CHAR_DEAD( l_U350 ))) AND ((NOT (IS_CHAR_DEAD( l_U349 ))) AND (NOT (IS_CHAR_DEAD( sub_1473() )))))
        {
            if (IS_CHAR_IN_ANY_CAR( sub_1473() ))
            {
                STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_1473(), ref uVar2 );
                if ((IS_CHAR_IN_CAR( l_U350, uVar2 )) AND (IS_CHAR_IN_CAR( l_U349, uVar2 )))
                {
                    return 1;
                }
            }
...
int sub_71234()
{
    if ((l_U384._fU48) || ((l_U384._fU44) || ((l_U384._fU40) || ((l_U384._fU36) || (l_U384._fU32)))))
    {
        return 1;
    }
    return 0;
...
int sub_71753(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    iVar6 = 0;
    I = 0;
    if ((uParam2) AND (NOT g_U20825[uParam0]._fU900._fU28))
    {
        iVar6 = g_U20825[uParam0]._fU900._fU24;
        I = 0;
        for ( I = 0; I < iVar6; I++ )
        {
            if ((NOT (sub_72154( uParam0, I ))) AND (sub_71914( uParam0, I )))
            {
                sub_72078( uParam0, I );
            }
        }
...
void sub_71868()
{
    ...
    for ( I = 0; I < iVar2; I++ )
    {
        if ((sub_71914( 7, I )) || (sub_71914( 3, I )))
        {
            sub_71997( 3, I );
            sub_71997( 7, I );
        }
        ...
        if ((sub_72154( 7, I )) || (sub_72154( 3, I )))
        {
            sub_72237( 3, I );
            sub_72237( 7, I );
        }
...
int sub_76819()
{
    ...
    if (l_U384._fU24)
    {
        if (NOT sub_71234())
        {
            ...
            if ((iVar2 > l_U384._fU28) AND (NOT (l_U384._fU28 == 0)))
            {
                l_U384._fU28 = 0;
                if (l_U384._fU8)
                {
...
void sub_78962()
{
    ...
    for ( I = 0; I < 13; I++ )
    {
        if (l_U692[I]._fU12 < iVar2)
        {
            ...
            {
                if ((sub_17095( l_U350 )) || (sub_17095( l_U349 )))
                {
                    sub_79211( I, 3 );
                }
            }
...
void sub_82164()
{
    ...
    if (NOT (l_U747 == 72))
    {
        ...
        else if ((IS_BLIP_SHORT_RANGE( l_U540[l_U747]._fU4 )) || ((iVar2 > l_U748) || (IS_MINIGAME_IN_PROGRESS())))
        {
    ...
    {
        STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_1473(), ref uVar4 );
        if ((IS_CHAR_SITTING_IN_CAR( l_U350, uVar4 )) AND (IS_CHAR_SITTING_IN_CAR( l_U349, uVar4 )))
        {
            bVar3 = true;
        }
    }
