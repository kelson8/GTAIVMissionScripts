...
void sub_6912()
{
    ...
    l_U139[3]._fU4 = 2;
    l_U139[3]._fU56 = 15;
    l_U139[3]._fU28 = {-442.03000000, 359.67040000, 9.85630100};
...
void sub_14364()
{
        ...
        else if (NOT g_U15811[35])
        {
            if ((NOT g_U30153) AND (NOT g_U12379))
            {
                if (NOT (l_U1149 == 2))
                {
                    ...
                    {
                        if ((g_U30110[l_U1149]) || (((NOT (sub_3885( sub_3600(), l_U1149, 0 ))) AND (l_U1121)) || (NOT (sub_14729( sub_3600(), l_U1149, 1094713344 )))))
                        {
    ...
    {
        GET_TIME_OF_DAY( ref iVar7, ref uVar8 );
        if (NOT ((l_U1149 == 0) AND (g_U30181)))
        {
            if (NOT g_U15811[35])
            {
                if ((sub_3885( sub_3600(), l_U1149, 0 )) || ((g_U30153) || (((iVar7 < 6) || (iVar7 >= 21)) || ((IS_THREAD_ACTIVE( g_U30226[l_U1149] )) || (g_U12379)))))
                {
    ...
    if ((NOT ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "rocco1" )) > 0)) AND ((IS_PLAYER_PLAYING( sub_2044() )) AND (sub_15432( sub_3600(), l_U1149 ))))
    {
        sub_16412();
        if (g_U30154[l_U1149])
        {
        ...
        switch (l_U1148)
        {
            ...
            {
                if ((NOT g_U30093[l_U1149]) AND (sub_24963( sub_3600(), l_U1149 )))
                {
            ...
            break;
            case 1:
            if ((NOT (sub_24963( sub_3600(), l_U1149 ))) || (NOT (sub_3885( sub_3600(), l_U1149, 0 ))))
            {
                sub_1794();
                l_U1148 = 0;
            }
        ...
        if ((sub_25748()) || (NOT g_U30149[l_U1149]))
        {
            if ((sub_25748()) || (NOT g_U30120[l_U1149]))
            {
                if (g_U30128[l_U1149])
                {
                ...
                if (g_U30114[l_U1149])
                {
                    ...
                    if ((sub_3885( sub_3600(), l_U1149, 0 )) || (IS_SCREEN_FADED_OUT()))
                    {
                ...
                if (g_U30109)
                {
                    for ( I = 0; I < l_U920; I++ )
                    {
                        if ((l_U920[I]._fU4 == 12) || (l_U920[I]._fU4 == 10))
                        {
                            l_U920[I]._fU16 = 0;
                        }
                    }
        ...
        else if ((l_U1114) || (IS_THREAD_ACTIVE( g_U30226[l_U1149] )))
        {
            sub_70702();
            if (g_U30110[l_U1149])
            {
...
int sub_15432(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_PLAYER_PLAYING( sub_2044() ))
    {
        ...
        {
            if (((sub_15706( sub_3600() )) == 3) || ((sub_15706( sub_3600() )) == 5))
            {
                bVar4 = true;
            }
        }
...
void sub_21263()
{
    ...
    if (IS_PLAYER_PLAYING( sub_2044() ))
    {
        if ((NOT g_U30179) AND (NOT g_U30153))
        {
            if (NOT l_U1104)
            {
                if ((NOT l_U1106) AND (NOT g_U30093[l_U1149]))
                {
            ...
            else if ((g_U30093[l_U1149]) || (NOT (sub_3913( sub_3600(), l_U1149 ))))
            {
                SET_CHAR_MAX_MOVE_BLEND_RATIO( sub_3600(), 3.00000000 );
                l_U1104 = 0;
            }
...
void sub_21692()
{
    ...
    if (IS_PLAYER_PLAYING( sub_2044() ))
    {
        if ((NOT g_U30179) AND (NOT g_U30153))
        {
            if (NOT l_U1106)
            {
                if ((NOT g_U30153) AND (NOT g_U30093[l_U1149]))
                {
                    if (sub_3913( sub_3600(), l_U1149 ))
                    {
            ...
            else
            {
                ...
                if ((sub_21992( sub_3600() )) || ((NOT bVar3) || ((g_U30153) || ((g_U30093[l_U1149]) || (NOT (sub_3913( sub_3600(), l_U1149 )))))))
                {
...
void sub_22558()
{
    ...
    if (NOT g_U30167)
    {
        if (((l_U1149 == 0) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "Tony6" )) > 0)) || ((IS_PLAYER_CONTROL_ON( sub_2044() )) AND (HAS_CUTSCENE_FINISHED())))
        {
            if (IS_PLAYER_PLAYING( sub_2044() ))
            {
                if (g_U30153)
                ...
                else if (((l_U1149 == 0) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "E2EndCredits" )) > 0)) || ((l_U1149 == 0) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "Tony6" )) > 0)))
                {
                    if ((NOT (sub_3885( sub_3600(), l_U1149, 0 ))) AND (IS_WANTED_LEVEL_GREATER( sub_2044(), 0 )))
                    {
                        sub_22837( l_U1149, 2 );
                    }
                    else
                ...
                else if ((g_U30149[l_U1149]) || ((g_U30093[l_U1149]) || (IS_WANTED_LEVEL_GREATER( sub_2044(), 0 ))))
                {
                    sub_22837( l_U1149, 2 );
                }
                else if (l_U1149 == 0)
            ...
            if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS( vVar3.x, vVar3.y, vVar3.z, 1.50000000, iVar2 ))
            {
                switch (g_U30192[l_U1149])
                {
                    ...
                    if ((NOT (sub_23292( vVar3, 2.00000000 ))) || (IS_SCREEN_FADED_OUT()))
                    {
                        fVar8 = -1.00000000;
                    }
    ...
    if (NOT l_U1103)
    {
        if (IS_PLAYER_PLAYING( sub_2044() ))
        {
            if (g_U30149[l_U1149])
            {
                ...
                {
                    if ((NOT g_U12379) AND ((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) AND (NOT sub_24185())))
                    {
                        switch (l_U1149)
                        {
                            case 0:
...
int sub_24185()
{
    if ((sub_24252()) || ((sub_24201()) || (IS_MESSAGE_BEING_DISPLAYED())))
    {
        return 1;
    }
    return 0;
...
void sub_29178()
{
    if (NOT l_U1102)
    {
        if (IS_PLAYER_PLAYING( sub_2044() ))
        {
            if ((NOT (g_U30192[l_U1149] == 1)) AND (g_U30093[l_U1149]))
            {
                if (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3600() )))
                {
                    if ((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) AND (NOT sub_24185()))
                    {
                        switch (l_U1149)
                        {
                            case 0:
...
void sub_30519()
{
    ...
    if ((NOT g_U30093[l_U1149]) AND (IS_PLAYER_PLAYING( sub_2044() )))
    {
        if ((NOT g_U43025) AND ((NOT (IS_WANTED_LEVEL_GREATER( sub_2044(), 0 ))) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3600() )))))
        {
            if (NOT l_U1098)
            {
                if (NOT l_U1085)
...
int sub_30649(unknown uParam0)
{
    ...
    if (NOT (IS_CHAR_INJURED( uParam0 )))
    {
        ...
        if (((VMAG2( uVar12 )) > 0.50000000) AND ((sub_30791( uVar12, uVar15 )) > 0.00000000))
        {
            return 1;
        }
    }
...
void sub_31536()
{
    ...
    if (NOT g_U30101)
    {
        if (NOT l_U1086)
        {
            ...
            {
                if ((sub_31604()) || (IS_CHAR_SHOOTING( sub_3600() )))
                {
                    g_U30093[l_U1149] = 1;
    ...
    if (NOT g_U30093[l_U1149])
    {
        if (IS_PLAYER_PLAYING( sub_2044() ))
        {
            if (((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "Tony6" )) > 0) || (sub_14729( sub_3600(), l_U1149, 1094713344 )))
            {
        ...
        if ((uParam0^)[I]._fU0)
        {
            if (NOT (IS_CHAR_INJURED( (uParam0^)[I]._fU24 )))
            {
                if (NOT g_U30153)
                {
                    if (NOT sub_31101())
                    {
                        if ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_2044(), (uParam0^)[I]._fU24 )) || (IS_PLAYER_TARGETTING_CHAR( sub_2044(), (uParam0^)[I]._fU24 )))
                        {
                            g_U30093[l_U1149] = 1;
                    ...
                    {
                        if ((((uParam0^)[I]._fU4 == 9) || ((uParam0^)[I]._fU4 == 8)) || (l_U1149 == 0))
                        {
...
void sub_33257()
{
    ...
    if (sub_3885( sub_3600(), l_U1149, 0 ))
    {
        if (sub_33290())
        {
            if ((NOT l_U1093) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "dancing" )) == 0))
            {
                if (NOT g_U30093[l_U1149])
                {
                ...
                if ((iVar8) AND ((sub_34776( 2, 0 )) AND ((g_U30105) || (bVar7))))
                {
                    l_U1211 = "DANC_H01";
                    if ((g_U30105) || ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT l_U1087)))
                    {
                        if (NOT (IS_CHAR_INJURED( l_U1196 )))
                        {
                            if (l_U1176 > 30000)
                        ...
                        if ((g_U30105) || (sub_35260( 2, l_U1211, 0 )))
                        {
                            g_U30206 = l_U1196;
                            g_U30190 = l_U1149;
                            l_U1122 = 0;
...
int sub_34776(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_2044() ))
    {
        ...
        {
            if ((iParam0 == 5) || (IS_PLAYER_CONTROL_ON( sub_2044() )))
            {
                if (((g_U9200) AND (uParam1)) || ((iParam0 == 4) || ((iParam0 == 5) || (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_2044() )))))
                {
                    if (NOT sub_34872())
                    {
...
void sub_38916(int iParam0)
{
    if (iParam0->_fU0)
    {
            ...
            else if (NOT l_U1086)
            {
                if (iParam0->_fU20 > 0)
                {
                    switch (iParam0->_fU4)
                    {
                        ...
                        case 10:
                        case 12:
                        if (((sub_25748()) || (NOT g_U30103)) AND ((sub_24963( sub_3600(), l_U1149 )) || (sub_3885( sub_3600(), l_U1149, 1 ))))
                        {
                            iParam0->_fU8 = 1;
                        }
                        break;
                        case 14:
                        if ((NOT g_U30180) AND (NOT l_U1125))
                        {
                            if ((NOT l_U1108) AND (NOT g_U30102))
                            {
        ...
        if (iParam0->_fU8 == 1)
        {
            if ((sub_39537( iParam0 )) AND (NOT l_U1086))
            {
                switch (iParam0->_fU4)
                {
                    case 1:
                    ...
                    {
                        if (((sub_25748()) || (NOT g_U30103)) AND ((sub_24963( sub_3600(), l_U1149 )) AND (sub_39692( iParam0 ))))
                        {
                            sub_40511( iParam0 );
                        }
                    }
                    ...
                    if (sub_39692( iParam0 ))
                    {
                        if ((sub_39364( (iParam0^) )) || (sub_48049( sub_3600(), l_U1149 )))
                        {
                            if ((sub_39364( (iParam0^) )) || (NOT g_U30102))
                            {
                                sub_40511( iParam0 );
                            }
                        }
                    ...
                    break;
                    case 6:
                    if ((sub_3913( sub_3600(), l_U1149 )) || (sub_48049( sub_3600(), l_U1149 )))
                    {
                        if (sub_39692( iParam0 ))
                        {
                            sub_40511( iParam0 );
                    ...
                    if (sub_3885( sub_3600(), l_U1149, 1 ))
                    {
                        if ((NOT g_U30103) AND ((sub_24963( sub_3600(), l_U1149 )) AND (sub_39692( iParam0 ))))
                        {
                            sub_40511( iParam0 );
                        }
                    }
        ...
        if (iParam0->_fU8 == 2)
        {
            ...
            else
            {
                switch (iParam0->_fU4)
                {
                    ...
                    case 10:
                    case 12:
                    if (((sub_25748()) || (NOT g_U30103)) AND (sub_24963( sub_3600(), l_U1149 )))
                    {
                        sub_48667( iParam0 );
                    }
                    else
                    ...
                    break;
                    case 4:
                    if ((NOT g_U30103) AND (sub_24963( sub_3600(), l_U1149 )))
                    {
                        sub_48667( iParam0 );
                    }
                    else
                    ...
                    else if ((NOT g_U30102) AND (sub_48049( sub_3600(), l_U1149 )))
                    {
                        sub_48667( iParam0 );
                    }
                    else
    ...
    else if (NOT g_U30097[l_U1149])
    {
        if (NOT (iParam0->_fU4 == 0))
        {
            ...
            else if ((NOT (iParam0->_fU4 == 9)) AND ((NOT (iParam0->_fU4 == 13)) AND ((NOT (iParam0->_fU4 == 2)) AND (NOT (sub_3885( sub_3600(), l_U1149, 0 ))))))
            {
                iParam0->_fU0 = 1;
            }
...
{
    if ((iParam0->_fU4 == 7) || ((iParam0->_fU4 == 6) || ((iParam0->_fU4 == 13) || ((iParam0->_fU4 == 2) || (g_U30162[l_U1149])))))
    {
...
void sub_40511(int iParam0)
{
    ...
    if (iParam0->_fU0)
    {
        if ((l_U1113) || (sub_40532( iParam0 )))
        {
            if ((l_U1113) || ((g_U30114[l_U1149]) || (sub_40603( iParam0 ))))
            {
                if ((l_U1113) || (NOT (sub_41434( iParam0->_fU28, g_U30251, g_U30254 ))))
                {
                    if ((l_U1113) || (sub_41534( iParam0 )))
                    {
                        if (HAS_MODEL_LOADED( iParam0->_fU48 ))
                        {
                            if (NOT (DOES_CHAR_EXIST( iParam0->_fU24 )))
                            {
                                if ((l_U1113) || ((sub_3885( sub_3600(), l_U1149, 0 )) || (NOT g_U30093[l_U1149])))
                                {
...
int sub_40603(int iParam0)
{
    ...
    if ((IS_PLAYER_CONTROL_ON( sub_2044() )) AND ((NOT g_U30114[l_U1149]) AND (NOT IS_SCREEN_FADED_OUT())))
    {
        ...
        if ((iParam0->_fU20 > 0) AND (iParam0->_fU16 == -1))
        {
            ...
            {
                GET_GAME_VIEWPORT_ID( ref uVar4 );
                if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3600(), ref iParam0->_fU28->_fU0, ref iParam0->_fU28->_fU4, ref iParam0->_fU28->_fU8, 5.00000000, 5.00000000, 5.00000000, 0 )) || (CAM_IS_SPHERE_VISIBLE( uVar4, ref iParam0->_fU28->_fU0, ref iParam0->_fU28->_fU4, ref iParam0->_fU28->_fU8, 2.00000000 )))
                {
                    return 0;
                }
            }
        ...
        {
            GET_GAME_VIEWPORT_ID( ref uVar4 );
            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3600(), ref iParam0->_fU28->_fU0, ref iParam0->_fU28->_fU4, ref iParam0->_fU28->_fU8, 7.00000000, 7.00000000, 5.00000000, 0 )) AND (CAM_IS_SPHERE_VISIBLE( uVar4, ref iParam0->_fU28->_fU0, ref iParam0->_fU28->_fU4, ref iParam0->_fU28->_fU8, 1.50000000 )))
            {
                return 0;
            }
        }
...
int sub_41679(unknown uParam0)
{
    ...
    switch (uParam0)
    {
        ...
        break;
        case 15:
        if (((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "Tony6" )) > 0) AND (l_U1149 == 0))
        {
            return 1;
        }
        else
...
string sub_43269(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((sub_41434( uParam0, -473.07430000, 139.93400000, 5.00000000, -467.99930000, 142.23400000, 11.86410000 )) || (sub_41434( uParam0, -471.45100000, 139.90120000, 5.00000000, -468.07600000, 156.20120000, 11.86410000 )))
    {
    ...
    if ((sub_41434( uParam0, -397.59980000, 431.71720000, 4.00000000, -383.42480000, 441.21720000, 12.05160000 )) || (sub_41434( uParam0, -398.37480000, 417.79220000, 4.00000000, -377.19980000, 431.96720000, 12.05160000 )))
    {
        return "gaydanceflr";
    }
    ...
    if (DOES_CHAR_EXIST( iParam0->_fU24 ))
    {
        if (NOT (IS_CHAR_INJURED( iParam0->_fU24 )))
        {
            if (NOT (sub_2330( iParam0->_fU24 )))
            {
                ...
                if (NOT (iParam0->_fU12 == 99))
                {
                    if ((sub_46583( iParam0->_fU56 )) || (sub_2999( iParam0->_fU56 )))
                    {
                        BLOCK_CHAR_AMBIENT_ANIMS( iParam0->_fU24, 1 );
                    }
                }
                if (NOT l_U1086)
                {
                    if (sub_50782( iParam0 ))
                    {
                        ...
                        else if (iParam0->_fU12 == 99)
                        {
                            ...
                            if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3600(), iParam0->_fU24, 15.00000000, 15.00000000, 5.00000000, 0 ))) AND (NOT (IS_CHAR_ON_SCREEN( iParam0->_fU24 ))))
                            {
                                if (l_U1088)
                                {
                        ...
                        switch (iParam0->_fU4)
                        {
                            ...
                            if (NOT g_U30118)
                            {
                                switch (iParam0->_fU12)
                                {
                                    ...
                                    if (NOT g_U30093[l_U1149])
                                    {
                                        ...
                                        if (NOT sub_31101())
                                        {
                                            if ((iParam0->_fU24 == l_U1191) || (iParam0->_fU24 == l_U1190))
                                            {
                                                CLEAR_CHAR_TASKS( iParam0->_fU24 );
                                                iParam0->_fU20 = 0;
                                                iParam0->_fU12 = 1;
                                    ...
                                    else if ((iParam0->_fU24 == l_U1191) || (iParam0->_fU24 == l_U1190))
                                    {
                                        GET_SCRIPT_TASK_STATUS( iParam0->_fU24, 91, ref l_U1212 );
                                        if (l_U1212 == 7)
                                        {
                                    ...
                                    break;
                                    case 2:
                                    if ((sub_3885( sub_3600(), l_U1149, 0 )) AND (NOT sub_31101()))
                                    {
                                        GET_SCRIPT_TASK_STATUS( iParam0->_fU24, 29, ref l_U1212 );
                                        if (l_U1212 == 7)
                                        {
                            ...
                            else
                            {
                                switch (iParam0->_fU12)
                                {
                                    ...
                                    {
                                        GET_SCRIPT_TASK_STATUS( iParam0->_fU24, 29, ref l_U1212 );
                                        if ((iParam0->_fU20 > 30000) || (l_U1212 == 7))
                                        {
                                            if (NOT (iParam0->_fU16 == -1))
                                            {
                            ...
                            break;
                            default:
                            if ((NOT (LOCATE_CHAR_ANY_MEANS_3D( iParam0->_fU24, ref iParam0->_fU28->_fU0, ref iParam0->_fU28->_fU4, ref iParam0->_fU28->_fU8, 5.00000000, 5.00000000, 5.00000000, 0 ))) || (sub_54405( iParam0 )))
                            {
                                iParam0->_fU12 = 99;
                            }
                            else
                            {
                                switch (iParam0->_fU12)
                                {
                                    ...
                                    else if ((NOT (sub_22164( uVar14 ))) AND (NOT (sub_22164( uVar13 ))))
                                    {
                                    ...
                                    if (sub_22164( sVar15 ))
                                    {
                                        ...
                                        if (l_U1212 == 7)
                                        {
                                            ...
                                            if ((NOT (sub_22164( uVar14 ))) AND (NOT (sub_22164( uVar13 ))))
                                            {
                                                if (NOT (IS_CHAR_PLAYING_ANIM( iParam0->_fU24, uVar14, uVar13 )))
                                                {
...
int sub_54405(int iParam0)
{
    if (NOT (IS_CHAR_INJURED( iParam0->_fU24 )))
    {
        if ((IS_PED_RAGDOLL( iParam0->_fU24 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( iParam0->_fU24, sub_3600(), 0 )))
        {
            return 1;
        }
    }
...
void sub_54551(int iParam0)
{
    ...
    for ( I = 0; I < l_U1065; I++ )
    {
        if ((NOT (l_U1065[I]._fU20 == iParam0->_fU24)) AND (NOT (I == iParam0->_fU16)))
        {
...
int sub_54874(unknown uParam0)
{
    ...
    {
        if ((sub_22164( sub_48796( l_U1065[uParam0]._fU24 ) )) || (sub_22164( l_U981[l_U1065[uParam0]._fU24]._fU0 )))
        {
            return 1;
        }
    }
...
int sub_57008(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14)
{
    if (NOT (IS_CHAR_INJURED( uParam0._fU24 )))
    {
        if (NOT (sub_3885( uParam0._fU24, l_U1149, 0 )))
        {
            ...
            {
                if ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_2044(), uParam0._fU24 )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3600(), uParam0._fU24, 60.00000000, 60.00000000, 60.00000000, 0 )))
                {
                    return 1;
                }
            }
                        ...
                        if (iParam0->_fU20 > 10000)
                        {
                            switch (iParam0->_fU4)
                            {
                                ...
                                if (l_U1110)
                                {
                                    ...
                                    {
                                        if ((NOT (IS_AMBIENT_SPEECH_PLAYING( iParam0->_fU24 ))) AND (NOT (IS_AMBIENT_SPEECH_PLAYING( l_U1195 ))))
                                        {
                                ...
                                if (DOES_CHAR_EXIST( l_U1193 ))
                                {
                                    ...
                                    {
                                        if ((l_U1193 == iParam0->_fU24) || (IS_AMBIENT_SPEECH_PLAYING( l_U1193 )))
                                        {
                                            bVar3 = false;
                                        }
                                    }
                                ...
                                if (NOT bVar4)
                                {
                                    if (bVar3)
                                    {
                                        if (NOT l_U1111)
                                        {
                                            if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3600(), iParam0->_fU24, 2.00000000, 2.00000000, 2.00000000, 0 )) AND ((iParam0->_fU20 > 20000) AND (l_U1172 > 6000)))
                                            {
                                                GENERATE_RANDOM_INT_IN_RANGE( 0, 5, ref iVar5 );
                                                if (iVar5 < 2)
                                                {
                                                    if ((l_U1149 == 0) || (sub_62930( iParam0->_fU24 )))
                                                    {
                                                ...
                                                else if ((l_U1177 > 20000) AND (sub_63773( iParam0->_fU24 )))
                                                {
                                                    l_U1193 = iParam0->_fU24;
                                ...
                                else if ((iParam0->_fU20 > 5000) AND (l_U1172 > 5000))
                                {
                                ...
                                if (DOES_CHAR_EXIST( l_U1194 ))
                                {
                                    ...
                                    {
                                        if ((l_U1194 == iParam0->_fU24) || (IS_AMBIENT_SPEECH_PLAYING( l_U1194 )))
                                        {
                                            bVar3 = false;
                                        }
                                    }
...
void sub_74772()
{
    ...
    if ((g_U30178) || (l_U1086))
    {
        if ((NOT l_U1119) AND (NOT (l_U1186 == -1)))
        {
    ...
    if (NOT (g_U30197 == -1))
    {
        ...
        else if (((NOT g_U30154[l_U1149]) AND (g_U30149[l_U1149])) || ((g_U30177) || (NOT (sub_14729( sub_3600(), g_U30197, l_U1142 )))))
        {
            if (l_U1115)
            {
                if (g_U30177)
    ...
    switch (l_U1179)
    {
        ...
        if (fVar2 < l_U1141)
        {
            if (g_U30197 == -1)
            {
                if ((g_U30154[l_U1149]) || ((NOT ((NOT g_U30154[l_U1149]) AND (g_U30149[l_U1149]))) AND ((NOT g_U30177) AND (sub_14729( sub_3600(), l_U1149, l_U1142 )))))
                {
...
void sub_78576(int iParam0)
{
    ...
    if ((IS_PLAYER_CONTROL_ON( sub_2044() )) || (g_U10597))
    {
...
int sub_78627(unknown uParam0)
{
    ...
    {
        case 1:
        if ((IS_CHAR_IN_AREA_3D( sub_3600(), -468.32000000, 156.33000000, 11.46000000, -476.07000000, 166.44000000, 8.74000000, 0 )) || (IS_CHAR_IN_AREA_3D( sub_3600(), -474.97280000, 143.74440000, 8.86370000, -471.82280000, 150.54440000, 11.86370000, 0 )))
        {
            return 1;
        }
        break;
