...
void sub_61()
{
    ...
    while ((NOT (HAS_MODEL_LOADED( -196312163 ))) || ((NOT (HAS_MODEL_LOADED( uVar5 ))) || (NOT (HAS_MODEL_LOADED( sub_1404( l_U172 ) )))))
    {
        WAIT( 0 );
    }
    ...
    switch (uVar13)
    {
        ...
        if (NOT (IS_CHAR_DEAD( l_U171 )))
        {
            ...
            for ( I = 0; I <= 1; I++ )
            {
                ...
                if ((NOT (IS_CHAR_DEAD( l_U178[I] ))) AND (NOT (IS_CAR_DEAD( l_U182 ))))
                {
...
void sub_4591()
{
    if ((g_U8642 < g_U2831) AND (g_U8642 < 100))
    {
...
void sub_4651()
{
    ...
    for ( I = 0; I <= (sub_4716() - 1); I++ )
    {
        if ((NOT (g_U2832[I]._fU216 == 1)) AND ((sub_5816( uVar8, I )) AND ((NOT g_U2832[I]._fU208) AND (g_U2832[I]._fU196 < 2000))))
        {
...
int sub_6139(int iParam0)
{
    ...
    {
        if ((sub_5816( uVar7, Result )) AND ((NOT g_U2832[Result]._fU212) AND (g_U2832[Result]._fU196 == iParam0)))
        {
...
void sub_7569()
{
    if (NOT l_U217)
    {
        if ((NOT (IS_CHAR_DEAD( l_U178[0] ))) AND (NOT (IS_CHAR_DEAD( l_U171 ))))
        {
...
void sub_7846(boolean bParam0)
{
    ...
    if ((NOT (IS_CAR_DEAD( l_U182 ))) AND (NOT (IS_CHAR_DEAD( l_U171 ))))
    {
        if (NOT l_U218)
        {
    ...
    if (l_U218)
    {
        if ((IS_PLAYER_PLAYING( sub_660() )) AND ((NOT (IS_CAR_DEAD( l_U182 ))) AND (NOT (IS_CHAR_DEAD( l_U171 )))))
        {
...
void sub_8983()
{
    if (NOT l_U218)
    {
        ...
        {
            if ((HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U171, sub_703() )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U171, sub_703(), 0 )))
            {
                CLEAR_CHAR_TASKS_IMMEDIATELY( l_U171 );
