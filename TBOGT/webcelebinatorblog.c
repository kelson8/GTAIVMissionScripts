...
void sub_82(int iParam0)
{
    ...
    if (((g_U972 != 2) AND ((g_U42941[5]) AND ((iParam0 == 10) || (iParam0 == 9)))) || (((g_U972 != 2) AND ((g_U42941[4]) AND ((iParam0 == 8) || (iParam0 == 7)))) || (((g_U972 != 2) AND ((g_U42941[3]) AND (iParam0 == 6))) || (((g_U972 != 2) AND ((g_U42941[2]) AND ((iParam0 == 5) || (iParam0 == 4)))) || (((g_U972 != 2) AND ((g_U42941[1]) AND ((iParam0 == 3) || (iParam0 == 2)))) || ((((g_U42941[0]) || (g_U972 == 2)) AND ((iParam0 == 12) || (iParam0 == 11))) || ((iParam0 == 1) || (iParam0 == 0))))))))
    {
        ...
        if ((NOT g_U42935) AND ((iParam0 == 12) AND (g_U972 == 2)))
        {
            sub_2091( ref l_U2[iParam0], "CELEB_LEAVE", 1 );
        }
        else if ((g_U42935) AND (iParam0 == 12))
        {
