...
int sub_831(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_1062() ))) AND (IS_CHAR_IN_ANY_CAR( sub_1062() )))
    {
    ...
    {
        case 0:
        if ((NOT bParam11) AND (NOT sub_1394()))
        {
            return 0;
        }
        g_U95._fU60 = uParam0;
...
void sub_9861()
{
    ...
    if (IS_CHAR_GETTING_IN_TO_A_CAR( sub_1062() ))
    {
        ...
        if ((l_U278 == l_U277) || ((l_U278 == l_U276) || (l_U278 == l_U275)))
        {
            l_U104 = 6;
        }
    }
    ...
    if ((NOT (sub_11205( sub_1062() ))) AND ((COUNT_SCRIPT_CAMS_BY_TYPE_AND_OR_STATE( -1, 1, 1 )) > 0))
    {
        sub_10936();
        l_U104 = 6;
    }
...
int sub_14474()
{
    if (NOT (IS_CHAR_INJURED( l_U280 )))
    {
        if (NOT (IS_CHAR_IN_ANY_CAR( sub_1062() )))
        {
            ...
            {
                if ((IS_SCORE_GREATER( sub_328(), sub_14587() )) AND (l_U113 < 175))
                {
                    return 1;
                }
            }
